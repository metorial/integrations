...
export let incidentEvents = SlateTrigger.create(
  spec,
  {
    ...
    key: 'incident_events',
    description: 'Triggers when incidents are created, updated, mitigated, resolved, cancelled, or deleted.',
  }
)
  .input(z.object({
  ...
  .output(z.object({
    ...
    environments: z.array(z.record(z.string(), z.any())).optional().describe('Affected environments'),
    incidentTypes: z.array(z.record(z.string(), z.any())).optional().describe('Incident types'),
