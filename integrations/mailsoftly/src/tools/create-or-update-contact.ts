...
export let createOrUpdateContact = SlateTool.create(
  ...
  .input(z.object({
    contactId: z.string().optional().describe('ID of an existing contact to update. Omit to create a new contact.'),
    email: z.string().describe('Email address of the contact.'),
    firstName: z.string().optional().describe('First name of the contact.'),
    lastName: z.string().optional().describe('Last name of the contact.'),
    customFields: z.record(z.string(), z.string()).optional().describe('Key-value pairs of custom field names and their values.'),
  }))
  .output(z.object({
