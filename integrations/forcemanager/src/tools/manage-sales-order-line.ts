...
export let manageSalesOrderLine = SlateTool.create(
  spec,
  {
...
Line items reference products with quantity, pricing, and up to four levels of discounts.`,
  ...
  .input(z.object({
    ...
    fields: lineFields.optional().describe('Line item fields (required for create, optional for update)')
  }))
  .output(z.object({
