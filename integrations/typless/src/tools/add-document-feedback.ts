...
export let addDocumentFeedback = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    documentTypeName: z.string().describe('Slug/name of the document type used during extraction'),
    documentObjectId: z.string().describe('Object ID returned from the extraction result'),
    learningFields: z.array(z.object({
      name: z.string().describe('Name of the field (e.g. "supplier_name", "total_amount", "issue_date")'),
