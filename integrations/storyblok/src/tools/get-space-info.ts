...
export let getSpaceInfo = SlateTool.create(
  spec,
  {
    name: 'Get Space Info',
    key: 'get_space_info',
  ...
  .output(z.object({
    ...
    })).optional().describe('Available workflows'),
    workflowStages: z.array(z.object({
      stageId: z.number().optional(),
      name: z.string().optional(),
      color: z.string().optional(),
      workflowId: z.number().optional(),
    })).optional().describe('Workflow stages'),
    roles: z.array(z.object({
      roleId: z.number().optional(),
      name: z.string().optional(),
    })).optional().describe('Space roles'),
    tags: z.array(z.object({
      name: z.string().optional(),
      count: z.number().optional(),
    })).optional().describe('Content tags'),
  }))
