...
export let buildRenderUrl = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    params: z.record(z.string(), z.string()).optional().describe('Rendering parameters as key-value pairs (e.g., {"w": "800", "h": "600", "fit": "crop", "auto": "compress,format"})'),
  }))
  .output(z.object({
