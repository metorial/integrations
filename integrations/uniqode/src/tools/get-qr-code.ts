...
export let getQrCode = SlateTool.create(
  spec,
  {
    name: 'Get QR Code',
    key: 'get_qr_code',
  ...
  .output(z.object({
    ...
    campaign: z.object({
      ...
      contentType: z.number().optional().describe('Campaign type: 0=None, 1=URL, 2=Landing Page, 3=Form'),
    ...
    }).optional().describe('Associated campaign details'),
    attributes: z.record(z.string(), z.unknown()).optional().describe('Visual design attributes'),
    fieldsData: z.record(z.string(), z.unknown()).optional().describe('Static QR code content fields'),
