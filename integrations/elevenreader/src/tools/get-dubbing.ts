...
export let getDubbingTool = SlateTool.create(
  spec,
  {
    name: 'Get Dubbing',
    key: 'get_dubbing',
  ...
  .output(z.object({
    ...
    status: z.string().describe('Current status of the dubbing (e.g. "dubbed", "dubbing", "failed")'),
    targetLanguages: z.array(z.string()).optional().describe('Target languages for the dubbing'),
