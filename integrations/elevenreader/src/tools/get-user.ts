...
export let getUserTool = SlateTool.create(
  ...
  .output(z.object({
    ...
    subscriptionStatus: z.string().optional().describe('Subscription status (active, trialing, free, etc.)'),
    ...
    canExtendCharacterLimit: z.boolean().optional().describe('Whether character limit can be extended'),
