...
let contactOutputSchema = z.object({
  ...
  unsubscribed: z.boolean().optional().describe('Whether the contact is globally unsubscribed.'),
  createdAt: z.string().optional().describe('Creation timestamp.'),
  properties: z.record(z.string(), z.any()).optional().nullable().describe('Custom contact properties.'),
});
...
export let createContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    unsubscribed: z.boolean().optional().describe('Set to true to globally unsubscribe from all broadcasts.'),
    properties: z.record(z.string(), z.string()).optional().describe('Custom properties as key-value pairs for personalization.'),
  }))
  .output(z.object({
...
export let updateContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    properties: z.record(z.string(), z.string()).optional().describe('Updated custom properties.'),
  }))
  .output(z.object({
