...
export let libraryPublish = SlateTrigger.create(
  spec,
  {
    name: 'Library Published',
    key: 'library_published',
    description: 'Triggers when a Figma library is published. Includes details about created, modified, and deleted components, styles, and variables.'
  }
)
  .input(z.object({
    ...
    }).optional().describe('User who published the library')
  }))
  .output(z.object({
    ...
    createdComponents: z.array(libraryChangeSchema).optional().describe('Newly created components'),
    modifiedComponents: z.array(libraryChangeSchema).optional().describe('Modified components'),
    deletedComponents: z.array(libraryChangeSchema).optional().describe('Deleted components'),
    ...
    createdVariables: z.array(libraryChangeSchema).optional().describe('Newly created variables'),
    modifiedVariables: z.array(libraryChangeSchema).optional().describe('Modified variables'),
