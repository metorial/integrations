...
export let listMailFolders = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    parentFolderId: z.string().optional().describe('Parent folder ID to list child folders. Omit to list top-level folders.'),
  }))
  .output(z.object({
