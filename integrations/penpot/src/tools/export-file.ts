...
export let exportFileTool = SlateTool.create(
  spec,
  {
    name: 'Export File',
    key: 'export_file',
  ...
  .input(z.object({
    ...
    includeLibraries: z.boolean().optional().default(false).describe('Whether to include linked shared libraries in the export'),
    embedAssets: z.boolean().optional().default(false).describe('Whether to embed all assets directly in the export file'),
  }))
  .output(z.object({
