...
export let listDashboards = SlateTool.create(
  ...
  .input(z.object({
    dashboardId: z.string().optional().describe('Get a specific dashboard by ID. If omitted, lists all dashboards.')
  }))
  .output(z.object({
    ...
    })).optional().describe('List of dashboards'),
    dashboard: z.object({
      dashboardId: z.number().describe('Dashboard ID'),
      name: z.string().describe('Dashboard name'),
      accessLevel: z.string().optional().describe('Access level'),
    ...
    }).optional().describe('Full dashboard data')
  }))
