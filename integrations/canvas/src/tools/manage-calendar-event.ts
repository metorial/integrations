...
export let manageCalendarEventTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    eventId: z.string().optional().describe('Calendar event ID (required for update/delete)'),
    contextCode: z.string().optional().describe('Context code like "course_123" or "user_456" (required for create)'),
