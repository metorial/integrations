...
export let listConversationsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    scope: z.enum(['inbox', 'unread', 'archived', 'starred', 'sent']).optional().describe('Filter conversations by scope'),
  }))
  .output(z.object({
    conversations: z.array(z.object({
      ...
      lastMessage: z.string().optional().nullable().describe('Preview of the last message'),
      lastMessageAt: z.string().optional().nullable().describe('Timestamp of last message'),
      ...
      isPrivate: z.boolean().optional().describe('Whether this is a private (2-person) conversation'),
    })),
  }))
