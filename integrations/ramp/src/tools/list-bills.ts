...
export let listBills = SlateTool.create(
  ...
  .input(z.object({
    ...
    fromDueDate: z.string().optional().describe('Filter bills due after this date (ISO 8601)'),
    toDueDate: z.string().optional().describe('Filter bills due before this date (ISO 8601)'),
