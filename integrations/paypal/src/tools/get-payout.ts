...
export let getPayout = SlateTool.create(
  ...
  .input(z.object({
    payoutBatchId: z.string().optional().describe('Payout batch ID to retrieve batch details'),
    payoutItemId: z.string().optional().describe('Individual payout item ID to retrieve item details'),
  }))
  .output(z.object({
    ...
    })).optional().describe('Payout items'),
