...
export let createInvoice = SlateTool.create(
  ...
  .input(z.object({
    ...
    items: z.array(z.object({
      ...
      unitOfMeasure: z.string().optional().describe('Unit of measure (e.g. QUANTITY, HOURS, AMOUNT)'),
    ...
    sendImmediately: z.boolean().optional().describe('Whether to send the invoice immediately after creation'),
  }))
  .output(z.object({
