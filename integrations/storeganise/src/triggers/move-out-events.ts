...
export let moveOutEventsTrigger = SlateTrigger.create(
  spec,
  {
    name: 'Move-Out & Transfer Events',
    key: 'move_out_events',
    description: 'Triggers on move-out lifecycle events (created, completed, cancelled) and unit transfer completion.',
  }
)
  .input(z.object({
