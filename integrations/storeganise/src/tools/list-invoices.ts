...
export let listInvoicesTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    state: z.string().optional().describe('Filter by invoice state (e.g. "draft", "sent", "paid", "void")'),
    updatedAfter: z.string().optional().describe('Only return invoices updated after this UTC timestamp'),
