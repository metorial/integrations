...
Filter by a specific alias or tag, and optionally narrow results by date range. This is a **paid feature**.`,
  ...
  .input(z.object({
    type: z.enum(['timeline', 'general', 'sources', 'languages', 'location', 'weekday_popularity', 'hour_popularity']).describe('Type of analytics report to retrieve'),
    ...
    interval: z.enum(['minute', 'hour', 'day', 'week', 'month']).optional().describe('Time interval for timeline analytics'),
