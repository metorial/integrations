...
export let getQuotesTool = SlateTool.create(
  spec,
  {
...
export let getHistoricalBarsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    from: z.string().optional().describe('Start date (YYYY-MM-DD or relative like "YTD", "1MONTH", "1D")'),
    to: z.string().optional().describe('End date (YYYY-MM-DD)'),
    interval: z.enum(['5M', '15M', '30M', '1H', '1D', '1W', '1MONTH']).optional().default('1D').describe('Candle interval'),
  }))
  .output(z.object({
