...
Describe the desired audio including genre, mood, instruments, and style for best results.`,
  ...
  .input(z.object({
    prompt: z.string().describe('Text description of the desired audio. Include genre, mood, instruments, tempo, and style for best results.'),
    duration: z.number().min(1).max(180).optional().describe('Duration of the generated audio in seconds. Max 180 seconds.'),
