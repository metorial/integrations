...
export let createExpense = SlateTool.create(
  ...
  .input(z.object({
    ...
    jobItemId: z.number().optional().describe('ID of the job item (line item) this expense is for'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.supplierContactId !== undefined) body.supplierContactId = ctx.input.supplierContactId;
