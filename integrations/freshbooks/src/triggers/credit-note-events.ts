...
export let creditNoteEvents = SlateTrigger.create(
  spec,
  {
  ...
  .webhook({
    ...
    handleEvent: async (ctx) => {
      ...
      return {
        ...
        output: { creditNoteId: ctx.input.objectId, accountId: ctx.input.accountId, eventName: ctx.input.eventName, identityId: ctx.input.identityId },
      };
    },
  }).build();
