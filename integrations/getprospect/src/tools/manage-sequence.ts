...
export let getSequence = SlateTool.create(
  ...
  .input(z.object({
    sequenceId: z.string().optional().describe('ID of a specific sequence to retrieve. If omitted, lists all sequences.'),
    search: z.string().optional().describe('Search keyword to filter sequences'),
    page: z.number().optional().describe('Page number'),
    perPage: z.number().optional().describe('Results per page'),
  }))
  .output(z.object({
    sequence: sequenceSchema.optional().describe('Single sequence (when sequenceId is provided)'),
    sequences: z.array(sequenceSchema).optional().describe('List of sequences (when listing)'),
...
export let createSequence = SlateTool.create(
  spec,
  {
...
export let updateSequence = SlateTool.create(
  spec,
  {
...
export let deleteSequence = SlateTool.create(
  spec,
  {
