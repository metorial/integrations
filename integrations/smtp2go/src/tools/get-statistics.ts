...
export let getEmailStatistics = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    summary: z.any().describe('Combined email statistics summary including bounces, spam, unsubscribes, and cycle data'),
  }))
...
export let getEmailBounces = SlateTool.create(
  spec,
  {
...
export let getEmailHistory = SlateTool.create(
  spec,
  {
