...
- **delete**: Remove a field by specifying its fieldId.`,
  ...
  .input(z.object({
    ...
    fieldId: z.string().optional().describe('Field/column ID (required for update and delete)'),
    ...
    dtxp: z.string().optional().describe('Data type extra params, e.g. select options as comma-separated values'),
