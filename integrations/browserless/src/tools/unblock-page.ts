...
export let unblockPage = SlateTool.create(
  spec,
  {
    name: 'Unblock Page',
    key: 'unblock_page',
  ...
  .output(z.object({
    pageContent: z.string().nullable().describe('HTML content of the unblocked page, or null if not requested'),
    ...
    screenshotBase64: z.string().nullable().describe('Base64-encoded screenshot, or null if not requested'),
  }))
