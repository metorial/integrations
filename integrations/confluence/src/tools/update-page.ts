...
export let updatePage = SlateTool.create(spec, {
  ...
  .input(z.object({
    ...
    body: z.string().optional().describe('New page body in Confluence storage format (XHTML)'),
    versionNumber: z.number().describe('The current version number of the page (will be incremented)'),
    versionMessage: z.string().optional().describe('A message describing the changes in this version'),
