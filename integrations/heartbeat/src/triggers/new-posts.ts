...
export let newPosts = SlateTrigger.create(
  spec,
  {
    name: 'New Posts',
    key: 'new_posts',
    description: '[Polling fallback] Polls for new threads created in your Heartbeat community. Detects newly created threads and returns their content.',
  }
)
  .input(z.object({
