...
export let manageRoles = SlateTool.create(
  ...
  .input(z.discriminatedUnion('action', [
    ...
    z.object({
      ...
      color: z.number().optional().describe('Role color as integer (e.g., 16711680 for red)'),
  ...
  .output(z.object({
    ...
    role: roleOutputSchema.optional().describe('Created or updated role (for create/update actions)'),
    success: z.boolean().optional().describe('Whether the operation succeeded (for delete/assign/remove actions)'),
  }))
