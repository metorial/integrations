...
export let folioEvents = SlateTrigger.create(
  spec,
  {
    name: 'Folio Events',
    key: 'folio_events',
    description: 'Triggers on folio events: created, closed, reopened, balance changed, charges/payments/refunds posted, deposit items, and movements between folios.',
  }
)
  .input(z.object({
