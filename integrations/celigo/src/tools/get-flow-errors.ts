...
export let getFlowErrors = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    occurredAtFrom: z.string().optional().describe('Filter errors occurring on or after this time (ISO 8601 UTC)'),
    occurredAtTo: z.string().optional().describe('Filter errors occurring on or before this time (ISO 8601 UTC)')
  }))
  .output(z.object({
    ...
    nextPageUrl: z.string().optional().describe('URL for the next page of results, if more errors exist')
  }))
