...
export let startReplication = SlateTool.create(
  spec,
  {
...
export let stopReplication = SlateTool.create(
  spec,
  {
...
export let listExtractions = SlateTool.create(
  spec,
  {
...
export let listLoads = SlateTool.create(
  spec,
  {
    name: 'List Loads',
    key: 'list_loads',
...
export let getExtractionLogs = SlateTool.create(
  spec,
  {
