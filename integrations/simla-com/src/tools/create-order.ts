...
export let createOrder = SlateTool.create(
  ...
  .input(z.object({
    ...
    orderMethod: z.string().optional().describe('Order method code (e.g., phone, shopping-cart)'),
    ...
    }).optional().describe('Link to an existing customer'),
    items: z.array(z.object({
      ...
      discountManualAmount: z.number().optional().describe('Manual discount amount per unit'),
      discountManualPercent: z.number().optional().describe('Manual discount percentage'),
    ...
    })).optional().describe('Payment records'),
    discountManualAmount: z.number().optional().describe('Order-level manual discount amount'),
    discountManualPercent: z.number().optional().describe('Order-level manual discount percentage'),
