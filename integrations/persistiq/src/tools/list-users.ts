...
let userSchema = z.object({
  ...
  activated: z.boolean().optional().nullable().describe('Whether the user account is activated'),
  defaultMailboxId: z.string().optional().nullable().describe('Default mailbox ID for this user'),
