...
export let getPerformanceAdvisorTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    namespaces: z.string().optional().describe('Comma-separated list of namespaces to filter (e.g., "db.collection")'),
    durationMs: z.number().optional().describe('Duration in milliseconds to analyze (default: last 24 hours)'),
