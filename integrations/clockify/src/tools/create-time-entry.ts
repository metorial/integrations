...
export let createTimeEntry = SlateTool.create(
  ...
  .input(z.object({
    ...
    taskId: z.string().optional().describe('ID of the task to assign the entry to (requires projectId)'),
    tagIds: z.array(z.string()).optional().describe('Array of tag IDs to apply to the entry'),
