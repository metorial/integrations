...
export let getTemplate = SlateTool.create(
  ...
  .output(z.object({
    ...
    properties: z.array(z.object({
      key: z.string().describe('Combined component ID and property name, used as data key when rendering'),
    ...
    })).optional().describe('List of configurable template properties'),
  }))
