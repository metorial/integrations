...
export let getStatisticsTool = SlateTool.create(
  spec,
  {
    name: 'Get Statistics',
    key: 'get_statistics',
  ...
  .input(z.object({
    fields: z.array(z.enum([
      'pageviews', 'visitors', 'histogram',
      'pages', 'countries', 'referrers',
      'utm_sources', 'utm_mediums', 'utm_campaigns', 'utm_contents', 'utm_terms',
      'browser_names', 'os_names', 'device_types',
      'seconds_on_page',
    ])).optional().describe('Analytics fields to retrieve. If omitted, only pageviews and visitors totals are returned.'),
    start: z.string().optional().describe('Start date in YYYY-MM-DD format or a relative placeholder (e.g. "today-30d"). Defaults to 1 month ago.'),
    end: z.string().optional().describe('End date in YYYY-MM-DD format or a relative placeholder (e.g. "today"). Defaults to today.'),
    timezone: z.string().optional().describe('IANA timezone identifier (e.g. "Europe/Amsterdam", "America/New_York").'),
    limit: z.number().optional().describe('Maximum number of results per dimension field (1–1000).'),
    interval: z.enum(['hour', 'day', 'week', 'month', 'year']).optional().describe('Histogram bucket interval. Only used when "histogram" is included in fields.'),
    page: z.string().optional().describe('Filter by page path. Supports wildcards (e.g. "/blog*").'),
    country: z.string().optional().describe('Filter by country code (e.g. "NL", "US").'),
    referrer: z.string().optional().describe('Filter by referrer domain (e.g. "google.com").'),
    ...
    browserName: z.string().optional().describe('Filter by browser name (e.g. "Chrome", "Firefox").'),
    osName: z.string().optional().describe('Filter by operating system name (e.g. "Windows", "macOS").'),
    deviceType: z.string().optional().describe('Filter by device type (e.g. "desktop", "mobile", "tablet").'),
  }))
  .output(z.object({
    ...
    histogram: z.array(histogramEntrySchema).optional().describe('Time-series data broken down by the chosen interval'),
    pages: z.array(z.object({
      value: z.string().describe('Page path'),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Top pages by traffic'),
    countries: z.array(z.object({
      value: z.string().describe('Country code'),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Visitors by country'),
    referrers: z.array(z.object({
      value: z.string().describe('Referrer domain'),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by referrer source'),
    utmSources: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by UTM source'),
    utmMediums: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by UTM medium'),
    utmCampaigns: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by UTM campaign'),
    utmContents: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by UTM content'),
    utmTerms: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by UTM term'),
    browserNames: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by browser'),
    osNames: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by operating system'),
    deviceTypes: z.array(z.object({
      value: z.string(),
      pageviews: z.number().optional(),
      visitors: z.number().optional(),
    })).optional().describe('Traffic by device type'),
