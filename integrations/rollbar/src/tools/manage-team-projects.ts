...
export let manageTeamProjects = SlateTool.create(
  spec,
  {
...
Requires an **account-level** access token.`,
  ...
  .input(z.object({
    ...
    projectId: z.number().optional().describe('Project ID (required for "add" and "remove" actions)'),
  }))
  .output(z.object({
    projects: z.array(z.object({
      projectId: z.number().describe('Project ID'),
      name: z.string().optional().describe('Project name'),
    })).optional().describe('List of team projects'),
