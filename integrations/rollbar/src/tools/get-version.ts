...
export let getVersion = SlateTool.create(
  spec,
  {
    name: 'Get Version',
    key: 'get_version',
  ...
  .input(z.object({
    ...
    includeItems: z.boolean().optional().describe('Whether to also list items associated with this version'),
  ...
  .output(z.object({
    ...
    })).optional().describe('Items associated with this version'),
  }))
