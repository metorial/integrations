...
export let manageOpportunities = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    opportunityId: z.string().optional().describe('Opportunity ID (required for update and delete)'),
    name: z.string().optional().describe('Opportunity name'),
    stage: z.string().optional().describe('Sales stage (e.g., Prospecting, Qualification, Proposal, Closed Won, Closed Lost)'),
