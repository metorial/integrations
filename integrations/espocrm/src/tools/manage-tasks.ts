...
export let manageTasks = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.string().optional().describe('Task status (e.g., Not Started, Started, Completed, Canceled, Deferred)'),
    ...
    parentType: z.string().optional().describe('Parent entity type (e.g., Account, Contact, Lead, Opportunity, Case)'),
