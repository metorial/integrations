...
export let editMessageTool = SlateTool.create(
  spec,
  {
    name: 'Edit Message',
    key: 'edit_message',
  ...
  .input(z.object({
    chatId: z.string().optional().describe('Chat ID where the message was sent. Required unless editing an inline message.'),
    messageId: z.number().optional().describe('ID of the message to edit. Required unless editing an inline message.'),
    inlineMessageId: z.string().optional().describe('ID of the inline message to edit. Required if chatId/messageId are not provided.'),
