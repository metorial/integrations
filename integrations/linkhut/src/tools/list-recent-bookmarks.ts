...
export let listRecentBookmarks = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Maximum of 100 bookmarks can be returned.',
    ],
    tags: {
      readOnly: true,
    },
  ...
  .input(z.object({
    ...
    count: z.number().optional().describe('Number of bookmarks to return (1-100, default: 15)'),
  }))
  .output(z.object({
