...
export let updateInvoice = SlateTool.create(
  ...
  .input(z.object({
    ...
    customerId: z.string().optional().describe('ID of the customer to associate with the invoice'),
    ...
    discountType: z.string().optional().describe('Type of discount: "entity_level" or "item_level"'),
    lineItems: z.array(lineItemInputSchema).optional().describe('Line items for the invoice (replaces all existing line items)'),
    ...
    currencyCode: z.string().optional().describe('Currency code for the invoice (e.g. USD, EUR)'),
  ...
  .output(z.object({
    ...
    customerId: z.string().optional().describe('ID of the customer associated with the invoice'),
    customerName: z.string().optional().describe('Name of the customer associated with the invoice'),
    date: z.string().optional().describe('Invoice date in yyyy-MM-dd format'),
    dueDate: z.string().optional().describe('Due date of the invoice in yyyy-MM-dd format'),
    ...
    lastModifiedTime: z.string().optional().describe('Timestamp when the invoice was last modified'),
  }))
