...
export let getPerson = SlateTool.create(
  ...
  .input(z.object({
    ...
    includes: z.string().optional().describe('Comma-separated list of related data to include (e.g., "companies,tags,contact_details,addrs")'),
  }))
  .output(z.object({
    ...
    rawData: z.any().optional().describe('Complete raw person data from API including any requested includes'),
  }))
