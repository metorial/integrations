...
Set **parentId** to reply in a thread.`,
  ...
  .input(z.object({
    ...
    parentId: z.string().optional().describe('ID of the parent message to reply in a thread'),
    ...
    attachments: z.array(z.any()).optional().describe('Array of Adaptive Card attachment objects')
  }))
  .output(z.object({
