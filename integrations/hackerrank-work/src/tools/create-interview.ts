...
export let createInterview = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    interviewerEmails: z.array(z.string()).optional().describe('Email addresses of the interviewers'),
    sendEmail: z.boolean().optional().describe('Whether to send email invitations to participants'),
