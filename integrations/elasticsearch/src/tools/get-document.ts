...
export let getDocumentTool = SlateTool.create(
  spec,
  {
    name: 'Get Document',
    key: 'get_document',
  ...
  .input(z.object({
    ...
    documentIds: z.array(z.string()).optional().describe('Array of document IDs for multi-get'),
  }))
  .output(z.object({
    ...
    })).optional().describe('Array of documents for multi-get requests'),
  }))
