...
export let createKnowledgeGraph = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    description: z.string().max(255).optional().describe('Description of the Knowledge Graph'),
  }))
  .output(z.object({
...
export let listKnowledgeGraphs = SlateTool.create(
  spec,
  {
...
export let getKnowledgeGraph = SlateTool.create(
  spec,
  {
...
export let updateKnowledgeGraph = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    description: z.string().max(255).optional().describe('New description for the Knowledge Graph'),
  }))
  .output(z.object({
    graphId: z.string().describe('Unique ID of the Knowledge Graph'),
...
export let deleteKnowledgeGraph = SlateTool.create(
  spec,
  {
