...
export let manageTeamMembers = SlateTool.create(
  ...
  .input(z.object({
    teamId: z.string().describe('ID of the team'),
    addTeammateIds: z.array(z.string()).optional().describe('Teammate IDs to add to the team'),
    removeTeammateIds: z.array(z.string()).optional().describe('Teammate IDs to remove from the team'),
  }))
  .output(z.object({
    teamId: z.string(),
    updated: z.boolean(),
