...
export let addComment = SlateTool.create(
  ...
  .input(z.object({
    conversationId: z.string().optional().describe('Conversation ID to add a new comment to'),
    parentCommentId: z.string().optional().describe('Comment ID to reply to (for threaded comments)'),
