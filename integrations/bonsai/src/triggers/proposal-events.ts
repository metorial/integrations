    ...
    handleRequest: async (ctx) => {
      ...
      return {
        inputs: [{
          ...
          clientName: proposal.client_name ?? proposal.clientName ?? data.client_name ?? undefined,
          clientEmail: proposal.client_email ?? proposal.clientEmail ?? data.client_email ?? undefined,
