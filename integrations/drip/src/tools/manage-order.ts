...
export let manageOrder = SlateTool.create(
  ...
  .input(z.object({
    ...
    provider: z.string().describe('Ecommerce provider identifier (e.g. "shopify", "my_custom_platform").'),
    action: z.enum(['placed', 'updated', 'paid', 'fulfilled', 'refunded', 'canceled']).describe('Order lifecycle action.'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.totalDiscounts !== undefined) order['total_discounts'] = ctx.input.totalDiscounts;
