...
export let createQuery = SlateTool.create(
  spec,
  {
    name: 'Create Query',
    key: 'create_query',
  ...
  .input(z.object({
    ...
    additionalKeywords: z.array(z.string()).optional().describe('Supporting keywords for the analysis'),
    competitorsMode: z.enum(['top10', 'top30', 'top-intent']).optional().describe('Competitors analysis mode'),
  }))
  .output(z.object({
