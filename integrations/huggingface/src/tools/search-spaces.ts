...
export let searchSpacesTool = SlateTool.create(
  spec,
  {
    name: 'Search Spaces',
    key: 'search_spaces',
  ...
  .input(z.object({
    search: z.string().optional().describe('Search query to filter spaces by name or description'),
    author: z.string().optional().describe('Filter by author/organization'),
    tags: z.array(z.string()).optional().describe('Filter by tags'),
    sort: z.enum(['likes', 'lastModified', 'trending', 'createdAt']).optional().describe('Sort field'),
