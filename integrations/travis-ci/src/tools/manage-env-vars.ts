...
export let manageEnvVars = SlateTool.create(
  ...
  .input(z.object({
    ...
    envVarId: z.string().optional().describe('Environment variable ID. Required for update and delete actions.'),
    name: z.string().optional().describe('Variable name. Required for create, optional for update.'),
    value: z.string().optional().describe('Variable value. Required for create, optional for update.'),
    isPublic: z.boolean().optional().describe('Whether the variable value is publicly visible. Defaults to false.'),
  ...
  .output(z.object({
    ...
    envVar: z.object({
      ...
      isPublic: z.boolean().describe('Whether the value is public'),
      branch: z.string().nullable().optional().describe('Branch restriction'),
    }).optional().describe('Created or updated environment variable'),
