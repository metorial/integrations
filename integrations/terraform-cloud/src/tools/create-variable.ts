...
export let createVariableTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    category: z.enum(['terraform', 'env']).describe('"terraform" for Terraform input variables, "env" for environment variables'),
    hcl: z.boolean().optional().describe('Whether the value is HCL-formatted (default: false)'),
