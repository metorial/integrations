...
export let getWorkspaceTool = SlateTool.create(
  spec,
  {
    name: 'Get Workspace',
    key: 'get_workspace',
  ...
  .input(z.object({
    workspaceId: z.string().optional().describe('The workspace ID (e.g., ws-xxxxx). Provide either this or workspaceName.'),
    workspaceName: z.string().optional().describe('The workspace name. Provide either this or workspaceId.')
  }))
  .output(z.object({
