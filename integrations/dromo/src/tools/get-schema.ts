...
export let getSchema = SlateTool.create(
  ...
  .output(z.object({
    ...
    createdDate: z.string().optional().describe('ISO-8601 timestamp of when the schema was created'),
    updatedDate: z.string().optional().describe('ISO-8601 timestamp of when the schema was last updated'),
  }))
