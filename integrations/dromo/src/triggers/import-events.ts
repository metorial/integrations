...
export let importEvents = SlateTrigger.create(
  spec,
  {
    name: 'Import Events',
    key: 'import_events',
    description: 'Triggers when an import event occurs, including import completions, headless imports needing review, and headless import failures. Configure a managed webhook in the Dromo dashboard pointing to the webhook URL.',
  }
)
  .input(z.object({
    eventType: z.string().describe('Type of event: import_completed, headless_import_needs_review, or headless_import_failed'),
    ...
    }).optional().describe('User who performed the import'),
    ...
    developmentMode: z.boolean().optional().describe('Whether the import was in development mode'),
