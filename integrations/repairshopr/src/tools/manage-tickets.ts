...
export let searchTickets = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.string().optional().describe('Filter by status (e.g. "new", "in progress", "resolved")'),
    ...
    createdBefore: z.string().optional().describe('Filter tickets created before this date (YYYY-MM-DD)'),
    createdAfter: z.string().optional().describe('Filter tickets created after this date (YYYY-MM-DD)'),
...
export let addTicketComment = SlateTool.create(
  ...
  .input(z.object({
    ...
    doNotEmail: z.boolean().optional().describe('If true, do not email the customer about this comment'),
  }))
...
export let listTicketComments = SlateTool.create(
  spec,
  {
