...
export let listCalendars = SlateTool.create(
  ...
  .input(z.object({
    showHidden: z.boolean().optional().describe('Whether to include hidden calendars in the result'),
    showDeleted: z.boolean().optional().describe('Whether to include deleted calendars in the result'),
  ...
  .output(z.object({
    calendars: z.array(z.object({
      ...
      accessRole: z.string().optional().describe('Access role (owner, writer, reader, freeBusyReader)'),
      ...
      selected: z.boolean().optional().describe('Whether the calendar is selected in the UI'),
