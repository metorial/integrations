...
export let auth = SlateAuth.create()
  ...
  .addTokenAuth({
    ...
    inputSchema: z.object({
      apiKey: z.string().describe('Ragic API key. Generate it from Personal Settings > Profile in your Ragic account.'),
    }),
    getOutput: async (ctx) => {
      return {
        output: {
  ...
  .addCustomAuth({
    ...
    key: 'email_password',
    inputSchema: z.object({
      serverDomain: z.string().describe('Ragic server domain (e.g., www.ragic.com, na3.ragic.com)'),
