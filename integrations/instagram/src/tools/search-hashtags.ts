...
export let searchHashtagsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    ranking: z.enum(['recent', 'top']).optional().describe('Sort order: "recent" for latest posts, "top" for most popular (default: "recent")'),
  ...
  .output(z.object({
    ...
    media: z.array(z.object({
      ...
      mediaType: z.string().optional().describe('Media type: IMAGE, VIDEO, CAROUSEL_ALBUM'),
