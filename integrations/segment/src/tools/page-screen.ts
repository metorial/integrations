...
export let pageScreen = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    type: z.enum(['page', 'screen']).describe('Whether this is a page view (web) or screen view (mobile)'),
    ...
    properties: z.record(z.string(), z.any()).optional().describe('Properties of the page/screen (e.g. url, title, referrer)'),
