...
export let generateAvatarVideo = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    text: z.string().optional().describe('Script text for the avatar to speak (up to 2,000 characters)'),
    audioUrl: z.string().optional().describe('Public URL of audio file for the avatar (overrides text)'),
  }))
  .output(z.object({
