...
export let createProblem = SlateTool.create(
  spec,
  {
    name: 'Create Problem',
    key: 'create_problem',
...
export let getProblem = SlateTool.create(
  spec,
  {
    name: 'Get Problem',
    key: 'get_problem',
...
export let listProblems = SlateTool.create(
  spec,
  {
    name: 'List Problems',
    key: 'list_problems',
  ...
  .handleInvocation(async (ctx) => {
    ...
    let result = await client.listProblems({ page: ctx.input.page, perPage: ctx.input.perPage });
...
export let updateProblem = SlateTool.create(
  spec,
  {
    name: 'Update Problem',
    key: 'update_problem',
...
export let deleteProblem = SlateTool.create(
  spec,
  {
    name: 'Delete Problem',
    key: 'delete_problem',
