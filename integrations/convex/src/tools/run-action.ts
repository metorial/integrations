...
Returns the action result.`,
  ...
  .input(z.object({
    functionPath: z.string().describe('Path to the action function (e.g. "ai:generateEmbedding")'),
    args: z.record(z.string(), z.any()).optional().describe('Arguments to pass to the action function')
  }))
  .output(z.object({
