...
export let listPostsTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    category: z.string().optional().describe('Filter by category (new, improvement, fix, or custom)'),
    ...
    ignoreFilters: z.boolean().optional().describe('Retrieve all posts, ignoring segmentation'),
