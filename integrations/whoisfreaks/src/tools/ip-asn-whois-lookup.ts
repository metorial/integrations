...
export let ipAsnWhoisLookup = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    asn: z.string().optional().describe('Autonomous System Number to look up (e.g. "AS15169" or "15169")'),
  }))
  .output(z.object({
    whoisData: z.any().describe('WHOIS registration and network data for the queried IP or ASN'),
  }))
