...
export let messageSent = SlateTrigger.create(
  spec,
  {
    name: 'Message Sent',
    key: 'message_sent',
    description: 'Triggered when an outgoing message is sent to a contact on any channel (WhatsApp, Instagram, Messenger, Telegram, Live Chat).',
  }
)
  .input(z.object({
