...
export let codeMonitorNotification = SlateTrigger.create(
  spec,
  {
    name: 'Code Monitor Notification',
    key: 'code_monitor_notification',
    description: 'Triggered when a code monitor detects matching changes in new commits. Receives webhook notifications from Sourcegraph code monitors.'
  }
)
  .input(z.object({
    ...
    matchedCommits: z.array(z.object({
      repository: z.string().optional(),
      diffRanges: z.array(z.object({
  ...
  .output(z.object({
    monitorDescription: z.string().optional().describe('Description of the code monitor that fired'),
    monitorUrl: z.string().optional().describe('URL of the code monitor on Sourcegraph'),
    ...
    matchedCommits: z.array(z.object({
      ...
      commitOid: z.string().optional()
    })).optional().describe('Commits that matched the monitor query')
  }))
  .webhook({
    handleRequest: async (ctx) => {
      ...
      let monitorDescription = body.monitorDescription || body.monitor_description || body.description || '';
