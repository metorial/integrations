...
export let getObject = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeContent: z.boolean().optional().describe('Download and include the object content as text'),
  }))
  .output(z.object({
    objectName: z.string(),
    bucketName: z.string(),
    ...
    content: z.string().optional().describe('Object content (only if includeContent was true)'),
  }))
