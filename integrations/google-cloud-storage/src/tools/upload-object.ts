...
export let uploadObject = SlateTool.create(
  spec,
  {
    name: 'Upload Object',
    key: 'upload_object',
  ...
  .input(z.object({
    ...
    contentType: z.string().optional().describe('MIME type (e.g., "text/plain", "application/json"). Defaults to "application/octet-stream".'),
    customMetadata: z.record(z.string(), z.string()).optional().describe('Custom key-value metadata to attach to the object'),
  }))
  .output(z.object({
    objectName: z.string(),
    bucketName: z.string(),
