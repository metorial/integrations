...
export class PlaidClient {
  ...
  async getAccounts(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/accounts/get', this.body({
  ...
  async getBalance(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/accounts/balance/get', this.body({
      access_token: accessToken,
      ...(accountIds?.length && { options: { account_ids: accountIds } }),
    }));
    return data;
  ...
  async syncTransactions(accessToken: string, cursor?: string, count?: number) {
    let { data } = await this.axios.post('/transactions/sync', this.body({
      access_token: accessToken,
      ...(cursor && { cursor }),
      ...(count && { count }),
    }));
  ...
  async getTransactions(
    ...
    let { data } = await this.axios.post('/transactions/get', this.body({
      access_token: accessToken,
  ...
  async getAuth(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/auth/get', this.body({
      access_token: accessToken,
      ...(accountIds?.length && { options: { account_ids: accountIds } }),
    }));
    return data;
  ...
  async getIdentity(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/identity/get', this.body({
      access_token: accessToken,
      ...(accountIds?.length && { options: { account_ids: accountIds } }),
    }));
    return data;
  ...
  async getHoldings(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/investments/holdings/get', this.body({
      access_token: accessToken,
      ...(accountIds?.length && { options: { account_ids: accountIds } }),
    }));
    return data;
  ...
  async getInvestmentTransactions(
    ...
    let { data } = await this.axios.post('/investments/transactions/get', this.body({
      access_token: accessToken,
      start_date: startDate,
      end_date: endDate,
      ...(Object.keys(options).length > 0 && { options }),
  ...
  async getLiabilities(accessToken: string, accountIds?: string[]) {
    let { data } = await this.axios.post('/liabilities/get', this.body({
      access_token: accessToken,
      ...(accountIds?.length && { options: { account_ids: accountIds } }),
    }));
    return data;
  ...
  async searchInstitutions(
    ...
    let { data } = await this.axios.post('/institutions/search', this.body({
      query,
  ...
  async getInstitutionById(
    ...
    let { data } = await this.axios.post('/institutions/get_by_id', this.body({
  ...
  async createLinkToken(params: {
    ...
    let { data } = await this.axios.post('/link/token/create', this.body({
  ...
  async exchangePublicToken(publicToken: string) {
    let { data } = await this.axios.post('/item/public_token/exchange', this.body({
  ...
  async getItem(accessToken: string) {
    let { data } = await this.axios.post('/item/get', this.body({
      access_token: accessToken,
    }));
    return data;
  }
  ...
  async removeItem(accessToken: string) {
    let { data } = await this.axios.post('/item/remove', this.body({
      access_token: accessToken,
    }));
    return data;
  }
  ...
  async updateItemWebhook(accessToken: string, webhook: string) {
    let { data } = await this.axios.post('/item/webhook/update', this.body({
      access_token: accessToken,
      webhook,
    }));
    return data;
  ...
  async createAssetReport(
    ...
    let { data } = await this.axios.post('/asset_report/create', this.body({
  ...
  async getAssetReport(assetReportToken: string) {
    let { data } = await this.axios.post('/asset_report/get', this.body({
  ...
  async createTransferAuthorization(params: {
    ...
    let { data } = await this.axios.post('/transfer/authorization/create', this.body({
  ...
  async createTransfer(params: {
    ...
    let { data } = await this.axios.post('/transfer/create', this.body({
      access_token: params.accessToken,
      account_id: params.accountId,
  ...
  async getTransfer(transferId: string) {
    let { data } = await this.axios.post('/transfer/get', this.body({
  ...
  async cancelTransfer(transferId: string) {
    let { data } = await this.axios.post('/transfer/cancel', this.body({
      transfer_id: transferId,
    }));
    return data;
  }
  ...
  async listTransfers(opts?: {
    ...
    let { data } = await this.axios.post('/transfer/list', this.body({
  ...
  async syncTransferEvents(afterId?: number) {
    let { data } = await this.axios.post('/transfer/event/sync', this.body({
      after_id: afterId ?? 0,
    }));
    return data;
  }
  ...
  async evaluateSignal(params: {
    ...
    let { data } = await this.axios.post('/signal/evaluate', this.body({
      access_token: params.accessToken,
      account_id: params.accountId,
  ...
  async enrichTransactions(
    ...
    let { data } = await this.axios.post('/transactions/enrich', this.body({
