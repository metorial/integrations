...
export let manageCollection = SlateTool.create(
  ...
  .input(z.object({
    ...
    collectionId: z.string().optional().describe('The collection ID (required for update and delete)'),
    name: z.string().optional().describe('The collection name (required for create, optional for update)'),
    jsonData: z.array(z.record(z.string(), z.unknown())).optional().describe('Array of JSON objects as collection data'),
