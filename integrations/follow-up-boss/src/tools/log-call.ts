...
export let logCall = SlateTool.create(
  ...
  .input(z.object({
    ...
    incoming: z.boolean().optional().describe('Whether the call was incoming (true) or outgoing (false)'),
    duration: z.number().optional().describe('Call duration in seconds'),
    note: z.string().optional().describe('Notes about the call'),
    outcome: z.string().optional().describe('Call outcome (e.g., "connected", "no answer", "left voicemail")'),
