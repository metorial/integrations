...
export let sendEvent = SlateTool.create(
  ...
  .input(z.object({
    ...
    person: z.object({
      ...
      emails: z.array(z.object({ value: z.string(), type: z.string().optional() })).optional(),
      phones: z.array(z.object({ value: z.string(), type: z.string().optional() })).optional(),
    ...
    }).optional().describe('Property details associated with the event'),
