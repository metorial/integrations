...
export let listTemplates = SlateTool.create(
  ...
  .input(z.object({
    ...
    after: z.number().optional().describe('Cursor for pagination: return templates after this ID'),
    before: z.number().optional().describe('Cursor for pagination: return templates before this ID'),
  }))
  .output(z.object({
