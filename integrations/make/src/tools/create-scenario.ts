...
export let createScenario = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    blueprint: z.string().optional().describe('Blueprint JSON string defining the scenario modules and flow'),
    scheduling: z.record(z.string(), z.any()).optional().describe('Scheduling configuration for the scenario'),
