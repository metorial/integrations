...
export let cancelCards = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    thirdPartyContactId: z.string().describe('The third-party (external CRM) contact ID whose pending cards should be cancelled.'),
  }))
  .output(z.object({
    thirdPartyContactId: z.string().describe('The contact ID that was used for cancellation.'),
