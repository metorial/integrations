...
export let getMessageStatus = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    messageStatus: z.number().optional().describe('Delivery status: 1=Delivered, 2=Failed, 3=Expired, 4=Pending, 5=Not Found'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let statusLabel = messageStatus !== undefined ? messageStatusLabels[messageStatus] || 'Unknown' : undefined;
