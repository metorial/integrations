...
export let manageNote = SlateTool.create(
  ...
  .input(z.object({
    noteId: z.string().optional().describe('Note ID to update. If omitted, a new note is created.'),
    leadId: z.string().optional().describe('Lead ID to attach the note to (required when creating a new note)'),
