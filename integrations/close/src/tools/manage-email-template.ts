...
export let manageEmailTemplate = SlateTool.create(
  ...
  .input(z.object({
    templateId: z.string().optional().describe('Template ID to update. If omitted, a new template is created.'),
    name: z.string().optional().describe('Template name (required when creating a new template)'),
