...
export let getTickerDetails = SlateTool.create(
  ...
  .input(z.object({
    ...
    date: z.string().optional().describe('Point-in-time date (YYYY-MM-DD) to retrieve historical ticker details. Defaults to most recent.'),
  }))
  .output(z.object({
    ...
    shareClassSharesOutstanding: z.number().optional().describe('Outstanding shares for this share class'),
    ...
    }).optional().describe('Company headquarters address'),
