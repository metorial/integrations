...
export let listMessages = SlateTool.create(
  ...
  .input(z.object({
    ...
    before: z.string().optional().describe('Only return messages created before this ISO timestamp'),
    after: z.string().optional().describe('Only return messages created after this ISO timestamp'),
  ...
  .output(z.object({
    messages: z.array(z.object({
      ...
      channels: z.array(z.string()).optional().describe('Channels the message was tagged with'),
