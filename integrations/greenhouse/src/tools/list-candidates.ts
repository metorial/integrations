...
export let listCandidatesTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    createdAfter: z.string().optional().describe('Only return candidates created after this ISO 8601 timestamp'),
    createdBefore: z.string().optional().describe('Only return candidates created before this ISO 8601 timestamp'),
    updatedAfter: z.string().optional().describe('Only return candidates updated after this ISO 8601 timestamp'),
    updatedBefore: z.string().optional().describe('Only return candidates updated before this ISO 8601 timestamp'),
  }))
  .output(z.object({
