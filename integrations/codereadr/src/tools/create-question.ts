...
export let createQuestion = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    type: z.enum(['manual', 'manualnumeric', 'option', 'checkbox', 'dropdown', 'gps', 'dropboximage', 'webcollect']).optional().describe('Question input type. Defaults to "manual" (keyboard text entry).'),
  }))
  .output(z.object({
