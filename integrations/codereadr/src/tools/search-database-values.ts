...
export let searchDatabaseValues = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    valueLike: z.string().optional().describe('Partial barcode value to search for (wildcard match)'),
    ...
    validity: z.enum(['0', '1']).optional().describe('Filter by validity status: "1" for valid, "0" for invalid'),
