...
export let deleteQuestion = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    questionId: z.string().describe('Question ID to delete. Use comma-separated IDs for multiple, or "all" to delete all.'),
  }))
  .output(z.object({
