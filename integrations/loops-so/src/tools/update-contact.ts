...
export let updateContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    subscribed: z.boolean().optional().describe('Updated subscription status. Setting to true will re-subscribe previously unsubscribed contacts.'),
    ...
    customProperties: z.record(z.string(), z.unknown()).optional().describe('Custom contact properties to update as key-value pairs. Send null to reset a property.')
  }))
  .output(z.object({
