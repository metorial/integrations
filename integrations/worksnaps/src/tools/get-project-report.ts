...
export let getProjectReport = SlateTool.create(
  ...
  .input(z.object({
    ...
    reportType: z.enum(['time_entries', 'time_summary']).describe('Type of report to generate'),
    ...
    userIds: z.string().optional().describe('Semicolon-separated user IDs (required for time_entries report)'),
