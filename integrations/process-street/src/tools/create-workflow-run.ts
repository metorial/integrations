...
export let createWorkflowRun = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    name: z.string().optional().describe('Name for the new workflow run (max 1024 characters)'),
    dueDate: z.string().optional().describe('Due date for the workflow run in ISO 8601 format'),
