...
export let getAccountInfo = SlateTool.create(
  ...
  .input(z.object({}))
  .output(z.object({
    availableChecks: z.number().optional().describe('Number of remaining uptime check slots'),
    availableSmsCredits: z.number().optional().describe('Number of remaining SMS credits'),
    availableSmsTests: z.number().optional().describe('Number of remaining SMS test credits'),
    ...
    autoRefillSmsWhenLeft: z.number().optional().describe('Auto-refill triggers when credits fall below this'),
    ...
    availableTransactionChecks: z.number().optional().describe('Available transaction check slots'),
  }))
