...
export let getDividendsAndSplits = SlateTool.create(
  ...
  .input(z.object({
    ...
    dataType: z.enum(['dividends', 'splits', 'both']).optional().default('both').describe('Which corporate action data to retrieve'),
  }))
  .output(z.object({
