...
export let createPickerSession = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    maxItemCount: z.number().min(1).optional().describe('Maximum number of items the user can pick (defaults to 2000)'),
  }))
  .output(z.object({
