...
export let translateAudio = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    prompt: z.string().optional().describe('Optional English text to guide the translation style'),
    responseFormat: z.enum(['json', 'text', 'verbose_json']).optional().describe('Response format'),
