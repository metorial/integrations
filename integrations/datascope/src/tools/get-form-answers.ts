...
export let getFormAnswers = SlateTool.create(
  spec,
  {
...
Use **detailed mode** to get full question metadata including question types, section labels, subform indices, and linked list references.`,
  ...
  .input(z.object({
    ...
    detailed: z.boolean().optional().describe('If true, returns detailed format with full question metadata'),
    sortByModified: z.boolean().optional().describe('If true, sorts results by modification date'),
