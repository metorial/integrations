...
export let getProject = SlateTool.create(
  ...
  .output(z.object({
    ...
    maxTrainPct: z.number().optional().nullable().describe('Maximum training data percentage'),
    ...
    positiveClass: z.string().optional().nullable().describe('Positive class for binary classification'),
  }))
