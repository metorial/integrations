...
export let updateSession = SlateTool.create(
  ...
  .input(z.object({
    ...
    recordingAccessPolicy: z.array(z.enum(['participant', 'admin', 'teacher', 'student'])).optional()
      .describe('Roles allowed to access the recording. An empty array defers to organisation default policy.'),
  }))
  .output(z.object({
