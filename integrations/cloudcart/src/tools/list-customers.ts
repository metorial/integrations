...
export let listCustomers = SlateTool.create(
  ...
  .input(z.object({
    ...
    pageSize: z.number().min(1).max(100).optional().describe('Number of customers per page (max 100)'),
    sort: z.string().optional().describe('Sort field, prefix with - for descending (e.g. "-date_added")'),
