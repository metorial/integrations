...
export let bannedInstagramHashtags = SlateTool.create(
  spec,
  {
...
Use this before publishing Instagram content to avoid shadowbanning or reduced reach.`,
  ...
  .output(z.object({
    ...
    bannedHashtags: z.array(z.string()).describe('List of hashtags that are currently banned on Instagram'),
  }))
