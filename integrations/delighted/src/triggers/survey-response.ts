...
export let surveyResponseTrigger = SlateTrigger.create(
  spec,
  {
    ...
    key: 'survey_response',
    description: 'Triggers when a survey response is received or updated, including score selection, comment addition, and additional question answers.',
  }
)
  .input(z.object({
    eventType: z.string().describe('Type of event (survey_response.created or survey_response.updated)'),
    ...
    personProperties: z.record(z.string(), z.string()).optional().describe('Custom properties'),
