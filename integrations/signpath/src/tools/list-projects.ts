...
export let listProjects = SlateTool.create(
  ...
  .output(z.object({
    projects: z.array(z.object({
      ...
      signingPolicies: z.array(signingPolicySchema).describe('Signing policies configured for this project'),
      artifactConfigurations: z.array(artifactConfigSchema).describe('Artifact configurations for this project')
