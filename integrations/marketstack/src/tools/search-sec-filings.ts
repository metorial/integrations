...
export let searchSecFilings = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    companyName: z.string().optional().describe('Company name to search for (used for CIK lookup). Either companyName or cik is required.'),
    cik: z.string().optional().describe('SEC CIK code. If provided, skips the company name lookup.'),
    formType: z.string().optional().describe('Filter by SEC form type (e.g. "10-K", "10-Q", "8-K", "4")'),
