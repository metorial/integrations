...
export let searchTickers = SlateTool.create(
  ...
  .input(z.object({
    search: z.string().optional().describe('Search query to match against ticker symbol or company name'),
    exchange: z.string().optional().describe('Filter by exchange MIC code (e.g. "XNAS" for NASDAQ)'),
