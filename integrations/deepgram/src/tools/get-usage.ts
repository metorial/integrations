...
export let getUsageTool = SlateTool.create(
  spec,
  {
    name: 'Get Usage',
    key: 'get_usage',
  ...
  .input(z.object({
    ...
    method: z.string().optional().describe('Filter by method (e.g., "sync", "async", "streaming").'),
...
export let getBalancesTool = SlateTool.create(
  spec,
  {
    name: 'Get Balances',
    key: 'get_balances',
