...
export let searchVideos = SlateTool.create(
  spec,
  {
    name: 'Search Videos',
    key: 'search_videos',
  ...
  .input(z.object({
    query: z.string().describe('The search query (e.g., "nature", "city traffic", "cooking")'),
    ...
    locale: z.string().optional().describe('Locale for the search query (e.g., en-US, de-DE). Default: en-US'),
