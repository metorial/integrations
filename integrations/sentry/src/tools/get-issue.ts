...
export let getIssueTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeLatestEvent: z.boolean().optional().default(true).describe('Whether to include the latest event with stack trace'),
    includeTags: z.boolean().optional().default(false).describe('Whether to include tag breakdowns')
  }))
  .output(z.object({
    issueId: z.string(),
    shortId: z.string(),
    ...
    latestEvent: z.any().optional().describe('Latest event data including stack trace and context'),
