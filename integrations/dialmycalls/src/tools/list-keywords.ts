...
export let listKeywords = SlateTool.create(
  ...
  .input(z.object({
    keywordId: z.string().optional().describe('Fetch a specific keyword by ID. If omitted, lists all keywords.'),
  ...
  .output(z.object({
    keywords: z.array(z.object({
      ...
      status: z.string().optional().describe('Status: active, pendingdelete, onhold, billingdecline'),
