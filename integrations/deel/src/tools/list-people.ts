...
export let listPeople = SlateTool.create(
  ...
  .input(z.object({
    ...
    hiringTypes: z.array(z.string()).optional().describe('Filter by hiring type (e.g. "contractor", "employee", "eor_employee")'),
    search: z.string().optional().describe('Search by name or email'),
  }))
  .output(z.object({
    people: z.array(z.record(z.string(), z.any())).describe('List of people/worker profiles'),
