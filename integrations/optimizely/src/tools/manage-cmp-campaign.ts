...
export let manageCmpCampaign = SlateTool.create(
  spec,
  {
...
Campaigns are top-level containers for organizing related content tasks, briefs, and assets.`,
  ...
  .input(z.object({
    ...
    startDate: z.string().optional().describe('Start date in ISO 8601 format (for create/update)'),
    endDate: z.string().optional().describe('End date in ISO 8601 format (for create/update)'),
