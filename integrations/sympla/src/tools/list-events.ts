...
export let listEventsTool = SlateTool.create(
  ...
  .input(z.object({
    from: z.string().optional().describe('Filter events starting from this date (YYYY-MM-DD format)'),
    published: z.boolean().optional().describe('Filter by published status. Defaults to true.'),
