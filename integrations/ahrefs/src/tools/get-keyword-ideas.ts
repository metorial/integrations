...
export let getKeywordIdeas = SlateTool.create(
  spec,
  {
...
Also supports fetching search volume history and volume by country for deeper analysis. Use to expand keyword lists and find new ranking opportunities.`,
  ...
  .input(z.object({
    ...
    ideaType: z.enum(['matching', 'related', 'volume-by-country', 'volume-history']).optional().describe('Type of keyword ideas to retrieve. Defaults to "matching".'),
    country: z.string().optional().describe('Two-letter country code. Defaults to "us". Not applicable for volume-by-country.'),
