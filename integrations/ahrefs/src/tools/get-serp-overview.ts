...
export let getSerpOverview = SlateTool.create(
  spec,
  {
...
Use for competitive analysis of specific search queries to see which pages currently rank and their authority metrics.`,
  ...
  .input(z.object({
    ...
    country: z.string().optional().describe('Two-letter country code for localized SERP results (e.g., "us", "uk"). Defaults to "us".'),
