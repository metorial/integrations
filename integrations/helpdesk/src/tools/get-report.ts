...
export let getReport = SlateTool.create(
  ...
  .input(z.object({
    ...
    from: z.string().describe('Start date for the report in ISO 8601 format (e.g., 2024-01-01T00:00:00Z)'),
    to: z.string().describe('End date for the report in ISO 8601 format (e.g., 2024-01-31T23:59:59Z)'),
    ...
    includeSpam: z.boolean().optional().describe('Whether to include spam tickets in the report'),
  }))
  .output(z.object({
