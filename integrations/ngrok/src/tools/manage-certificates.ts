...
let tlsCertOutputSchema = z.object({
  ...
  subjectAlternativeNames: z.object({
    dnsNames: z.array(z.string()),
    ips: z.array(z.string())
  }).optional().nullable().describe('Subject alternative names'),
...
export let listTlsCertificates = SlateTool.create(
  spec,
  {
...
export let getTlsCertificate = SlateTool.create(
  spec,
  {
...
export let uploadTlsCertificate = SlateTool.create(
  spec,
  {
...
export let deleteTlsCertificate = SlateTool.create(
  spec,
  {
...
export let listCertificateAuthorities = SlateTool.create(
  spec,
  {
...
export let createCertificateAuthority = SlateTool.create(
  spec,
  {
...
export let deleteCertificateAuthority = SlateTool.create(
  spec,
  {
