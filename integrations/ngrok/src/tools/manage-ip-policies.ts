...
export let listIpPolicies = SlateTool.create(
  spec,
  {
...
export let getIpPolicy = SlateTool.create(
  spec,
  {
    name: 'Get IP Policy',
    key: 'get_ip_policy',
...
export let createIpPolicy = SlateTool.create(
  spec,
  {
...
export let updateIpPolicy = SlateTool.create(
  spec,
  {
...
export let deleteIpPolicy = SlateTool.create(
  spec,
  {
...
export let listIpPolicyRules = SlateTool.create(
  spec,
  {
...
export let createIpPolicyRule = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    action: z.enum(['allow', 'deny']).describe('Whether to allow or deny traffic from this CIDR'),
    description: z.string().optional().describe('Description (max 255 bytes)'),
    metadata: z.string().optional().describe('Metadata (max 4096 bytes)')
  }))
...
export let deleteIpPolicyRule = SlateTool.create(
  spec,
  {
