...
export let listBotUsers = SlateTool.create(
  spec,
  {
    name: 'List Bot Users',
    key: 'list_bot_users',
...
export let getBotUser = SlateTool.create(
  spec,
  {
    name: 'Get Bot User',
    key: 'get_bot_user',
...
export let createBotUser = SlateTool.create(
  spec,
  {
...
export let updateBotUser = SlateTool.create(
  spec,
  {
...
export let deleteBotUser = SlateTool.create(
  spec,
  {
