...
export let listSshCredentials = SlateTool.create(
  spec,
  {
...
export let createSshCredential = SlateTool.create(
  spec,
  {
...
export let deleteSshCredential = SlateTool.create(
  spec,
  {
...
export let listSshCertificateAuthorities = SlateTool.create(
  spec,
  {
...
export let createSshCertificateAuthority = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    privateKeyType: z.enum(['rsa', 'ecdsa', 'ed25519']).optional().describe('Key type (default ed25519)'),
...
export let deleteSshCertificateAuthority = SlateTool.create(
  spec,
  {
