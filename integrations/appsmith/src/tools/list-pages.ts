...
export let listPages = SlateTool.create(
  ...
  .output(z.object({
    pages: z.array(z.object({
      ...
      isDefault: z.boolean().optional().describe('Whether this is the default page of the application.'),
      isHidden: z.boolean().optional().describe('Whether the page is hidden from navigation.'),
