...
export let createSubitemTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    columnValues: z.record(z.string(), z.any()).optional().describe('Column values as a JSON object mapping column IDs to values'),
