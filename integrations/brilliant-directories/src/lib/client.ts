...
export class Client {
  ...
  async getUserByProperty(property: string, propertyValue: string, options?: { limit?: number; page?: string }): Promise<any> {
  ...
  async deleteUser(userId: string, deleteImages?: boolean): Promise<any> {
    ...
    let response = await this.axios.delete('/api/v2/user/delete', { data: this.toFormData(data) });
    return response.data;
  }
  ...
  async getLeadByProperty(property: string, propertyValue: string): Promise<any> {
    let response = await this.axios.get('/api/v2/leads/get', { params: { property, property_value: propertyValue } });
    return response.data;
  }

  async createLead(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/leads/create', this.toFormData({ ...data, bdapi_model: 'leads' }));
    return response.data;
  }

  async updateLead(data: Record<string, any>): Promise<any> {
    let response = await this.axios.put('/api/v2/leads/update', this.toFormData({ ...data, bdapi_model: 'leads' }));
    return response.data;
  }

  async matchLead(leadId: string, usersToMatch: string): Promise<any> {
    let response = await this.axios.post('/api/v2/leads/match', this.toFormData({
      lead_id: leadId,
  ...
  async getReviewByProperty(property: string, propertyValue: string): Promise<any> {
    let response = await this.axios.get('/api/v2/user_reviews/get', { params: { property, property_value: propertyValue } });
    return response.data;
  }

  async createReview(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/users_reviews/create', this.toFormData(data));
    return response.data;
  }
  ...
  async searchReviews(params: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/users_reviews/search', this.toFormData(params));
    return response.data;
  }
  ...
  async getPostByProperty(property: string, propertyValue: string): Promise<any> {
    let response = await this.axios.get('/api/v2/data_posts/get', { params: { property, property_value: propertyValue } });
    return response.data;
  }
  ...
  async getPortfolioGroupByProperty(property: string, propertyValue: string): Promise<any> {
    let response = await this.axios.get('/api/v2/users_portfolio_groups/get', { params: { property, property_value: propertyValue } });
    return response.data;
  }

  async createPortfolioGroup(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/users_portfolio_groups/create', this.toFormData(data));
    return response.data;
  }

  async updatePortfolioGroup(data: Record<string, any>): Promise<any> {
    let response = await this.axios.put('/api/v2/users_portfolio_groups/update', this.toFormData(data));
    return response.data;
  }
  ...
  async searchPortfolioGroups(params: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/users_portfolio_groups/search', this.toFormData(params));
    return response.data;
  }
  ...
  async createAlbumPhoto(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/users_portfolio/create', this.toFormData(data));
    return response.data;
  }

  async updateAlbumPhoto(data: Record<string, any>): Promise<any> {
    let response = await this.axios.put('/api/v2/users_portfolio/update', this.toFormData(data));
    return response.data;
  }
  ...
  async createCategory(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/data_categories/create', this.toFormData(data));
    return response.data;
  }

  async updateCategory(data: Record<string, any>): Promise<any> {
    let response = await this.axios.put('/api/v2/data_categories/update', this.toFormData(data));
    return response.data;
  }
  ...
  async searchCategories(params: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/data_categories/search', this.toFormData(params));
    return response.data;
  }
  ...
  async renderWidget(params: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/data_widgets/render', this.toFormData(params));
    return response.data;
  }
  ...
  async createUnsubscribe(data: Record<string, any>): Promise<any> {
    let response = await this.axios.post('/api/v2/unsubscribe_list/create', this.toFormData(data));
    return response.data;
  }

  async updateUnsubscribe(data: Record<string, any>): Promise<any> {
    let response = await this.axios.put('/api/v2/unsubscribe_list/update', this.toFormData(data));
    return response.data;
  }
