...
export let listExtractionRuns = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    runs: z.array(z.object({
      ...
      approved: z.boolean().optional().describe('Whether the results have been approved'),
      approverEmail: z.string().optional().describe('Email of the approver'),
      extractedFields: z.array(z.any()).optional().describe('Array of extracted data points'),
