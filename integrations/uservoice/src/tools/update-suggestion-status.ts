...
export let updateSuggestionStatus = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    notifySupporters: z.boolean().optional().describe('Whether to email supporters about this status change (default: false)'),
  }))
  .output(z.object({
