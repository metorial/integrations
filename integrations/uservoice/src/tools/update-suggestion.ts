...
export let updateSuggestion = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    categoryId: z.number().nullable().optional().describe('New category ID (null to remove)'),
    labelIds: z.array(z.number()).optional().describe('New label IDs (replaces existing labels)'),
