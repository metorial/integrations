...
Results can be filtered by status to retrieve only deliverable, undeliverable, risky, or unknown emails.`,
  ...
  .input(z.object({
    ...
    status: z.enum(['deliverable', 'undeliverable', 'risky', 'unknown']).optional().describe('Filter results by verification status'),
  ...
  .output(z.object({
    results: z.array(z.object({
      ...
      suggestion: z.string().nullable().describe('Suggested correction for misspelled domains'),
