...
export let upsertLanguageVariant = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    languageCodename: z.string().describe('Codename of the language for the variant (e.g., "en-US", "default")'),
    elements: z.array(z.object({
      elementCodename: z.string().describe('Codename of the element to set'),
      value: z.any().describe('Value for the element. Type depends on the element type (string, number, array, etc.)'),
