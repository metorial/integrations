...
export let updateCoupon = SlateTool.create(
  ...
  .input(z.object({
    ...
    isStorewide: z.boolean().optional().describe('Whether the coupon applies to all products'),
    ...
    requiresSubscriptionProduct: z.string().optional().describe('Product ID for subscriber-only restriction'),
  }))
  .output(z.object({
