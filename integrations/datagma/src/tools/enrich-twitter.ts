...
export let enrichTwitter = SlateTool.create(
  spec,
  {
...
Returns the Twitter profile data along with linked social profiles (LinkedIn, Facebook, GitHub), industry, skills, and interests.`,
  ...
  .input(z.object({
    ...
    linkedinUrl: z.string().optional().describe('LinkedIn URL without https:// (e.g. "linkedin.com/in/johndoe")'),
  ...
  .output(z.object({
    ...
    twitterEmail: z.string().optional().describe('Email associated with the Twitter account'),
