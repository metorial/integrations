...
export let createThread = SlateTool.create(
  ...
  .input(z.object({
    ...
    priority: z.number().optional().describe('Priority level (0=urgent, 1=high, 2=normal, 3=low)'),
    ...
    }).optional().describe('Tenant to associate with the thread'),
