...
export let pullRequestTrigger = SlateTrigger.create(
  spec,
  {
    name: 'Pull Request',
    key: 'pull_request',
    description: 'Triggered for pull request activity including opened, closed, merged, assigned, labeled, review requested, synchronized, and more.',
  }
)
  .input(z.object({
    action: z.string().describe('PR event action (e.g., opened, closed, synchronize, labeled)'),
