...
export let issuesTrigger = SlateTrigger.create(
  spec,
  {
    name: 'Issues',
    key: 'issues',
    description: 'Triggered for issue activity including opened, edited, closed, assigned, labeled, milestoned, and more.',
  }
)
  .input(z.object({
    action: z.string().describe('Issue event action (e.g., opened, closed, edited, labeled)'),
