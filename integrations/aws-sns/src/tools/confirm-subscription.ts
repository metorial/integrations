...
export let confirmSubscription = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Confirmation tokens expire after 2 days.',
    ],
    tags: {
      destructive: false,
      readOnly: false,
  ...
  .input(z.object({
    ...
    authenticateOnUnsubscribe: z.boolean().optional().describe('Require authentication for future unsubscribe requests'),
  }))
  .output(z.object({
