...
export let listCanvases = SlateTool.create(
  spec,
  {
    name: 'List Canvases',
    key: 'list_canvases',
  ...
  .input(z.object({
    ...
    lastEditTimeGt: z.string().optional().describe('Filter Canvases edited after this ISO 8601 timestamp')
  }))
  .output(z.object({
...
export let getCanvasDetails = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    steps: z.array(z.record(z.string(), z.any())).optional().describe('Canvas steps configuration'),
