...
export let getDataset = SlateTool.create(
  ...
  .output(z.object({
    ...
    })).optional().describe('Dataset parameters'),
    ...
    })).optional().describe('Tables in the dataset'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.includeRefreshSchedule) {
      ...
      } catch { output.refreshSchedule = null; }
    }
