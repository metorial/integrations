...
export let createSubproject = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'The subproject creation endpoint is currently in BETA.',
    ],
  ...
  .handleInvocation(async (ctx) => {
    ...
    let result = await client.createNested('projects', ctx.input.projectId, 'subprojects', body);
