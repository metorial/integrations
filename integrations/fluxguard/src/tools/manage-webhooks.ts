...
export let listWebhooks = SlateTool.create(
  ...
  .output(z.object({
    webhooks: z.array(z.object({
      ...
      secret: z.string().optional().describe('Secret key for verifying webhook signatures'),
...
export let createWebhook = SlateTool.create(
  ...
  .input(z.object({
    url: z.string().describe('The URL of the webhook endpoint to receive change notifications'),
  }))
  .output(z.object({
...
export let getWebhookSample = SlateTool.create(
  spec,
  {
