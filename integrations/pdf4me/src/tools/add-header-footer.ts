...
export let addHeaderFooter = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    location: z.enum(['header', 'footer']).default('footer').describe('Where to place the HTML content'),
    pages: z.string().default('all').describe('Pages to add header/footer to (e.g. "1,2,3" or "all")'),
