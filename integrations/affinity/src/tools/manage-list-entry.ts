...
export let addListEntry = SlateTool.create(
  spec,
  {
    name: 'Add List Entry',
    key: 'add_list_entry',
  ...
  .input(z.object({
    ...
    entityId: z.number().describe('ID of the entity (person, organization, or opportunity) to add'),
...
export let removeListEntry = SlateTool.create(
  spec,
  {
