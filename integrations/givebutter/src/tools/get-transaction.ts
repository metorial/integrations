...
export let getTransaction = SlateTool.create(
  ...
  .output(z.object({
    ...
    }).nullable().describe('Donor address'),
    ...
    givingSpace: z.object({
      givingSpaceId: z.number().nullable(),
      name: z.string().nullable(),
      amount: z.number().nullable(),
      message: z.string().nullable(),
    }).nullable().describe('Giving space details'),
    subTransactions: z.array(subTransactionSchema).describe('Sub-transactions with line items'),
