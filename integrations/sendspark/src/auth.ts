...
export let auth = SlateAuth.create()
  ...
  .addCustomAuth({
    ...
    inputSchema: z.object({
      apiKey: z.string().describe('Your Sendspark API Key, found in the API Credentials tab at https://sendspark.com/settings/api-credentials'),
      apiSecret: z.string().describe('Your Sendspark API Secret, found in the API Credentials tab at https://sendspark.com/settings/api-credentials'),
    }),
