...
export let getProspect = SlateTool.create(
  ...
  .output(z.object({
    ...
    status: z.string().optional().describe('Prospect video status: saved, billed, errored, processing, uploaded, or completed'),
    valid: z.boolean().optional(),
    createdAt: z.string().optional(),
    updatedAt: z.string().optional(),
    deletedAt: z.string().nullable().optional(),
    shareUrl: z.string().optional().describe('Share URL for the generated personalized video'),
