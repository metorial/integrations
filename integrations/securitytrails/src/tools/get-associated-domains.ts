...
let associatedDomainSchema = z.object({
...
export let getAssociatedDomains = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    hostname: z.string().describe('Domain to find associated domains for (e.g., "example.com")'),
