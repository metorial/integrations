...
export let getTemplate = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeLayers: z.boolean().optional().describe('Include layer data in the template response'),
    includePages: z.boolean().optional().describe('Include page data in the template response'),
    includeLockedLayers: z.boolean().optional().describe('Include locked layers when listing editable layers')
  }))
  .output(z.object({
    ...
    editableLayers: z.array(z.object({
