...
export let addIssueRelationTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    relationType: z.string().describe('Relationship type (e.g. "blocks", "is_blocked_by", "duplicates", "relates_to")'),
  }))
  .output(z.object({
...
export let removeIssueRelationTool = SlateTool.create(
  spec,
  {
