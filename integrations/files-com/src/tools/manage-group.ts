...
export let manageGroup = SlateTool.create(
  ...
  .input(z.object({
    ...
    adminIds: z.string().optional().describe('Comma-separated user IDs to add as group admins'),
    sftpPermission: z.boolean().optional().describe('Allow SFTP access for group members'),
    ftpPermission: z.boolean().optional().describe('Allow FTP/FTPS access for group members'),
    davPermission: z.boolean().optional().describe('Allow WebDAV access for group members'),
    restapiPermission: z.boolean().optional().describe('Allow REST API access for group members'),
  ...
  .output(z.object({
    ...
    group: z.object({
      ...
      name: z.string().describe('Group name'),
      notes: z.string().optional().describe('Group notes'),
    }).optional().describe('Created or updated group'),
