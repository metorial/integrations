...
export let extractionCompleted = SlateTrigger.create(
  spec,
  {
    ...
    description: 'Triggered when an asynchronous data extraction request completes. Receives the extraction result payload via webhook.',
  }
)
  .input(z.object({
    ...
    extractionId: z.string().optional().describe('Unique identifier for this extraction request.'),
