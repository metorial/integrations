...
export let validateEmail = SlateTool.create(
  ...
  .output(z.object({
    ...
    reason: z.string().describe('Specific reason for the result: accepted_email, invalid_format, invalid_domain, invalid_smtp, rejected_email, catch_all, disposable, no_connect, timeout, or other'),
    ...
    isFreeProvider: z.boolean().describe('Whether the email uses a free provider (e.g. Gmail, Yahoo)'),
  }))
