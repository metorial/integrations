...
export let getCampaignNotifications = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    notifications: z.array(z.object({
      ...
      notificationType: z.string().optional().describe('Type of notification (e.g., LATEST_CONVERSION)'),
      impressions: z.number().optional().describe('Number of times the notification was displayed'),
