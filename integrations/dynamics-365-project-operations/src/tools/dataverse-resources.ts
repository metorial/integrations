...
let queryFields = {
  ...
  pageSize: z
    ...
    .max(5000)
    .optional()
    .describe('Preferred Dataverse page size. Defaults to config.defaultPageSize when set.'),
  nextLink: z
    .string()
    .optional()
  ...
  SlateTool.create(spec, {
    ...
    .handleInvocation(async ctx => {
      ...
      let client = createProjectOperationsDataverseClient(ctx, {
        instanceUrl: typeof input.instanceUrl === 'string' ? input.instanceUrl : undefined
      });
