...
export let manageForm = SlateTool.create(
  spec,
  {
    name: 'Manage Form',
    key: 'manage_form',
  ...
  .input(z.object({
    action: z.enum(['list', 'get', 'list_submissions', 'subscribe']).describe('Action to perform'),
    formId: z.string().optional().describe('Form ID (required for get, list_submissions, subscribe)'),
