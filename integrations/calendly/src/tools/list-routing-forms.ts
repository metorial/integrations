...
export let listRoutingForms = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    organizationUri: z.string().describe('URI of the organization to list routing forms for'),
    routingFormUri: z.string().optional().describe('If provided, lists submissions for this specific routing form instead of listing forms'),
  ...
  .output(z.object({
    routingForms: z.array(z.object({
      ...
      createdAt: z.string(),
      updatedAt: z.string()
    })).optional().describe('Routing forms (when not querying submissions)'),
    submissions: z.array(z.object({
      ...
      createdAt: z.string(),
      updatedAt: z.string()
    })).optional().describe('Submissions for a specific routing form'),
