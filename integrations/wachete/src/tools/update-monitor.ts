...
Can modify the URL, XPath, alerts, notification endpoints, check frequency, and other settings.`,
  ...
  .input(z.object({
    ...
    })).optional().describe('Geographic proxy locations'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let updated = {
      ...
      ...(ctx.input.recurrenceInSeconds !== undefined && { recurrenceInSeconds: ctx.input.recurrenceInSeconds }),
      ...(ctx.input.alerts !== undefined && { alerts: ctx.input.alerts }),
      ...(ctx.input.notificationEndpoints !== undefined && { notificationEndpoints: ctx.input.notificationEndpoints }),
      ...(ctx.input.dynamicContent !== undefined && { dynamicContent: ctx.input.dynamicContent }),
      ...
      ...(ctx.input.crawlPagesFromAllDomains !== undefined && { crawlPagesFromAllDomains: ctx.input.crawlPagesFromAllDomains }),
