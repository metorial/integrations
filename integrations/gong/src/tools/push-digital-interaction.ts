...
export let pushDigitalInteraction = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    events: z.array(z.object({
      eventType: z.string().describe('Type of event (e.g., "ContentShared", "ContentViewed")'),
      ...
      customData: z.record(z.string(), z.string()).optional().describe('Additional custom key-value data'),
