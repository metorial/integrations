...
export let getScorecards = SlateTool.create(
  spec,
  {
    name: 'Get Scorecards',
    key: 'get_scorecards',
  ...
  .input(z.object({
    fromDateTime: z.string().optional().describe('Start of review date range in ISO 8601 format'),
    toDateTime: z.string().optional().describe('End of review date range in ISO 8601 format'),
