...
export let buildCdnUrl = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    operations: z.array(z.object({
      operation: z.enum([
        'preview', 'resize', 'crop', 'scale_crop', 'smart_resize',
        'autorotate', 'rotate', 'flip', 'mirror',
        'format', 'quality', 'progressive',
        'blur', 'sharp', 'enhance', 'grayscale', 'invert',
        'brightness', 'contrast', 'saturation',
      ]).describe('Image processing operation'),
      value: z.string().optional().describe('Operation value/parameters (e.g. "300x200", "90", "webp", "smart")'),
