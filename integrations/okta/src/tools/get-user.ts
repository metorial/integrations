...
export let getUserTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeGroups: z.boolean().optional().describe('Also fetch the user\'s group memberships'),
    includeApps: z.boolean().optional().describe('Also fetch the user\'s assigned applications'),
  }))
  .output(z.object({
    ...
    groups: z.array(z.object({
      ...
      name: z.string(),
      type: z.string(),
    })).optional().describe('User group memberships'),
    apps: z.array(z.object({
      appName: z.string(),
      appInstanceId: z.string(),
      label: z.string(),
    })).optional().describe('Assigned application links'),
  }))
