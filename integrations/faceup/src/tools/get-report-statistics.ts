...
export let getReportStatistics = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    dateFrom: z.string().optional().describe('ISO 8601 date string to filter statistics from (e.g., "2024-01-01T00:00:00.000Z"). If omitted, returns all available statistics.'),
  }))
  .output(z.object({
