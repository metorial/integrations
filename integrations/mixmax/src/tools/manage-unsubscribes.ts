...
export let listUnsubscribes = SlateTool.create(
  spec,
  {
...
export let addUnsubscribe = SlateTool.create(
  spec,
  {
...
export let removeUnsubscribe = SlateTool.create(
  spec,
  {
