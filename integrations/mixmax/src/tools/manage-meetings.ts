...
let meetingTypeSchema = z.object({
  ...
  }).optional().describe('Default meeting details'),
});
...
export let listMeetingTypes = SlateTool.create(
  spec,
  {
...
export let manageMeetingType = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    meetingTypeId: z.string().optional().describe('Meeting type ID (required for update/delete)'),
    name: z.string().optional().describe('Meeting type name'),
    durationMin: z.number().optional().describe('Duration in minutes'),
...
export let listMeetingInvites = SlateTool.create(
  spec,
  {
