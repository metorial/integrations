...
export let sendEmail = SlateTool.create(
  ...
  .input(z.object({
    ...
    trackingEnabled: z.boolean().optional().describe('Enable open tracking (default: false)'),
    linkTrackingEnabled: z.boolean().optional().describe('Enable link click tracking (default: false)'),
  }))
  .output(z.object({
