...
export let listDesigns = SlateTool.create(
  ...
  .input(z.object({
    designType: z.enum(['static', 'animated', 'printer', 'printer_multipage']).optional()
      .describe('Filter designs by type. Static for images, animated for videos/GIFs/HTML5, printer for PDFs, printer_multipage for multi-page PDFs.'),
    categoryId: z.string().optional()
      .describe('Filter designs by category UUID.'),
  }))
  .output(z.object({
    designs: z.array(z.object({
      ...
      type: z.string().describe('Design type: static, animated, printer, or printer_multipage'),
