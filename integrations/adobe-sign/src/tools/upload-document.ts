...
export let uploadDocument = SlateTool.create(
  ...
  .input(z.object({
    fileName: z.string().describe('Name of the file including extension (e.g., "contract.pdf")'),
    fileContent: z.string().describe('Base64-encoded file content'),
    mimeType: z.string().optional().describe('MIME type of the file (e.g., "application/pdf"). Defaults to "application/pdf".')
  }))
  .output(z.object({
    transientDocumentId: z.string().describe('ID of the uploaded transient document, used to reference this document when creating agreements')
  }))
