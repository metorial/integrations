...
Use this for **company enrichment** — get comprehensive metadata about any business.`,
  ...
  .input(z.object({
    domain: z.string().optional().describe('Company website domain (e.g., "tesla.com"). Most reliable lookup method.'),
  ...
  .output(z.object({
    ...
    latestFundingRound: z.string().nullable().optional().describe('Latest funding round type'),
    latestFundingDate: z.string().nullable().optional().describe('Date of the latest funding round'),
    techstack: z.array(z.string()).nullable().optional().describe('Technologies used by the company'),
