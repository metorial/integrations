...
export let getAlias = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    aliasName: z.string().describe('The alias path to look up (e.g., "my-link" or "aBcDe012").'),
  ...
  .output(z.object({
    ...
    snippets: z.array(z.object({
      ...
      parameters: z.record(z.string(), z.string()).optional().describe('Snippet parameters.'),
