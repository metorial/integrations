...
export let generatePageTool = SlateTool.create(
  spec,
  {
    name: 'Generate Page',
    key: 'generate_page',
...
Use this to programmatically create page content for Sketch documents, including artboards sized for common device screens and layers with fills, borders, and text.`,
  ...
  .output(z.object({
    page: z.record(z.string(), z.unknown()).describe('The generated Sketch page JSON object, ready to be placed in the pages/ folder of a .sketch archive'),
  }))
