...
Use **skipGeocoding** to only retrieve enrichment field data for coordinates without performing address lookup (reduces cost).`,
  ...
  .input(z.object({
    ...
    skipGeocoding: z.boolean().optional().describe('If true, skip address lookup and only return field append data'),
  }))
  .output(z.object({
    results: z.array(z.object({
      ...
      stableAddressKey: z.string().optional().describe('Persistent identifier for this address'),
