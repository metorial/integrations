...
export let stackEvents = SlateTrigger.create(
  spec,
  {
    name: 'Stack Events',
    key: 'stack_events',
    description: 'Triggered when stack lifecycle events occur, including updates, previews, destroys, refreshes, and stack creation/deletion.',
  }
)
  .input(z.object({
