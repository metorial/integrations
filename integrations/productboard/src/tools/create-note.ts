...
export let createNoteTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    displayUrl: z.string().optional().describe('URL to link to the original source of this feedback'),
    sourceOrigin: z.string().optional().describe('Origin system of the note (e.g. "zendesk", "intercom")'),
    ...
    customerEmail: z.string().optional().describe('Email of the customer providing feedback'),
