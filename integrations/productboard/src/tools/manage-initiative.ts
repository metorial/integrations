...
export let listInitiativesTool = SlateTool.create(
  spec,
  {
...
export let getInitiativeTool = SlateTool.create(
  spec,
  {
    name: 'Get Initiative',
    key: 'get_initiative',
...
export let createInitiativeTool = SlateTool.create(
  spec,
  {
...
export let updateInitiativeTool = SlateTool.create(
  spec,
  {
...
export let deleteInitiativeTool = SlateTool.create(
  spec,
  {
