...
export let createBulkRun = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    inputParametersList: z.array(z.record(z.string(), z.any())).describe('Array of input parameter objects, each typically containing an "originUrl" key'),
  }))
  .output(z.object({
