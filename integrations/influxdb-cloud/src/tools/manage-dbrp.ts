...
let dbrpSchema = z.object({
  ...
  isDefault: z.boolean().optional().describe('Whether this is the default mapping for the database'),
  orgId: z.string().optional().describe('Organization ID'),
});

export let listDBRPs = SlateTool.create(
  spec,
  {
...
export let createDBRP = SlateTool.create(
  spec,
  {
...
export let deleteDBRP = SlateTool.create(
  spec,
  {
