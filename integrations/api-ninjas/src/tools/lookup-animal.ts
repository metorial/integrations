...
export let lookupAnimal = SlateTool.create(
  spec,
  {
    name: 'Lookup Animal',
    key: 'lookup_animal',
  ...
  .output(z.object({
    animals: z.array(z.object({
      ...
      }).optional().describe('Taxonomic classification'),
      locations: z.array(z.string()).optional().describe('Geographic locations where found'),
      characteristics: z.record(z.string(), z.any()).optional().describe('Physical and behavioral characteristics'),
