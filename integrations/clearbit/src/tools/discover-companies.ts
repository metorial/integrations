...
export let discoverCompanies = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Each company returned counts toward your monthly quota.',
    ],
    tags: {
      readOnly: true,
    },
  ...
  .input(z.object({
    query: z.string().describe('Discovery query string (e.g., "tech:marketo", "similar:salesforce.com", "and:(tech:react employees:100~)")'),
