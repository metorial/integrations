...
export let createUser = SlateTool.create(
  ...
  .input(z.object({
    ...
    customProperties: z.record(z.string(), z.string()).optional().describe('Custom user properties as key-value pairs'),
  }))
  .output(z.object({
    userId: z.string().describe('User ID'),
    isNew: z.boolean().describe('Whether the user was newly created (false if existing user was updated)'),
  }))
