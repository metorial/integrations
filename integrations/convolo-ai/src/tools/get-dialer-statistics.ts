...
let durationMetricsSchema = z.object({
...
let directionStatsSchema = z.object({
...
export let getDialerStatistics = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    types: z.array(z.number()).optional().describe('Call types: 0=inbound, 1=outbound, 2=internal'),
    states: z.array(z.number()).optional().describe('Call states: 0=unanswered, 1=answered, 2=failed'),
