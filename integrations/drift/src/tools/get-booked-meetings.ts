...
export let getBookedMeetings = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    limit: z.number().optional().describe('Maximum number of meetings to return (max 1000, default 100)'),
  }))
  .output(z.object({
    meetings: z.array(z.object({
      ...
      scheduledAt: z.number().optional().describe('When the meeting was scheduled (epoch ms)'),
      ...
      conferenceType: z.string().optional().describe('Conference type (e.g., Zoom, Google Meet)'),
    })),
  }))
