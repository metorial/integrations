...
export class VimeoClient {
  ...
  async listMyVideos(params?: PaginationParams & {
    query?: string;
    sort?: string;
    direction?: string;
    filter?: string;
  ...
  async searchVideos(query: string, params?: PaginationParams & {
    sort?: string;
    direction?: string;
    filter?: string;
  }): Promise<PaginatedResponse<any>> {
  ...
  async editVideo(videoId: string, data: {
    name?: string;
    description?: string;
    privacy?: { view?: string; embed?: string; download?: boolean; add?: boolean; comments?: string };
    password?: string;
    tags?: string[];
    embedDomains?: string[];
    license?: string;
  ...
  async addVideoTextTrack(videoId: string, data: {
    language: string;
    name: string;
    type: string;
    active?: boolean;
  }): Promise<any> {
    let response = await api.post(`/videos/${videoId}/texttracks`, data, { headers: this.headers });
    return response.data;
  }

  async getVideoComments(videoId: string, params?: PaginationParams): Promise<PaginatedResponse<any>> {
  ...
  async addVideoComment(videoId: string, text: string): Promise<any> {
    let response = await api.post(`/videos/${videoId}/comments`, { text }, { headers: this.headers });
    return response.data;
  }
  ...
  async getLikedVideos(params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async listShowcases(params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async editShowcase(showcaseId: string, data: {
    name?: string;
    description?: string;
    privacy?: string;
    password?: string;
    ...
    let response = await api.patch(`/me/albums/${showcaseId}`, body, { headers: this.headers });
    return response.data;
  }
  ...
  async getShowcaseVideos(showcaseId: string, params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async listFolders(params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async editFolder(folderId: string, name: string): Promise<any> {
    let response = await api.patch(`/me/folders/${folderId}`, { name }, { headers: this.headers });
    return response.data;
  }
  ...
  async getFolderVideos(folderId: string, params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async addVideoToFolder(folderId: string, videoUri: string): Promise<void> {
    await api.put(`/me/folders/${folderId}/videos`, { uris: [videoUri] }, { headers: this.headers });
  }
  ...
  async getChannelVideos(channelId: string, params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async getCategoryVideos(categoryName: string, params?: PaginationParams & { sort?: string }): Promise<PaginatedResponse<any>> {
  ...
  async editLiveEvent(liveEventId: string, data: {
    title?: string;
    description?: string;
    privacy?: { view?: string };
    autoPlay?: boolean;
    ...
    let response = await api.patch(`/me/live_events/${liveEventId}`, body, { headers: this.headers });
    return response.data;
  }
