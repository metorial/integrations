...
export let mailingEvents = SlateTrigger.create(
  spec,
  {
    name: 'Mailing Events',
    key: 'mailing_events',
    description: 'Triggers on mailing events: created, updated, destroyed, bounced, delivered, opened, or replied.',
  }
)
  .input(z.object({
    eventAction: z.string().describe('The action (created, updated, destroyed, bounced, delivered, opened, replied)'),
