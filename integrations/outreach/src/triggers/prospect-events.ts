...
export let prospectEvents = SlateTrigger.create(
  ...
  .input(z.object({
    eventAction: z.string().describe('The action that occurred (created, updated, destroyed)'),
    resourceId: z.string().describe('ID of the affected prospect'),
    resourceAttributes: z.record(z.string(), z.any()).describe('Prospect attributes from the webhook payload'),
