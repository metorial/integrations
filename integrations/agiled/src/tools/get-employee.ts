...
export let getEmployee = SlateTool.create(
  ...
  .input(z.object({
    employeeId: z.string().optional().describe('ID of a specific employee to retrieve. If omitted, lists employees.'),
    page: z.number().optional().describe('Page number for pagination'),
    perPage: z.number().optional().describe('Number of employees per page'),
  }))
  .output(z.object({
    employees: z.array(z.record(z.string(), z.unknown())).describe('Array of employee records'),
