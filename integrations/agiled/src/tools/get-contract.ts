...
export let getContract = SlateTool.create(
  ...
  .input(z.object({
    contractId: z.string().optional().describe('ID of a specific contract to retrieve. If omitted, lists contracts.'),
    page: z.number().optional().describe('Page number for pagination'),
    perPage: z.number().optional().describe('Number of contracts per page'),
  }))
  .output(z.object({
    contracts: z.array(z.record(z.string(), z.unknown())).describe('Array of contract records'),
