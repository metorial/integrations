...
export let listPlans = SlateTool.create(
  ...
  .output(z.object({
    plans: z.array(z.object({
      ...
      billingInterval: z.string().nullable().describe('Billing interval for recurring plans'),
      ...
      minBillingCycles: z.number().nullable().describe('Minimum billing cycles before cancellation allowed'),
      userSelectsAmount: z.boolean().describe('Whether user selects the amount (donation mode)'),
