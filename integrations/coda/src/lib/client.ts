...
export class Client {
  ...
  async updateDoc(docId: string, body: {
    title?: string;
    iconName?: string;
  }) {
  ...
  async updateFolder(folderId: string, body: {
    name?: string;
  }) {
  ...
  async listPages(docId: string, params?: {
    limit?: number;
    pageToken?: string;
  }) {
  ...
  async createPage(docId: string, body: {
    name: string;
    subtitle?: string;
    iconName?: string;
    imageUrl?: string;
  ...
  async updatePage(docId: string, pageIdOrName: string, body: {
    name?: string;
    subtitle?: string;
    iconName?: string;
    imageUrl?: string;
    contentUpdate?: { insertionIndex?: number; canvasContent?: { type: string; body: string } };
  }) {
    let response = await http.put(`/docs/${docId}/pages/${encodeURIComponent(pageIdOrName)}`, body, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async deletePage(docId: string, pageIdOrName: string) {
    let response = await http.delete(`/docs/${docId}/pages/${encodeURIComponent(pageIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }

  async getPageContent(docId: string, pageIdOrName: string, params?: {
    outputFormat?: 'html' | 'markdown';
  }) {
    let response = await http.get(`/docs/${docId}/pages/${encodeURIComponent(pageIdOrName)}/content`, {
      headers: this.headers,
      params,
    });
    return response.data;
  ...
  async beginPageExport(docId: string, pageIdOrName: string, body: {
    outputFormat: 'html' | 'markdown';
  }) {
    let response = await http.post(`/docs/${docId}/pages/${encodeURIComponent(pageIdOrName)}/export`, body, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getPageExportStatus(docId: string, pageIdOrName: string, requestId: string) {
    let response = await http.get(`/docs/${docId}/pages/${encodeURIComponent(pageIdOrName)}/export/${requestId}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async listTables(docId: string, params?: {
    limit?: number;
    pageToken?: string;
    sortBy?: string;
    tableTypes?: string;
  ...
  async getTable(docId: string, tableIdOrName: string) {
    let response = await http.get(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async listColumns(docId: string, tableIdOrName: string, params?: {
    limit?: number;
    pageToken?: string;
    visibleOnly?: boolean;
  }) {
    let response = await http.get(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/columns`, {
      headers: this.headers,
      params,
    });
    return response.data;
  ...
  async getColumn(docId: string, tableIdOrName: string, columnIdOrName: string) {
    let response = await http.get(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/columns/${encodeURIComponent(columnIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async listRows(docId: string, tableIdOrName: string, params?: {
    query?: string;
    sortBy?: string;
    ...
    let response = await http.get(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows`, {
      headers: this.headers,
      params,
    });
    return response.data;
  ...
  async getRow(docId: string, tableIdOrName: string, rowIdOrName: string, params?: {
    useColumnNames?: boolean;
    valueFormat?: 'simple' | 'simpleWithArrays' | 'rich';
  }) {
    let response = await http.get(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows/${encodeURIComponent(rowIdOrName)}`, {
      headers: this.headers,
      params,
    });
    return response.data;
  ...
  async upsertRows(docId: string, tableIdOrName: string, body: {
    rows: Array<{ cells: Array<{ column: string; value: any }> }>;
    keyColumns?: string[];
  }) {
    let response = await http.post(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows`, body, {
      headers: this.headers,
    });
    return response.data;
  }

  async updateRow(docId: string, tableIdOrName: string, rowIdOrName: string, body: {
    row: { cells: Array<{ column: string; value: any }> };
  }) {
    let response = await http.put(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows/${encodeURIComponent(rowIdOrName)}`, body, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async deleteRow(docId: string, tableIdOrName: string, rowIdOrName: string) {
    let response = await http.delete(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows/${encodeURIComponent(rowIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }

  async deleteRows(docId: string, tableIdOrName: string, body: {
    rowIds: string[];
  }) {
    let response = await http.delete(`/docs/${docId}/tables/${encodeURIComponent(tableIdOrName)}/rows`, {
      headers: this.headers,
      data: body,
    });
    return response.data;
  ...
  async pushButton(docId: string, tableIdOrName: string, rowIdOrName: string, columnIdOrName: string) {
  ...
  async listFormulas(docId: string, params?: {
    limit?: number;
    pageToken?: string;
  }) {
  ...
  async getFormula(docId: string, formulaIdOrName: string) {
    let response = await http.get(`/docs/${docId}/formulas/${encodeURIComponent(formulaIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async listControls(docId: string, params?: {
    limit?: number;
    pageToken?: string;
  }) {
  ...
  async getControl(docId: string, controlIdOrName: string) {
    let response = await http.get(`/docs/${docId}/controls/${encodeURIComponent(controlIdOrName)}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async listPermissions(docId: string, params?: {
    limit?: number;
    pageToken?: string;
  }) {
  ...
  async addPermission(docId: string, body: {
  ...
  async searchPrincipals(docId: string, params?: {
    query?: string;
    limit?: number;
    pageToken?: string;
  }) {
  ...
  async updateAclSettings(docId: string, body: {
  ...
  async publishDoc(docId: string, body: {
    slug?: string;
  ...
  async createWebhook(docId: string, body: {
    url: string;
    eventTypes: string[];
  }) {
  ...
  async listPageAnalytics(docId: string, params?: {
    sinceDate?: string;
    untilDate?: string;
    limit?: number;
    pageToken?: string;
