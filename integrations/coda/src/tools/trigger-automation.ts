...
export let triggerAutomationTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    payload: z.record(z.string(), z.any()).optional().describe('JSON payload to send to the automation, accessible as Step 1 Result'),
  }))
  .output(z.object({
