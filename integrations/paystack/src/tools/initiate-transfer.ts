...
export let initiateTransfer = SlateTool.create(
  spec,
  {
...
Amounts are in the **smallest currency unit**.`,
  ...
  .input(z.object({
    ...
    recipientCode: z.string().describe('Recipient code (from creating a transfer recipient)'),
    reason: z.string().optional().describe('Reason for the transfer'),
    currency: z.string().optional().describe('Currency code'),
    reference: z.string().optional().describe('Unique transfer reference. Auto-generated if not provided'),
  }))
  .output(z.object({
...
export let createTransferRecipient = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    type: z.enum(['nuban', 'mobile_money', 'basa', 'authorization']).describe('Recipient type: nuban (Nigerian bank), mobile_money, basa (South African bank), authorization'),
    name: z.string().describe('Recipient name'),
    accountNumber: z.string().describe('Account number or mobile money number'),
    bankCode: z.string().describe('Bank code (use List Banks tool or verify bank account to find this)'),
