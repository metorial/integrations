...
export let customerIdentificationEvents = SlateTrigger.create(
  spec,
  {
  ...
  .webhook({
        ...
        inputs: [
          {
            ...
            identificationStatus: event === 'customeridentification.success' ? 'success' : 'failed',
          },
        ],
      };
    },
    ...
    handleEvent: async (ctx) => {
      return {
        type: ctx.input.identificationStatus === 'success'
