...
export let getTask = SlateTool.create(
  ...
  .output(z.object({
    ...
    duration: z.union([z.string(), z.number()]).optional().describe('Duration in minutes or special value'),
    ...
    chunks: z.array(z.any()).optional().describe('Scheduling chunks with IDs, durations, and times'),
    customFieldValues: z.any().optional().describe('Custom field values keyed by field name'),
