...
let alertContactSchema = z.object({
  ...
  type: z.number().describe('Contact type: 1=SMS, 2=Email, 3=Twitter, 5=WebHook, 6=Pushbullet, 7=Zapier, 9=Pushover, 11=Slack'),
...
export let listAlertContacts = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    contactIds: z.array(z.string()).optional().describe('Filter to specific alert contact IDs'),
