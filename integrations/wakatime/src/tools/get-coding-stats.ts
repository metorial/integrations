...
export let getCodingStats = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    range: z.string().default('last_7_days').describe('Time range: "last_7_days", "last_30_days", "last_6_months", "last_year", "all_time", or "YYYY" / "YYYY-MM"'),
  ...
  .output(z.object({
    ...
    }).optional().describe('Day with the most coding activity'),
