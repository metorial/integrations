...
export let listIncidents = SlateTool.create(
  ...
  .input(z.object({
    ...
    limit: z.number().optional().describe('Number of incidents to return (max 100, default 20)'),
    sort: z.enum(['createdAt', 'updatedAt', 'status', 'priority']).optional().describe('Field to sort by'),
