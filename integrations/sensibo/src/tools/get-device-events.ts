...
let eventSchema = z.object({
  ...
  eventType: z.string().optional().describe('Type of event (e.g. acStateChange, scheduleChange, climateReactTrigger)'),
  ...
  }).optional().describe('AC state associated with the event'),
  triggeredBy: z.string().optional().describe('What triggered the event (user, schedule, climateReact, etc.)'),
});

export let getDeviceEventsTool = SlateTool.create(
  spec,
  {
