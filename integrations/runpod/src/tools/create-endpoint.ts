...
export let createEndpoint = SlateTool.create(
  ...
  .input(z.object({
    ...
    cpuFlavorIds: z.array(z.string()).optional().describe('CPU flavor IDs for CPU endpoints'),
    ...
    idleTimeout: z.number().optional().describe('Seconds before idle worker shutdown (1-3600, default: 5)'),
