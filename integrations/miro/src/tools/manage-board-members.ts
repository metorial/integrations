...
export let shareBoard = SlateTool.create(
  spec,
  {
    name: 'Share Board',
    key: 'share_board',
  ...
  .input(z.object({
    ...
    role: z.enum(['viewer', 'commenter', 'editor']).optional().describe('Role to assign to invited users'),
...
export let updateBoardMember = SlateTool.create(
  spec,
  {
...
export let removeBoardMember = SlateTool.create(
  spec,
  {
