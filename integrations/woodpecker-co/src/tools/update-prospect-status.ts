...
export let updateProspectStatus = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    prospects: z.array(z.object({
      ...
      interestLevel: z.enum(['INTERESTED', 'NOT_INTERESTED', 'MAYBE_LATER']).describe('New interest level'),
    })).min(1).describe('Prospects to update with their new interest levels'),
  }))
  .output(z.object({
