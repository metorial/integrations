...
export let createCustomsDeclaration = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    contentsExplanation: z.string().optional().describe('Explanation if contentsType is OTHER'),
    nonDeliveryOption: z.enum(['ABANDON', 'RETURN']).optional().describe('Action if package cannot be delivered'),
    ...
    incoterm: z.enum(['DDP', 'DDU', 'FCA', 'DAP', 'CPT', 'CIP', 'CIF', 'FOB', 'EXW']).optional().describe('Incoterms trade term'),
    eelPfc: z.enum(['NOEEI_30_37_a', 'NOEEI_30_37_h', 'NOEEI_30_36', 'AES_ITN']).optional().describe('EEL/PFC code for US exports'),
