...
let scholarResultSchema = z.object({
  ...
  publicationInfo: z.string().optional().describe('Publication details (authors, journal, year)'),
...
export let scholarSearch = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    includeCitations: z.boolean().optional().describe('Include citation entries (default: true)'),
