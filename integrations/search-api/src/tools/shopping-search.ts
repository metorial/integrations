...
export let shoppingSearch = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    sortBy: z.enum(['price_low_to_high', 'price_high_to_low', 'rating_high_to_low']).optional()
  ...
  .output(z.object({
    ...
    shoppingAds: z.array(shoppingResultSchema).optional().describe('Sponsored product listings'),
