...
export let listDocs = SlateTool.create(
  ...
  .input(z.object({
    userId: z.string().optional().describe('List documents for a specific user. If provided, other filters are ignored.'),
    projectId: z.string().optional().describe('Filter by project ID'),
    folderId: z.string().optional().describe('Filter by folder ID'),
    titleContains: z.string().optional().describe('Filter docs whose title contains this substring'),
