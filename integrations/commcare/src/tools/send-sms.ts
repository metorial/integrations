...
Requires an SMS gateway to be configured on the CommCare project.`,
    constraints: [
      'Requires an SMS gateway to be configured in CommCare project settings.',
    ],
    tags: {
      destructive: false,
    },
  ...
  .input(z.object({
    phoneNumber: z.string().describe('Recipient phone number (include country code, e.g., "+1234567890")'),
