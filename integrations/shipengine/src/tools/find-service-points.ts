...
export let findServicePoints = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    })).min(1).describe('Carrier providers to search for service points'),
    ...
    }).optional().describe('Structured address to search near'),
