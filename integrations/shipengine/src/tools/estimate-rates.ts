...
export let estimateRates = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    fromCountryCode: z.string().optional().describe('Origin country code (defaults to account country)'),
    ...
    }).optional().describe('Package dimensions'),
