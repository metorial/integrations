...
let oddValueSchema = z.object({
  value: z.string().nullable().describe('Bet selection (e.g., "Home", "Draw", "Away", "Over 2.5")'),
...
let bookmakerOddsSchema = z.object({
  ...
  bets: z.array(z.object({
    betName: z.string().nullable().describe('Bet type name (e.g., "Match Winner", "Over/Under")'),
