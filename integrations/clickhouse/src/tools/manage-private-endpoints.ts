...
export let getPrivateEndpointConfig = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    endpointConfig: z.record(z.string(), z.any()).describe('Private endpoint configuration details'),
  }))
...
export let listReversePrivateEndpoints = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({}))
  .output(z.object({
    reversePrivateEndpoints: z.array(z.object({
      endpointId: z.string(),
...
export let createReversePrivateEndpoint = SlateTool.create(
  spec,
  {
...
export let deleteReversePrivateEndpoint = SlateTool.create(
  spec,
  {
