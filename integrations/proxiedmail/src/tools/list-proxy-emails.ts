...
let proxyBindingSchema = z.object({
  ...
  realAddresses: z.record(z.string(), realAddressInfoSchema).describe('Map of forwarding addresses and their status'),
...
export let listProxyEmails = SlateTool.create(
  spec,
  {
