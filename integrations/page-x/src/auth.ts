...
export let auth = SlateAuth.create()
  ...
  .addCustomAuth({
    ...
    inputSchema: z.object({
      pageXApiKey: z.string().describe('Your PageXCRM API key obtained from your PageXCRM account'),
      rapidApiKey: z.string().describe('Your RapidAPI key obtained by subscribing to the PageXCRM API on RapidAPI'),
    }),
