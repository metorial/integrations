...
export let fulfillOrder = SlateTool.create(
  ...
  .input(z.object({
    ...
    shouldSendNotification: z.boolean().describe('Whether to send a fulfillment notification email to the customer'),
    shipments: z.array(z.object({
      shipDate: z.string().describe('ISO 8601 UTC ship date'),
      carrierName: z.string().describe('Name of the shipping carrier (e.g., "USPS", "FedEx")'),
