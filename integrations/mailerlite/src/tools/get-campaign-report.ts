...
export let getCampaignReport = SlateTool.create(
  ...
  .input(z.object({
    ...
    activityType: z.enum(['opens', 'clicks', 'unsubscribes', 'bounces', 'junks', 'forwards']).optional().describe('Filter subscriber activity by type'),
  ...
  .output(z.object({
    ...
    })).optional().describe('Subscriber activity records'),
  }))
