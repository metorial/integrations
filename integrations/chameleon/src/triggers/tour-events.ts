...
export let tourEvents = SlateTrigger.create(
  spec,
  {
    name: 'Tour Events',
    key: 'tour_events',
    description: 'Triggers when a user interacts with a Chameleon tour: started, completed, exited, snoozed, or button clicked.',
  }
)
  .input(z.object({
