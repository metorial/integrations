...
export let microsurveyEvents = SlateTrigger.create(
  spec,
  {
    name: 'Microsurvey Events',
    key: 'microsurvey_events',
    description: 'Triggers when a user interacts with a Chameleon microsurvey: started, completed, exited, snoozed, button clicked, or response submitted.',
  }
)
  .input(z.object({
