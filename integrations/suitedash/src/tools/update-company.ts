...
export let updateCompany = SlateTool.create(
  ...
  .input(z.object({
    ...
    backgroundInfo: z.string().optional().describe('Updated background information about the company'),
  }))
  .output(z.object({
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.backgroundInfo !== undefined) payload.background_info = ctx.input.backgroundInfo;
