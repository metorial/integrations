...
export let deskGetTickets = SlateTool.create(spec, {
  ...
  .input(z.object({
    ...
    sortBy: z.string().optional().describe('Field to sort by (e.g., "modifiedTime", "createdTime")'),
    sortOrder: z.enum(['asc', 'desc']).optional().describe('Sort order'),
    includeDepartments: z.boolean().optional().describe('Also return the list of departments'),
  }))
  .output(z.object({
    ...
    departments: z.array(z.object({
      ...
      name: z.string(),
    })).optional().describe('Departments (if includeDepartments is true)'),
  }))
