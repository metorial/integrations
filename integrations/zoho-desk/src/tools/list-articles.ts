...
export let listArticles = SlateTool.create(
  ...
  .input(z.object({
    categoryId: z.string().optional().describe('KB category ID to list articles from. If omitted, lists root categories instead.'),
    status: z.string().optional().describe('Filter articles by status (e.g., Draft, Published)'),
  ...
  .output(z.object({
    ...
    })).optional().describe('List of articles (when categoryId is provided)'),
    categories: z.array(z.object({
      categoryId: z.string().describe('Category ID'),
      name: z.string().optional().describe('Category name'),
      description: z.string().optional().describe('Category description'),
    })).optional().describe('List of KB categories (when categoryId is omitted)'),
  }))
