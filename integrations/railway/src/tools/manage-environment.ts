...
export let getEnvironmentTool = SlateTool.create(
  ...
  .output(z.object({
    ...
    name: z.string().describe('Environment name'),
    createdAt: z.string().describe('Creation timestamp'),
    serviceInstances: z.array(z.object({
...
export let createEnvironmentTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    sourceEnvironmentId: z.string().optional().describe('ID of an existing environment to clone configuration from')
  }))
  .output(z.object({
...
export let deleteEnvironmentTool = SlateTool.create(
  spec,
  {
