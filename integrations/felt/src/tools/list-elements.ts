...
export let listElements = SlateTool.create(
  spec,
  {
    name: 'List Elements',
    key: 'list_elements',
  ...
  .output(z.object({
    elements: z.record(z.string(), z.unknown()).describe('GeoJSON FeatureCollection of all elements'),
    elementGroups: z.array(z.object({
