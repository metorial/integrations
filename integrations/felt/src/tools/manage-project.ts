...
To **delete** a project, provide the project ID and set delete to true.`,
  ...
  .input(z.object({
    ...
    visibility: z.enum(['workspace', 'private']).optional().describe('Visibility level (required for create)'),
    maxInheritedPermission: z.enum(['view_only', 'view_and_contribute', 'view_and_edit']).optional().describe('Maximum inherited permission for maps in the project'),
