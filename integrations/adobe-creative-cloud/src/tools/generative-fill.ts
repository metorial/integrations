...
export let generativeFill = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    maskUrl: z.string().describe('URL of the mask image (white = fill area, black = preserve)'),
    prompt: z.string().optional().describe('Text prompt to guide what is generated in the masked area'),
