...
export let updateFileMetadata = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    itemId: z.string().optional().describe('ID of the file or folder. Provide either itemId or itemPath.'),
    ...
    name: z.string().optional().describe('New name for the file or folder (including extension).'),
