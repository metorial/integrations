...
let balanceSchema = z.object({
  ...
  amount: z.string().describe('Balance amount (positive means you are owed, negative means you owe)'),
});
...
let groupSchema = z.object({
  ...
  groupType: z.string().optional().describe('Group type: home, trip, couple, apartment, house, or other'),
