...
export let formMetadataSchema = z.object({
  ...
  calculations: z.array(calculationDefinitionSchema).optional().describe('Calculations defined in the form'),
  urlParameters: z.array(fieldDefinitionSchema).optional().describe('URL parameters configured for the form'),
  scheduling: z.array(fieldDefinitionSchema).optional().describe('Scheduling fields in the form'),
...
export let submissionSchema = z.object({
  ...
  urlParameters: z.array(urlParameterResponseSchema).optional().describe('URL parameter values'),
