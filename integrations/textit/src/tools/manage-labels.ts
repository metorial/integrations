...
export let manageLabels = SlateTool.create(
  ...
  .input(z.object({
    ...
    labelUuid: z.string().optional().describe('UUID of the label (required for update/delete)'),
    name: z.string().optional().describe('Name of the label (required for create and update)'),
  }))
  .output(z.object({
