...
export let getZoneDetails = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    zoneInfo: z.record(z.string(), z.unknown()).describe('Full zone configuration including plan, creation date, permissions, and IPs.'),
