...
export let addressActivity = SlateTrigger.create(spec, {
  ...
  description: 'Fires when a tracked address sends or receives ETH, ERC-20, ERC-721, or ERC-1155 tokens. Tracks all transfer activity for monitored addresses.',
})
  .input(z.object({
    ...
    activity: z.array(z.object({
      ...
      category: z.string().describe('Transfer category (external, internal, erc20, erc721, erc1155)'),
      ...
      }).optional().describe('Associated event log'),
