...
export class FlowiseClient {
  ...
  async sendPrediction(chatflowId: string, body: {
    question: string;
  ...
  async updateChatflow(chatflowId: string, body: {
    name?: string;
    flowData?: string;
    deployed?: boolean;
    isPublic?: boolean;
  ...
  async updateAssistant(assistantId: string, body: {
    details?: string;
    credential?: string;
    iconSrc?: string;
  }) {
  ...
  async vectorUpsert(chatflowId: string, body: {
    stopNodeId?: string;
    overrideConfig?: Record<string, any>;
  }) {
  ...
  async getChatMessages(chatflowId: string, params?: {
    chatType?: string;
    order?: string;
    chatId?: string;
    memoryType?: string;
  ...
  async deleteChatMessages(chatflowId: string, params?: {
    chatId?: string;
    chatType?: string;
    sessionId?: string;
    memoryType?: string;
  ...
  async listFeedback(chatflowId: string, params?: {
    chatId?: string;
    sortOrder?: string;
    startDate?: string;
    endDate?: string;
  ...
  async updateFeedback(feedbackId: string, body: {
    rating?: string;
    content?: string;
  }) {
  ...
  async updateTool(toolId: string, body: {
    name?: string;
    description?: string;
    color?: string;
    schema?: string;
  ...
  async updateVariable(variableId: string, body: {
    name?: string;
    value?: string;
    type?: string;
  }) {
  ...
  async getUpsertHistory(chatflowId: string, params?: {
    order?: string;
    startDate?: string;
    endDate?: string;
  }) {
