...
export let listUsersAndGroups = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    groupId: z.string().optional().describe('If provided, fetch the members of this group. Otherwise, list all groups.'),
  }))
  .output(z.object({
    groups: z.array(z.object({
      groupId: z.string().describe('Group ID'),
      name: z.string().optional().describe('Group name'),
    })).optional().describe('List of groups (when no groupId is provided)'),
    users: z.array(z.object({
      userId: z.string().describe('User ID'),
      email: z.string().optional().describe('User email'),
      firstName: z.string().optional().describe('First name'),
      lastName: z.string().optional().describe('Last name'),
    })).optional().describe('List of users in the specified group'),
  }))
