...
export let listTemplates = SlateTool.create(
  ...
  .input(z.object({
    templateId: z.string().optional().describe('If provided, lists all versions of this specific template. Otherwise lists all templates.')
  }))
  .output(z.object({
    templates: z.array(z.object({
      ...
      renderCount: z.number().optional().describe('Number of times this template has been used to render images'),
      createdAt: z.string().optional().describe('Timestamp when the template was created')
