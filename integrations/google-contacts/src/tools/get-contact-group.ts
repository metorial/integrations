...
export let getContactGroup = SlateTool.create(
  ...
  .input(z.object({
    resourceName: z.string().describe('Resource name of the contact group (e.g., "contactGroups/abc123" or "contactGroups/myContacts")'),
    maxMembers: z.number().optional().describe('Maximum number of member resource names to return (default 100)'),
  }))
