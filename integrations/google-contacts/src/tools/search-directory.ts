...
export let searchDirectory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    sources: z.array(z.enum(['DIRECTORY_SOURCE_TYPE_DOMAIN_CONTACT', 'DIRECTORY_SOURCE_TYPE_DOMAIN_PROFILE']))
      .optional()
      .describe('Directory sources to search (defaults to both domain contacts and profiles)'),
