...
export let listEmployees = SlateTool.create(
  ...
  .input(z.object({
    ...
    terminated: z.boolean().optional().describe('If true, include terminated employees. If false, only active employees.'),
  ...
  .output(z.object({
    employees: z.array(z.object({
      ...
      twoPercentShareholder: z.boolean().optional().describe('Whether the employee is a 2% shareholder'),
