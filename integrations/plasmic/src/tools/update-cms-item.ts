...
export let updateCmsItem = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    fields: z.record(z.string(), z.unknown()).describe('Field values to update. Keys should match the model field identifiers'),
