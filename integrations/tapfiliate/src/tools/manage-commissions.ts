...
let commissionSchema = z.object({
  ...
  conversionSubAmount: z.number().optional().describe('Conversion sub-amount used for calculation'),
...
export let listCommissions = SlateTool.create(
  spec,
  {
...
export let getCommission = SlateTool.create(
  spec,
  {
    name: 'Get Commission',
    key: 'get_commission',
...
export let updateCommission = SlateTool.create(
  spec,
  {
...
export let approveCommission = SlateTool.create(
  spec,
  {
...
export let disapproveCommission = SlateTool.create(
  spec,
  {
