...
export let searchTrends = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    keywords: z.string().describe('Single keyword or comma-separated keywords (max 5), e.g. "react,vue,angular"'),
    ...
    property: z.enum(['', 'youtube', 'images', 'news', 'froogle']).optional().describe('Search property: empty for web, "youtube", "images", "news", or "froogle" (Google Shopping)'),
