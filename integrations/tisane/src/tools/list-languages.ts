...
export let listLanguages = SlateTool.create(
  ...
  .output(z.object({
    languages: z.array(z.object({
      ...
      usesLatinScript: z.boolean().optional().describe('Whether the language uses Latin script'),
      rightToLeft: z.boolean().optional().describe('Whether the language is written right-to-left'),
