...
export let listContractAmendments = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    status: z.string().optional().describe('Filter by amendment status (submitted, reviewed, done, canceled)'),
    page: z.number().optional().describe('Page number'),
    pageSize: z.number().optional().describe('Page size'),
  }))
  .output(z.object({
    contractAmendments: z.array(z.record(z.string(), z.any())).describe('List of contract amendment records'),
