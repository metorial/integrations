...
export let getAudienceActivityTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    includeGrowthHistory: z.boolean().optional().describe('Also include monthly growth history (default false)'),
  }))
  .output(z.object({
    ...
    growthHistory: z.array(z.object({
      month: z.string(),
      existing: z.number(),
      imports: z.number(),
      optins: z.number(),
