...
export let getIncident = SlateTool.create(
  ...
  .output(z.object({
    ...
    })).optional().describe('Current assignees'),
    acknowledgements: z.array(z.object({
      userId: z.string(),
      userName: z.string().optional(),
      acknowledgedAt: z.string().optional(),
    })).optional().describe('Acknowledgements'),
    ...
    notes: z.array(z.object({
      ...
      userName: z.string().optional(),
    })).optional().describe('Incident notes'),
  }))
  .handleInvocation(async (ctx) => {
    ...
    let notes: { noteId: string; content?: string; createdAt?: string; userName?: string }[] | undefined;
