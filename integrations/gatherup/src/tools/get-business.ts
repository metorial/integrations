...
export let getBusiness = SlateTool.create(
  ...
  .output(z.object({
    ...
    communicationMethod: z.string().optional().describe('Communication method (Automatic or Manual)'),
    communicationSendEmail: z.number().optional().describe('Daily email volume in automatic mode'),
    ...
    customersNotSent: z.number().optional().describe('Customers not yet sent feedback requests'),
