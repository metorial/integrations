...
export let getGroup = SlateTool.create(
  ...
  .input(z.object({
    ...
    expand: z.array(z.string()).optional().describe('Related objects to expand (e.g. memberships, memberships.user)'),
  }))
  .output(z.object({
    ...
    memberships: z.array(z.record(z.string(), z.unknown())).optional().nullable().describe('Group memberships if expanded'),
  }))
