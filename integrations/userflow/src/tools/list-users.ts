...
export let listUsers = SlateTool.create(
  ...
  .input(z.object({
    ...
    orderBy: z.string().optional().describe('Sort order (e.g. "created_at", "-created_at" for descending, "attributes.name")'),
    expand: z.array(z.string()).optional().describe('Related objects to expand (e.g. memberships, groups)'),
  }))
  .output(z.object({
