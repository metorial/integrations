...
export let domainCompetitors = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    mode: z.enum(['competitors', 'rank_overview']).default('competitors').describe('Analysis mode'),
  ...
  .output(z.object({
    ...
    }).optional().describe('Domain rank overview metrics'),
