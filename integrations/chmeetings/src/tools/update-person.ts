...
export let updatePerson = SlateTool.create(
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.socialStatus !== undefined) updateData.social_status = ctx.input.socialStatus;
    ...
    if (ctx.input.envelopeNumber !== undefined) updateData.envelope_number = ctx.input.envelopeNumber;
