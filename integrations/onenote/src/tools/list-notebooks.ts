...
export let listNotebooks = SlateTool.create(
  spec,
  {
    name: 'List Notebooks',
    key: 'list_notebooks',
  ...
  .input(z.object({
    filter: z.string().optional().describe('OData filter expression, e.g. "displayName eq \'My Notebook\'"'),
    orderBy: z.string().optional().describe('OData orderby expression, e.g. "createdDateTime desc"'),
