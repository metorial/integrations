...
export let searchRequisitions = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    createdAfter: z.string().optional().describe('Filter requisitions created after this date (ISO 8601)'),
    updatedAfter: z.string().optional().describe('Filter requisitions updated after this date (ISO 8601)'),
...
export let createRequisition = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    requisitionLines: z.array(z.object({
    ...
    })).min(1).describe('Requisition lines'),
