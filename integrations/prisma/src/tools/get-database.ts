...
export let getDatabase = SlateTool.create(
  ...
  .output(z.object({
    ...
    connectionString: z.string().optional().describe('Primary Prisma Postgres connection string'),
    projectId: z.string().optional().describe('Parent project ID'),
    projectName: z.string().optional().describe('Parent project name'),
    connections: z.array(connectionSchema).optional().describe('Available connection configurations'),
  }))
