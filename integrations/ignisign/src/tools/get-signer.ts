...
export let getSigner = SlateTool.create(
  spec,
  {
    name: 'Get Signer',
    key: 'get_signer',
  ...
  .input(z.object({
    ...
    detailed: z.boolean().optional().describe('If true, fetch full details including claims context; otherwise returns summary'),
  }))
  .output(z.object({
