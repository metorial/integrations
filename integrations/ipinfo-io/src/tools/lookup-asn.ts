...
export let lookupAsn = SlateTool.create(
  spec,
  {
    name: 'Lookup ASN',
    key: 'lookup_asn',
    ...
    constraints: [
      'Available on Core tier and above.'
    ],
    tags: {
      destructive: false,
      readOnly: true
  ...
  .output(z.object({
    ...
    registry: z.string().optional().describe('Regional Internet Registry (arin, ripencc, apnic, lacnic, afrinic)'),
    ...
    type: z.string().optional().describe('ASN type (isp, hosting, business, education, government)'),
