...
export let updateTicket = SlateTool.create(
  ...
  .input(z.object({
    ...
    snoozedUntil: z.string().optional().describe('ISO 8601 date until which to snooze the ticket'),
  ...
  .output(z.object({
    ticket: z.record(z.string(), z.any()).describe('The updated ticket object or confirmation')
  }))
