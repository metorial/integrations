...
export let getReport = SlateTool.create(
  ...
  .input(z.object({
    ...
    grouping: z.string().optional().describe('For summary: grouping dimension (e.g., "projects", "clients", "users")'),
    ...
    firstRowNumber: z.number().optional().describe('For detailed: starting row number for pagination'),
  }))
  .output(z.object({
