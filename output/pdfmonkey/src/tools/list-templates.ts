...
export let listTemplates = SlateTool.create(
  ...
  .input(z.object({
    ...
    folders: z.string().optional().describe('Comma-separated folder IDs to filter by, or "none" for templates at root level'),
    page: z.number().optional().describe('Page number for pagination'),
    sort: z.enum(['identifier', 'created_at', 'updated_at']).optional().describe('Sort order for results'),
  }))
  .output(z.object({
