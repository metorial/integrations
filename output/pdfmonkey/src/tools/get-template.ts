...
export let getTemplate = SlateTool.create(
  ...
  .output(z.object({
    ...
    settings: z.record(z.string(), z.unknown()).nullable().describe('Published page layout settings'),
    settingsDraft: z.record(z.string(), z.unknown()).nullable().describe('Draft page layout settings'),
