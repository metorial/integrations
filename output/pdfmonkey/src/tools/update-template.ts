...
export let updateTemplate = SlateTool.create(
  ...
  .input(z.object({
    ...
    }).optional().describe('Updated published page layout settings'),
    ...
    }).optional().describe('Updated draft page layout settings'),
    editionMode: z.enum(['code', 'visual']).optional().describe('Edition mode for the template editor'),
    folderId: z.string().nullable().optional().describe('Folder ID to move the template to, or null for root'),
