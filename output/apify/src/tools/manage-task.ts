...
export let manageTask = SlateTool.create(
  ...
  .input(z.object({
    ...
    taskId: z.string().optional().describe('Task ID or name (required for get/update/delete/run)'),
    actorId: z.string().optional().describe('Actor ID to associate with the task (required for create)'),
    name: z.string().optional().describe('Task name (required for create)'),
    title: z.string().optional().describe('Human-readable title'),
    input: z.any().optional().describe('Input configuration for the task (for create/update/run)'),
  ...
  .output(z.object({
    ...
    })).optional().describe('Task list (for list action)'),
