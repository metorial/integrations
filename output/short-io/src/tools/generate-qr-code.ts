...
export let generateQrCode = SlateTool.create(
  ...
  .input(z.object({
    linkId: z.string().describe('The link ID string (e.g., "lnk_abc123_abcdef") to generate a QR code for.'),
    color: z.string().optional().describe('Foreground hex color code (e.g., "000000").'),
    backgroundColor: z.string().optional().describe('Background hex color code (e.g., "FFFFFF").'),
