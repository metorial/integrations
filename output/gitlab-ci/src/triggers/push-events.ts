...
export let pushEvents = SlateTrigger.create(
  spec,
  {
    name: 'Push Events',
    key: 'push_events',
    description: 'Triggered when code is pushed to the repository, which typically triggers CI/CD pipelines. Includes commit details, branch/ref information, and before/after SHAs.'
  }
)
  .input(z.object({
    eventType: z.string(),
