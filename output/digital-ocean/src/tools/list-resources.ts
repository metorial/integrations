...
export let listRegions = SlateTool.create(
  spec,
  {
    name: 'List Regions',
    key: 'list_regions',
...
export let listSizes = SlateTool.create(
  spec,
  {
    name: 'List Sizes',
    key: 'list_sizes',
...
export let listSnapshots = SlateTool.create(
  ...
  .input(z.object({
    resourceType: z.enum(['droplet', 'volume']).optional().describe('Filter by resource type'),
...
export let listImages = SlateTool.create(
  ...
  .input(z.object({
    imageType: z.enum(['distribution', 'application']).optional().describe('Filter by image type'),
