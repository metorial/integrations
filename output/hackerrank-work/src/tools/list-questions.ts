...
export let listQuestions = SlateTool.create(
  ...
  .input(z.object({
    type: z.string().optional().describe('Filter by question type (e.g., "coding", "mcq", "project", "database")'),
    limit: z.number().min(1).max(100).optional().describe('Number of questions to return (1-100, default 100)'),
