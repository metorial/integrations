...
export let listReimbursements = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    fromDate: z.string().optional().describe('Filter reimbursements from this date (ISO 8601)'),
    toDate: z.string().optional().describe('Filter reimbursements until this date (ISO 8601)'),
    direction: z.enum(['BUSINESS_TO_USER', 'USER_TO_BUSINESS']).optional().describe('Filter by direction'),
  }))
  .output(z.object({
