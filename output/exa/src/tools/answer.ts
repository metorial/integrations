...
export let answerTool = SlateTool.create(
  spec,
  {
...
Ideal for factual questions, research queries, and getting quick answers grounded in web sources.`,
  ...
  .input(z.object({
    ...
    includeSourceText: z.boolean().optional().describe('Include the full text of cited sources in the response'),
  }))
  .output(z.object({
    ...
    citations: z.array(z.object({
      ...
      text: z.string().optional().describe('Source text content (when includeSourceText is true)'),
