...
export let getPosts = SlateTool.create(
  ...
  .input(z.object({
    postUrn: z.string().optional().describe('URN of a specific post to retrieve. If provided, authorUrn is ignored.'),
    authorUrn: z.string().optional().describe('URN of the author whose posts to retrieve, e.g. "urn:li:person:abc123" or "urn:li:organization:12345"'),
  ...
  .output(z.object({
    posts: z.array(z.object({
      ...
      publishedAt: z.string().optional().describe('ISO timestamp when the post was published'),
