...
export let listPhotoAvatars = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    photoAvatarId: z.string().optional().describe('If provided, returns detailed info for this specific photo avatar'),
    title: z.string().optional().describe('Filter by title'),
    status: z.array(z.enum(['draft', 'processing', 'published', 'failed', 'deleted'])).optional().describe('Filter by status'),
