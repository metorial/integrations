...
export let manageLicensee = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    licenseeNumber: z.string().optional().describe('Licensee identifier. Required for update/delete. Optional for create.'),
    ...
    markedForTransfer: z.boolean().optional().describe('Mark this licensee as a source for license transfer'),
    forceCascade: z.boolean().optional().describe('When deleting, force cascade deletion of licenses'),
  }))
  .output(z.object({
