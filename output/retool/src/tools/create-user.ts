...
export let createUser = SlateTool.create(
  ...
  .input(z.object({
    ...
    active: z.boolean().optional().describe('Whether the user should be active immediately (defaults to true)'),
    metadata: z.record(z.string(), z.any()).optional().describe('Custom metadata key-value pairs to attach to the user'),
