...
let deploymentOutputSchema = z.object({
  ...
  }).optional().describe('Current deployment release configuration')
});
...
export let updateDeployment = SlateTool.create(
  spec,
  {
...
export let deleteDeployment = SlateTool.create(
  spec,
  {
