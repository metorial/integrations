...
**Payment statuses**: 1=Successful, 2=Pending, 3=Error, 4=Refund.`,
  ...
  .input(z.object({
    ...
    paymentMode: z.number().describe('Payment method code (2=Cash, 3=Cheque, 4=Bank transfer, 5=Other, 1=PayPal, etc.)'),
    paymentStatus: z.number().describe('Payment status (1=Successful, 2=Pending, 3=Error, 4=Refund)'),
