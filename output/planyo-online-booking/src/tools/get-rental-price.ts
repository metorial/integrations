...
export let getRentalPrice = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    customFields: z.record(z.string(), z.string()).optional().describe('Custom form fields that may affect pricing'),
  }))
  .output(z.object({
    ...
    includedProducts: z.any().optional().describe('Additional products included in the price'),
  }))
