...
export let listVisitors = SlateTool.create(
  spec,
  {
    name: 'List Visitors',
    key: 'list_visitors',
  ...
  .input(z.object({
    search: z.string().optional().describe('Search query to filter visitors by name, email, or username'),
  }))
  .output(z.object({
...
export let addVisitor = SlateTool.create(
  spec,
  {
    name: 'Add Visitor',
    key: 'add_visitor',
  ...
  .input(z.object({
    ...
    username: z.string().optional().describe('Username for the visitor (auto-generated if omitted)'),
    password: z.string().optional().describe('Password for the visitor (auto-generated if omitted)'),
  }))
  .output(z.object({
...
export let updateVisitor = SlateTool.create(
  spec,
  {
    name: 'Update Visitor',
    key: 'update_visitor',
...
export let removeVisitor = SlateTool.create(
  spec,
  {
    name: 'Remove Visitor',
    key: 'remove_visitor',
