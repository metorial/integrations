...
Use this to verify transaction safety, preview token transfers, estimate gas costs, or detect potential failures before spending gas.`,
  ...
  .output(z.object({
    ...
    assetChanges: z.array(z.object({
      assetType: z.string().optional().describe('Type of asset (native, erc20, erc721, etc.)'),
      changeType: z.string().optional().describe('Type of change (transfer, approve, etc.)'),
    ...
    })).optional().describe('Predicted asset changes from the transaction'),
