...
export let createColumnTool = SlateTool.create(
  spec,
  {
    name: 'Create Column',
    key: 'create_column',
  ...
  .input(z.object({
    ...
    title: z.string().describe('Column title'),
    columnType: z.string().describe('Monday.com column type identifier (e.g., status, text, numbers, date)'),
    description: z.string().optional().describe('Column description'),
    defaults: z.string().optional().describe('JSON string of default settings for the column'),
  }))
  .output(z.object({
