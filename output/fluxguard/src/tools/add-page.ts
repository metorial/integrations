...
export let addPage = SlateTool.create(
  spec,
  {
    name: 'Add Page',
    key: 'add_page',
  ...
  .input(z.object({
    ...
    categories: z.array(z.string()).optional().describe('List of category IDs to assign the new site to'),
    categoryId: z.string().optional().describe('Single category ID to assign the new site to'),
