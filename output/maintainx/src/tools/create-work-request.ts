...
export let createWorkRequest = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    description: z.string().optional().describe('Detailed description of the requested work'),
    priority: z.enum(['NONE', 'LOW', 'MEDIUM', 'HIGH']).optional().describe('Requested priority level'),
