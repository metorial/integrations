...
export let createAsset = SlateTool.create(
  ...
  .input(z.object({
    ...
    parentId: z.number().optional().describe('Parent asset ID for hierarchical relationships'),
    ...
    vendorIds: z.array(z.number()).optional().describe('Vendor IDs associated with this asset'),
  }))
  .output(z.object({
