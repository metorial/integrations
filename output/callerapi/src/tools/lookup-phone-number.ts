...
let carrierCountrySchema = z.object({
...
let carrierNetworkSchema = z.object({
...
export let lookupPhoneNumber = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeHlr: z.boolean().optional().default(false).describe('Include HLR data for real-time carrier validation'),
  }))
  .output(z.object({
