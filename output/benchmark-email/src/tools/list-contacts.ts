...
export let listContacts = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.enum(['active', 'unsubscribed']).optional().describe('Filter by contact status'),
  ...
  .output(z.object({
    contacts: z.array(z.object({
      ...
      customFields: z.record(z.string(), z.string()).describe('Custom field values (Field1-Field24)'),
