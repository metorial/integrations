...
export let templateEvent = SlateTrigger.create(
  spec,
  {
    name: 'Template Event',
    key: 'template_event',
    description: 'Triggered when a template is created or updated. Configure the webhook URL in the DocuSeal console under Settings > Webhooks.',
  }
)
  .input(z.object({
    eventType: z.enum(['template.created', 'template.updated']).describe('Type of template event'),
