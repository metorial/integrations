...
Use this for browsing record collections or finding records that match specific criteria.`,
  ...
  .input(z.object({
    ...
    filter: z.string().optional().describe('Filter query using NetSuite REST API syntax (e.g., "companyName CONTAIN \'Acme\'")'),
  ...
  .output(z.object({
    records: z.array(z.record(z.string(), z.any())).describe('Array of records matching the criteria'),
