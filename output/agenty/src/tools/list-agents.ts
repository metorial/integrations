...
export let listAgents = SlateTool.create(
  ...
  .input(z.object({
    offset: z.number().optional().describe('Number of agents to skip for pagination. Defaults to 0.'),
    limit: z.number().optional().describe('Maximum number of agents to return. Defaults to 100, max 1000.'),
  ...
  .output(z.object({
    ...
    agents: z.array(z.object({
      ...
      isPublic: z.boolean().optional().nullable().describe('Whether the agent is publicly accessible.'),
