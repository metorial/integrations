...
export let paraphrase = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    style: z.enum(['general', 'casual', 'formal', 'short', 'long']).optional().describe('Paraphrasing style'),
    startIndex: z.number().int().optional().describe('Start character index for subsection paraphrasing'),
    endIndex: z.number().int().optional().describe('End character index for subsection paraphrasing'),
  }))
  .output(z.object({
