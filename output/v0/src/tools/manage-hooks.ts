...
export let listHooksTool = SlateTool.create(
  spec,
  {
    name: 'List Hooks',
    key: 'list_hooks',
...
export let createHookTool = SlateTool.create(
  spec,
  {
    name: 'Create Hook',
    key: 'create_hook',
...
export let getHookTool = SlateTool.create(
  spec,
  {
    name: 'Get Hook',
    key: 'get_hook',
...
export let deleteHookTool = SlateTool.create(
  spec,
  {
    name: 'Delete Hook',
    key: 'delete_hook',
