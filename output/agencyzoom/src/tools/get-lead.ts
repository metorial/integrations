...
export let getLead = SlateTool.create(
  ...
  .output(z.object({
    ...
    customFields: z.record(z.string(), z.any()).optional().describe('Custom fields associated with the lead'),
    ...
    updatedAt: z.string().optional().describe('ISO 8601 timestamp when the lead was last updated'),
    opportunities: z.array(z.record(z.string(), z.any())).describe('Opportunities associated with this lead'),
    quotes: z.array(z.record(z.string(), z.any())).describe('Quotes associated with this lead'),
  }))
  .handleInvocation(async (ctx) => {
    ...
    let opportunities = Array.isArray(opportunitiesResult.data) ? opportunitiesResult.data : Array.isArray(opportunitiesResult) ? opportunitiesResult : [];
    let quotes = Array.isArray(quotesResult.data) ? quotesResult.data : Array.isArray(quotesResult) ? quotesResult : [];
