...
export let createPolicy = SlateTool.create(
  spec,
  {
    name: 'Create Policy',
    key: 'create_policy',
  ...
  .input(z.object({
    ...
    productLine: z.string().describe('Product line name or ID (e.g. "Auto", "Home", "Life")'),
    ...
    effectiveDate: z.string().optional().describe('Policy effective date (ISO date string, e.g. "2024-01-01")'),
    expiryDate: z.string().optional().describe('Policy expiry date (ISO date string, e.g. "2025-01-01")'),
