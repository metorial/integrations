...
export let getTopPages = SlateTool.create(
  spec,
  {
    name: 'Get Top Pages',
    key: 'get_top_pages',
...
Use to identify a site's highest-traffic content and most linked-to pages.`,
  ...
  .input(z.object({
    ...
    reportType: z.enum(['top-pages', 'pages-by-traffic', 'best-by-external-links', 'best-by-internal-links']).optional().describe('Type of pages report to retrieve. Defaults to "top-pages".'),
