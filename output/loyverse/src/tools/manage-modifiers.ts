...
export let listModifiers = SlateTool.create(
  spec,
  {
    name: 'List Modifiers',
    key: 'list_modifiers',
...
export let createOrUpdateModifier = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    options: z.array(z.object({
      modifierOptionId: z.string().optional().describe('Option ID to update; omit for new option'),
      optionName: z.string().optional().describe('Option name'),
      price: z.number().optional().describe('Price adjustment'),
      position: z.number().optional().describe('Display position'),
    })).optional().describe('Modifier options'),
  }))
...
export let deleteModifier = SlateTool.create(
  spec,
  {
