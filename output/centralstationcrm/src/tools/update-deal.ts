...
export let updateDeal = SlateTool.create(
  ...
  .input(z.object({
    ...
    valueType: z.enum(['total', 'monthly', 'hourly', 'daily']).optional().describe('Updated billing type'),
    ...
    currentState: z.enum(['0', '25', '50', '75', 'won', 'lost']).optional().describe('Updated deal state'),
