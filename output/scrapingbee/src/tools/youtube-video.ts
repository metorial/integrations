...
export let youtubeVideo = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    transcriptLanguage: z.string().optional().describe('Language code for the transcript (e.g., "en", "es")'),
    includeTrainability: z.boolean().optional().describe('Include AI trainability information')
  }))
  .output(z.object({
    metadata: z.any().describe('Video metadata including title, description, channel, views, likes, and more'),
