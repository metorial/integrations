...
export let youtubeSearch = SlateTool.create(
  ...
  .input(z.object({
    ...
    uploadDate: z.enum(['hour', 'today', 'week', 'month', 'year']).optional().describe('Filter by upload date'),
    page: z.number().optional().describe('Page number for pagination')
  }))
  .output(z.object({
    results: z.any().describe('Structured YouTube search results as JSON, including video titles, URLs, channels, views, and more')
  }))
