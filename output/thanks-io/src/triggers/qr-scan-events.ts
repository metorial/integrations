...
export let qrScanEvents = SlateTrigger.create(
  spec,
  {
    name: 'QR Code Scan Events',
    key: 'qr_scan_events',
    description: 'Triggered when a QR code on a mailer (postcard, letter, notecard) is scanned by a recipient, or when a gift card is redeemed.',
  }
)
  .input(z.object({
