...
export let getMessage = SlateTool.create(
  ...
  .output(z.object({
    ...
    extractedText: z.string().optional().describe('Extracted reply text without quoted history'),
    extractedHtml: z.string().optional().describe('Extracted reply HTML without quoted history'),
