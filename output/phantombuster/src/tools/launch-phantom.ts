...
export let launchPhantom = SlateTool.create(
  spec,
  {
    name: 'Launch Phantom',
    key: 'launch_phantom',
  ...
  .input(z.object({
    ...
    argument: z.record(z.string(), z.any()).optional().describe('JSON arguments to pass to the Phantom. Must match the Phantom\'s expected input fields.'),
  }))
  .output(z.object({
    containerId: z.string().optional().describe('ID of the container created for this execution'),
