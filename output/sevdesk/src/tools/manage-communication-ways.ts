...
export let addCommunicationWay = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    key: z.enum(['1', '2', '3', '4', '5']).optional().describe('Key: 1=Private, 2=Work (default), 3=Fax, 4=Mobile, 5=Newsletter/Invoice'),
  }))
  .output(z.object({
