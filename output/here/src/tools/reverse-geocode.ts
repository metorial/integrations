...
export let reverseGeocode = SlateTool.create(
  ...
  .input(z.object({
    ...
    types: z.string().optional().describe('Comma-separated result types to filter: "address", "street", "area"'),
  ...
  .output(z.object({
    results: z.array(z.object({
      ...
      }).optional().describe('Structured address'),
      position: z.object({
        lat: z.number(),
        lng: z.number(),
      }).optional().describe('Coordinates of the result'),
