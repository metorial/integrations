...
export let pollWebhookReceiver = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    webhookPayload: z.any().nullable().describe('The received webhook payload data, or null if nothing received yet'),
  }))
