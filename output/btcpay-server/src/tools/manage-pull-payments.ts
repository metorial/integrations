...
export let managePullPayments = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    paymentMethods: z.array(z.string()).optional().describe('Accepted payment methods (e.g., ["BTC", "BTC-LightningNetwork"])'),
    ...
    autoApproveClaims: z.boolean().optional().describe('Automatically approve payout claims'),
    includeArchived: z.boolean().optional().describe('Include archived pull payments (for list)'),
  }))
  .output(z.object({
