...
export let getEstimate = SlateTool.create(
  ...
  .input(z.object({
    estimateId: z.string().optional().describe('ID of a specific estimate to retrieve. If omitted, lists estimates.'),
    page: z.number().optional().describe('Page number for pagination'),
    perPage: z.number().optional().describe('Number of estimates per page'),
  }))
  .output(z.object({
    estimates: z.array(z.record(z.string(), z.unknown())).describe('Array of estimate records'),
