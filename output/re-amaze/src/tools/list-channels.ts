...
export let listChannels = SlateTool.create(
  ...
  .input(z.object({
    channelType: z.enum(['email', 'facebook', 'twitter', 'chat']).optional().describe('Filter channels by type'),
  }))
  .output(z.object({
    ...
    channels: z.array(z.object({
      ...
      channelTypeCode: z.number().describe('Numeric channel type (1=Email, 2=Twitter, 3=Facebook, 6=Chat, etc.)'),
