...
export let createNetworkVolume = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    dataCenterId: z.string().describe('Data center ID where the volume will be created, e.g. "US-TX-3"'),
  }))
  .output(z.object({
