...
export let listSubmissionsTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeRubricAssessment: z.boolean().optional().describe('Include rubric assessment details'),
  }))
  .output(z.object({
    submissions: z.array(z.object({
      ...
      workflowState: z.string().optional().describe('Submission state (submitted, graded, pending_review, unsubmitted)'),
