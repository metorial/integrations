...
export let sendLetter = SlateTool.create(
  ...
  .input(z.object({
    ...
    file: z.string().describe('Letter content: HTML string, template ID (tmpl_), or PDF URL'),
    color: z.boolean().describe('Print in color (true) or black-and-white (false)'),
    description: z.string().optional().describe('Internal description'),
    mergeVariables: z.record(z.string(), z.any()).optional().describe('Dynamic variables to merge into the template'),
    ...
    addressPlacement: z.enum(['top_first_page', 'insert_blank_page', 'bottom_first_page_center', 'bottom_first_page']).optional().describe('Where to place the address on the letter'),
    ...
    extraService: z.enum(['certified', 'certified_return_receipt', 'registered']).optional().describe('Extra postal service'),
...
export let getLetter = SlateTool.create(
  spec,
  {
    name: 'Get Letter',
    key: 'get_letter',
...
export let listLetters = SlateTool.create(
  spec,
  {
    name: 'List Letters',
    key: 'list_letters',
  ...
  .input(z.object({
    limit: z.number().optional().describe('Number of letters to return (max 100, default 10)'),
...
export let cancelLetter = SlateTool.create(
  spec,
  {
    name: 'Cancel Letter',
    key: 'cancel_letter',
