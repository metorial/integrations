...
let addressSchema = z.object({
  ...
  addressCountry: z.string().optional().nullable().describe('Country code (ISO 3166-1 alpha-2)'),
  ...
  metadata: z.record(z.string(), z.string()).optional().nullable().describe('Custom metadata key-value pairs'),
...
export let createAddress = SlateTool.create(
  ...
  .input(z.object({
    ...
    addressLine2: z.string().optional().describe('Secondary address line (apt, suite, etc.)'),
    ...
    addressCountry: z.string().optional().describe('Country code (ISO 3166-1 alpha-2). Defaults to US.'),
    phone: z.string().optional().describe('Phone number'),
    email: z.string().optional().describe('Email address'),
    description: z.string().optional().describe('Internal description for this address'),
    metadata: z.record(z.string(), z.string()).optional().describe('Up to 20 custom metadata key-value pairs'),
  }))
...
export let listAddresses = SlateTool.create(
  ...
  .input(z.object({
    limit: z.number().optional().describe('Number of addresses to return (max 100, default 10)'),
