...
export let verifyInternationalAddress = SlateTool.create(
  ...
  .output(z.object({
    ...
    deliverability: z.string().describe('Deliverability status: deliverable, deliverable_missing_info, undeliverable, no_match'),
    ...
    lastLine: z.string().optional().nullable().describe('City, state/province, and postal code'),
