...
export let enrichIntent = SlateTool.create(
  spec,
  {
    name: 'Enrich Intent',
    key: 'enrich_intent',
  ...
  .output(z.object({
    intentSignals: z.array(z.record(z.string(), z.any())).describe('Intent signals for the company, including topics, scores, and recommended contacts'),
  }))
