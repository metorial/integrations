...
export let searchIntent = SlateTool.create(
  spec,
  {
    name: 'Search Intent',
    key: 'search_intent',
    ...
    constraints: [
      'Only returns intent data for topics your organization is subscribed to.',
    ],
    tags: {
      readOnly: true,
    },
  ...
  .output(z.object({
    results: z.array(z.record(z.string(), z.any())).describe('Intent search results with company and signal data'),
