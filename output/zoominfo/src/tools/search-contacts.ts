...
export let searchContacts = SlateTool.create(
  ...
  .input(z.object({
    ...
    managementLevel: z.string().optional().describe('Management level (e.g., "C-Level", "VP-Level", "Director", "Manager")'),
    ...
    contactAccuracyScoreMin: z.number().min(70).max(99).optional().describe('Minimum contact accuracy score (70-99)'),
    ...
    sort: z.string().optional().describe('Sort field (e.g., "contactAccuracyScore", "-lastName", "companyName")'),
  }))
  .output(z.object({
    contacts: z.array(z.record(z.string(), z.any())).describe('Array of contact preview records'),
