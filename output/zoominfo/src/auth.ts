...
export let auth = SlateAuth.create()
  ...
  .addOauth({
    ...
    handleCallback: async (ctx) => {
      ...
      let response = await http.post('https://okta-login.zoominfo.com/oauth2/default/v1/token', body.toString(), {
        headers: {
  ...
  .addCustomAuth({
    ...
    inputSchema: z.object({
      clientId: z.string().describe('Client ID from ZoomInfo Admin Portal (Admin Portal > Integrations > API & Webhooks)'),
