...
export let getRecords = SlateTool.create(
  ...
  .input(z.object({
    ...
    modifiedAfter: z.string().optional().describe('ISO 8601 timestamp to filter records modified after this time'),
    recordIds: z.array(z.string()).optional().describe('Filter to only include records with these IDs'),
