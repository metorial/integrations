...
export let auth = SlateAuth.create()
  ...
  .addCustomAuth({
    ...
    inputSchema: z.object({
      ...
      apiPassword: z.string().describe('Your DPD API password (found in Profile > DPD API Credentials)'),
    }),
    ...
    getProfile: async (ctx: { output: { username: string; token: string }; input: { username: string; apiPassword: string } }) => {
