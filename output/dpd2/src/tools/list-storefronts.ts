...
export let listStorefronts = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    storefronts: z.array(z.object({
      ...
      subdomain: z.string().describe('Subdomain for v2 storefronts (append to dpdcart.com for full domain)'),
