...
export let createOrUpdateTask = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    taskId: z.string().optional().describe('ID of the task to update (omit to create a new task)'),
    ...
    duedate: z.string().optional().describe('Due date in ISO 8601 format (e.g., "2024-12-31T17:00:00-06:00")'),
