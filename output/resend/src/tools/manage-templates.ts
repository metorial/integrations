...
export let createTemplate = SlateTool.create(
  ...
  .input(z.object({
    ...
    replyTo: z.union([z.string(), z.array(z.string())]).optional().describe('Default reply-to address(es).'),
...
export let updateTemplate = SlateTool.create(
  ...
  .input(z.object({
    ...
    replyTo: z.union([z.string(), z.array(z.string())]).optional().describe('Updated reply-to address(es).'),
