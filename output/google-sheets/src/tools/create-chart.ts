...
export let createChart = SlateTool.create(
  spec,
  {
    name: 'Create Chart',
    key: 'create_chart',
  ...
  .input(z.object({
    ...
    chartType: z.enum(['BAR', 'LINE', 'PIE', 'AREA', 'SCATTER', 'COLUMN']).describe('Type of chart to create'),
    ...
    anchorRowIndex: z.number().optional().describe('Row index to anchor the chart (0-based). Defaults to 0.'),
    anchorColumnIndex: z.number().optional().describe('Column index to anchor the chart (0-based). Defaults to 0.'),
    legendPosition: z.enum(['BOTTOM_LEGEND', 'LEFT_LEGEND', 'RIGHT_LEGEND', 'TOP_LEGEND', 'NO_LEGEND']).optional().describe('Position of the chart legend'),
  }))
  .output(z.object({
