...
export let updateRow = SlateTool.create(
  spec,
  {
    name: 'Update Row',
    key: 'update_row',
  ...
  .input(z.object({
    ...
    primaryKey: z.record(z.string(), z.unknown()).optional().describe('Primary key of the row to update (e.g., {"id": 1})'),
    bulkPrimaryKeys: z.array(z.record(z.string(), z.unknown())).optional().describe('Array of primary keys for bulk update'),
