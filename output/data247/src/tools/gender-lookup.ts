...
export let genderLookup = SlateTool.create(
  spec,
  {
    name: 'Gender Lookup',
    key: 'gender_lookup',
  ...
  .output(z.object({
    ...
    genderPercent: z.string().optional().describe('Percentage of instances where the name is associated with this gender'),
  }))
