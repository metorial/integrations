...
export let getSurveyStatisticsTool = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    statistics: z.any().describe('Aggregated statistics for the survey, including response counts, rates, and question-level metrics'),
  }))
