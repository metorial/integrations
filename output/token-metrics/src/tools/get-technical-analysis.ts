...
export let getTechnicalAnalysis = SlateTool.create(
  spec,
  {
...
- Correlation shows the top 10 and bottom 10 correlations with the top 100 market cap tokens.`,
  ...
  .input(z.object({
    analysisType: z.enum(['resistance_support', 'correlation']).describe('Type of technical analysis'),
  ...
  .output(z.object({
    analysis: z.array(z.record(z.string(), z.any())).describe('Array of technical analysis records'),
  }))
