...
export let getMailbox = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeSchema: z.boolean().optional().describe('Also fetch the mailbox schema describing extracted fields'),
  }))
  .output(z.object({
    ...
    schema: z.record(z.string(), z.any()).nullable().describe('Mailbox schema describing extracted fields (if requested)'),
  }))
