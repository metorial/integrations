...
export let updateSubscription = SlateTool.create(
  ...
  .input(z.object({
    ...
    filterPolicyScope: z.enum(['MessageAttributes', 'MessageBody']).optional().describe('Scope of the filter policy'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.rawMessageDelivery !== undefined) {
      updates.push({ name: 'RawMessageDelivery', value: String(ctx.input.rawMessageDelivery) });
    }
