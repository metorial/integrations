...
export let autocompleteInternationalAddress = SlateTool.create(
  ...
  .input(z.object({
    ...
    countriesFilter: z.string().optional().describe('ISO 2-letter country code to filter suggestions (e.g. "GB", "DE", "JP")'),
    containerId: z.string().optional().describe('Container ID for drilldown into building-level results'),
