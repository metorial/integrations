...
export let listSnapshots = SlateTool.create(
  ...
  .input(z.object({
    sandboxId: z.string().optional().describe('Filter snapshots by the sandbox they were created from.'),
  ...
  .output(z.object({
    snapshots: z.array(z.object({
      ...
      metadata: z.record(z.string(), z.string()).optional().describe('Metadata associated with the snapshot.'),
