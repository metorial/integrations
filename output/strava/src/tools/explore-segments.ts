...
export let exploreSegments = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    minClimbCategory: z.number().optional().describe('Minimum climb category (0=HC, 5=easiest)'),
    maxClimbCategory: z.number().optional().describe('Maximum climb category (0=HC, 5=easiest)')
  }))
  .output(z.object({
