...
export let createInvite = SlateTool.create(
  spec,
  {
    name: 'Create Invite',
    key: 'create_invite',
...
export let fetchInvite = SlateTool.create(
  spec,
  {
    name: 'Fetch Invite',
    key: 'fetch_invite',
...
export let deleteInvite = SlateTool.create(
  spec,
  {
    name: 'Delete Invite',
    key: 'delete_invite',
...
export let fetchServerInvites = SlateTool.create(
  spec,
  {
