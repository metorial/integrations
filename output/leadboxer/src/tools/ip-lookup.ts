...
export let ipLookup = SlateTool.create(
  spec,
  {
    name: 'IP Lookup',
    key: 'ip_lookup',
  ...
  .output(z.object({
    ...
    usageType: z.string().optional().describe('Type of IP usage (residential, commercial, etc.)'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let output = {
      ...
      responseTimeMs: result.searchResponseTimeMs != null ? Number(result.searchResponseTimeMs) : undefined,
    };
