...
export let listBlocks = SlateTool.create(
  spec,
  {
    name: 'List Blocks',
    key: 'list_blocks',
...
export let createBlock = SlateTool.create(
  ...
  .input(z.object({
    ...
    isComponent: z.boolean().optional().describe('Whether this block is a reusable component'),
    componentBlockId: z.string().nullable().optional().describe('ID of the parent component block if this is an instance'),
  }))
...
export let updateBlock = SlateTool.create(
  spec,
  {
    name: 'Update Block',
    key: 'update_block',
