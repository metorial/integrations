...
export let boardActivity = SlateTrigger.create(
  spec,
  {
    name: 'Board Activity',
    key: 'board_activity',
    description: 'Triggers on any activity on a Trello board, including card creation, updates, moves, comments, member changes, list changes, and label modifications.',
  }
)
  .input(z.object({
    actionId: z.string().describe('Unique action ID'),
    actionType: z.string().describe('Action type (e.g. createCard, updateCard, commentCard)'),
