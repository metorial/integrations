...
export let getComparison = SlateTool.create(
  spec,
  {
    name: 'Get Comparison',
    key: 'get_comparison',
  ...
  .input(z.object({
    comparisonIdentifier: z.string().describe('Unique identifier of the comparison to retrieve'),
  }))
  .output(z.object({
    ...
    readyTime: z.string().nullable().describe('UTC timestamp when the comparison became ready'),
