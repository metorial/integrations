...
export let getAnalytics = SlateTool.create(
  ...
  .output(z.object({
    metrics: z.array(z.object({
      meanSecondsToResolve: z.number().optional().describe('Mean time to resolve in seconds'),
      meanSecondsToFirstAck: z.number().optional().describe('Mean time to first acknowledge in seconds'),
      meanSecondsToEngage: z.number().optional().describe('Mean time to engage in seconds'),
      meanSecondsToMobilize: z.number().optional().describe('Mean time to mobilize in seconds'),
