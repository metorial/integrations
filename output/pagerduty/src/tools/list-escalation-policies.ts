...
export let listEscalationPolicies = SlateTool.create(
  ...
  .input(z.object({
    ...
    userIds: z.array(z.string()).optional().describe('Filter to policies with these user IDs as targets'),
  ...
  .output(z.object({
    escalationPolicies: z.array(z.object({
      ...
      numLoops: z.number().optional().describe('Number of times the policy loops before an incident goes unacknowledged'),
      ...
      })).optional().describe('Escalation levels and their targets'),
