...
export let getSurvey = SlateTool.create(
  spec,
  {
    name: 'Get Survey',
    key: 'get_survey',
  ...
  .input(z.object({
    ...
    includeDetails: z.boolean().optional().describe('If true, returns full survey details including pages, questions, and answer options'),
  }))
  .output(z.object({
    surveyId: z.string(),
    title: z.string(),
