...
export let getResponses = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.enum(['completed', 'partial', 'overquota', 'disqualified']).optional().describe('Filter by response status'),
    startCreatedAt: z.string().optional().describe('Filter responses created after this date (YYYY-MM-DDTHH:MM:SS)'),
    endCreatedAt: z.string().optional().describe('Filter responses created before this date (YYYY-MM-DDTHH:MM:SS)'),
    startModifiedAt: z.string().optional().describe('Filter responses modified after this date'),
    endModifiedAt: z.string().optional().describe('Filter responses modified before this date'),
    sortBy: z.enum(['date_modified']).optional().describe('Sort field'),
    sortOrder: z.enum(['ASC', 'DESC']).optional().describe('Sort direction'),
    simple: z.boolean().optional().describe('If true, includes question/answer text alongside IDs for easier reading'),
...
export let getResponse = SlateTool.create(
  spec,
  {
    name: 'Get Response',
    key: 'get_response',
