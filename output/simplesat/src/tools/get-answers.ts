...
export let getAnswers = SlateTool.create(
  ...
  .output(z.object({
    ...
    answers: z.array(z.object({
      ...
      sentiment: z.string().nullable().describe('Sentiment classification (positive, neutral, negative)'),
      followUpAnswer: z.string().nullable().describe('Follow-up text answer if provided'),
      publishedAsTestimonial: z.boolean().describe('Whether this answer is published as a testimonial'),
