...
export let taskCompleted = SlateTrigger.create(
  spec,
  {
    name: 'Task Completed',
    key: 'task_completed',
    description: 'Triggers when a conversion task finishes (succeeds or fails). Polls for recently completed tasks and emits events for each new completion.',
  }
)
  .input(z.object({
