...
export let createApplicationTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    interviewStageId: z.string().optional().describe('ID of the interview stage to start the application at'),
    sourceId: z.string().optional().describe('ID of the source to attribute the application to'),
    creditedToUserId: z.string().optional().describe('ID of the user to credit for this application'),
  }))
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.interviewPlanId !== undefined) params.interviewPlanId = ctx.input.interviewPlanId;
    if (ctx.input.interviewStageId !== undefined) params.interviewStageId = ctx.input.interviewStageId;
    if (ctx.input.sourceId !== undefined) params.sourceId = ctx.input.sourceId;
    if (ctx.input.creditedToUserId !== undefined) params.creditedToUserId = ctx.input.creditedToUserId;
