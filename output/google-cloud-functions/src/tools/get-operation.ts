...
export let getOperation = SlateTool.create(
  ...
  .input(z.object({
    operationName: z.string().describe('Full operation name returned by create, update, or delete operations (e.g. "projects/my-project/locations/us-central1/operations/abc123")')
  }))
  .output(z.object({
