...
export let listPickedMedia = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    pageSize: z.number().min(1).max(100).optional().describe('Maximum number of items to return (1-100, default 50)'),
  ...
  .output(z.object({
    mediaItems: z.array(z.object({
      ...
      baseUrl: z.string().optional().describe('Base URL for accessing the media bytes (active for 60 minutes)'),
