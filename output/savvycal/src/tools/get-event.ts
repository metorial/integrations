...
export let getEventTool = SlateTool.create(
  ...
  .output(z.object({
    ...
    originalStartAt: z.string().nullable().optional().describe('Original start time if rescheduled'),
    originalEndAt: z.string().nullable().optional().describe('Original end time if rescheduled'),
