...
export let listGroups = SlateTool.create(
  ...
  .input(z.object({
    ...
    limit: z.number().min(1).max(100).optional().describe('Maximum number of groups to return (1-100, default 100)'),
  ...
  .output(z.object({
    groups: z.array(z.object({
      ...
      membershipMethod: z.string().optional().describe('Membership method (e.g. STATIC, DYNAMIC_AUTOMATED)'),
