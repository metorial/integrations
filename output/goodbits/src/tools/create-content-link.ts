...
export let createContentLink = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    fetchRemoteThumbnailUrl: z.string().optional().describe('URL of an image to use as the thumbnail'),
    imageCandidates: z.array(z.string()).optional().describe('Array of image URLs to use as thumbnail candidates'),
  }))
  .output(z.object({
