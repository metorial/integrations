...
let filterPropertySchema = z.object({
  property: z.string().describe('Property name to filter on (e.g. "name", "creationTime", "dueDate", "invoiceType").'),
...
Returns matching projects with their full details.`,
  ...
  .input(z.object({
    ...
    sortAscending: z.boolean().optional().default(false).describe('Sort results in ascending order.'),
