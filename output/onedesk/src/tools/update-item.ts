...
Modify the name, description, priority, or completion percentage of a ticket, task, or other item type.`,
  ...
  .input(z.object({
    ...
    description: z.string().optional().describe('New description for the work item. Supports HTML.'),
    priority: z.number().optional().describe('New priority level (0=No priority, 20=1-star, 40=2-star, 60=3-star, 80=4-star, 100=5-star).'),
