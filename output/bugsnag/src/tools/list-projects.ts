...
let projectSchema = z.object({
  ...
  updatedAt: z.string().optional().describe('ISO 8601 timestamp when the project was last updated'),
...
export let listProjects = SlateTool.create(
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (!orgId) throw new Error('Organization ID is required. Provide it in the input or set it in the config.');
