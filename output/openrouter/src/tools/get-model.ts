...
export let getModel = SlateTool.create(
  ...
  .input(z.object({
    modelId: z.string().describe('Model identifier (e.g., "openai/gpt-4o", "anthropic/claude-3.5-sonnet")'),
  }))
  .output(z.object({
    ...
    }).optional().describe('Architecture details'),
    supportedParameters: z.array(z.string()).optional().describe('List of supported API parameters'),
