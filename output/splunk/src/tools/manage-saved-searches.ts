...
export let listSavedSearches = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    searchFilter: z.string().optional().describe('Filter string to match saved search names'),
...
export let createSavedSearch = SlateTool.create(
  ...
  .input(z.object({
    ...
    cronSchedule: z.string().optional().describe('Cron schedule expression (e.g. "*/5 * * * *")'),
    ...
    alertActions: z.string().optional().describe('Comma-separated alert actions (e.g. "email,webhook")'),
...
export let dispatchSavedSearch = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    forceDispatch: z.boolean().optional().describe('Force dispatch even if another instance is running'),
    namespace: namespaceSchema
  }))
  .output(z.object({
