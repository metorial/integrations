...
export let listKVStoreCollections = SlateTool.create(
  spec,
  {
...
export let createKVStoreCollection = SlateTool.create(
  spec,
  {
...
export let deleteKVStoreCollection = SlateTool.create(
  spec,
  {
...
export let queryKVStoreRecords = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    query: z.string().optional().describe('MongoDB-style query JSON string (e.g. {"status": "active"})'),
...
export let upsertKVStoreRecord = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    recordKey: z.string().optional().describe('Existing record _key for update (omit to insert new)'),
    owner: z.string().optional().describe('Owner username (default: "nobody")')
  }))
  .output(z.object({
...
export let deleteKVStoreRecords = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    query: z.string().optional().describe('MongoDB-style query to match records for deletion'),
    owner: z.string().optional().describe('Owner username (default: "nobody")')
  }))
  .output(z.object({
    deleted: z.boolean()
