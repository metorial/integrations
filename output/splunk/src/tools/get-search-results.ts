...
export let getSearchResults = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    dispatchState: z.string().optional().describe('Current state: QUEUED, PARSING, RUNNING, FINALIZING, DONE, FAILED'),
    ...
    results: z.array(z.record(z.string(), z.any())).optional().describe('Search result rows'),
