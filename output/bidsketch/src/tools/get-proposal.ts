...
export let getProposal = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeContent: z.boolean().optional().describe('If true, fetches full proposal content including all sections and fees')
  }))
  .output(z.object({
    ...
    }).nullable().describe('Proposal display settings'),
    content: z.any().nullable().describe('Full proposal content (sections and fees) when includeContent is true'),
