...
export let getTracking = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    startDate: z.string().optional().describe('Filter trackings created after this date (ISO 8601)'),
    endDate: z.string().optional().describe('Filter trackings created before this date (ISO 8601)'),
