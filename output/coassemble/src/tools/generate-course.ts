...
export let generateCourse = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Requires Headless course creation access on your workspace.',
    ],
  }
)
  .input(z.object({
    ...
    clientIdentifier: z.string().optional().describe('Client identifier to associate with the course'),
    audience: z.string().optional().describe('Target audience for the course (e.g. "new employees", "sales team")'),
    familiarity: z.string().optional().describe('Learner familiarity level (e.g. "beginner", "intermediate", "advanced")'),
    tone: z.string().optional().describe('Content tone (e.g. "professional", "casual", "educational")'),
