...
let messageSchema = z.object({
  ...
  threadTs: z.string().optional().describe('Thread parent timestamp if this is a thread reply'),
...
export let getConversationHistory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    threadTs: z.string().optional().describe('If provided, fetches replies in this thread instead of channel messages'),
