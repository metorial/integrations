...
export let fetchPage = SlateTool.create(
  ...
  .input(z.object({
    ...
    allowRedirects: z.boolean().optional().describe('Follow HTTP redirects (default: false)'),
    allowInsecureSsl: z.boolean().optional().describe('Bypass TLS certificate verification (default: false)'),
