...
export let listConnectors = SlateTool.create(
  ...
  .output(z.object({
    connectors: z.array(z.object({
      ...
      type: z.string().describe('Type of the connector (e.g. google_drive, sharepoint, notion)'),
      collectionId: z.string().describe('ID of the collection this connector syncs to'),
      createdAt: z.string().optional().describe('ISO timestamp when the connector was created'),
      updatedAt: z.string().optional().describe('ISO timestamp when the connector was last updated'),
