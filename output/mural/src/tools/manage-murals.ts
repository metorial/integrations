...
export let listMuralsTool = SlateTool.create(
  spec,
  {
    name: 'List Murals',
    key: 'list_murals',
...
export let getMuralTool = SlateTool.create(
  spec,
  {
    name: 'Get Mural',
    key: 'get_mural',
...
export let createMuralTool = SlateTool.create(
  spec,
  {
    name: 'Create Mural',
    key: 'create_mural',
...
export let updateMuralTool = SlateTool.create(
  spec,
  {
    name: 'Update Mural',
    key: 'update_mural',
...
export let deleteMuralTool = SlateTool.create(
  spec,
  {
    name: 'Delete Mural',
    key: 'delete_mural',
...
export let duplicateMuralTool = SlateTool.create(
  spec,
  {
