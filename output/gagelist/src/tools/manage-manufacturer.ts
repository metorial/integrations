...
export let listManufacturers = SlateTool.create(
  spec,
  {
...
export let createManufacturer = SlateTool.create(
  spec,
  {
...
export let updateManufacturer = SlateTool.create(
  spec,
  {
...
export let deleteManufacturer = SlateTool.create(
  spec,
  {
