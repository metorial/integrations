...
let componentSchema = z.object({
  ...
  containingFrame: z.object({
    name: z.string().optional(),
    nodeId: z.string().optional(),
    pageId: z.string().optional(),
    pageName: z.string().optional()
  }).optional().describe('Frame containing this component')
});

export let getComponents = SlateTool.create(
  spec,
  {
    name: 'Get Components',
    key: 'get_components',
  ...
  .input(z.object({
    ...
    fileKey: z.string().optional().describe('File key to get components from a specific file'),
    componentKey: z.string().optional().describe('Specific component key to get details for a single component'),
    pageSize: z.number().optional().describe('Number of components to return (team-level only)'),
