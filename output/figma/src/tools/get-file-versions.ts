...
export let getFileVersions = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    before: z.string().optional().describe('Version ID cursor - return versions before this version'),
    after: z.string().optional().describe('Version ID cursor - return versions after this version')
  }))
  .output(z.object({
    versions: z.array(z.object({
      ...
      }).optional().describe('User who created this version')
