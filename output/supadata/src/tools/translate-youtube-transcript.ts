...
export let translateYouTubeTranscript = SlateTool.create(
  spec,
  {
...
This is specific to YouTube and uses YouTube's built-in translation capabilities.`,
  ...
  .input(z.object({
    ...
    targetLang: z.string().describe('Target language code (ISO 639-1, e.g. "es", "fr", "de")'),
  ...
  .output(z.object({
    content: z.union([
      ...
      z.string(),
    ]).optional().describe('Translated transcript content'),
