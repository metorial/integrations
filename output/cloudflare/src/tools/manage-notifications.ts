...
export let manageNotificationsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    mechanisms: z.record(z.string(), z.array(z.object({ id: z.string() }))).optional().describe('Delivery mechanisms (email, webhooks, pagerduty)'),
    filters: z.record(z.string(), z.array(z.string())).optional().describe('Filters for the notification policy'),
    webhookUrl: z.string().optional().describe('Webhook URL for creating a webhook destination'),
