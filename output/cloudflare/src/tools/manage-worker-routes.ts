...
export let manageWorkerRoutesTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    pattern: z.string().optional().describe('URL pattern for the route (e.g. example.com/api/*)'),
