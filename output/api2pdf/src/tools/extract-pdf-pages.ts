...
export let extractPdfPages = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    start: z.number().optional().describe('Start page index (0-indexed, inclusive). Supports negative indexing.'),
    end: z.number().optional().describe('End page index (0-indexed, inclusive). Supports negative indexing.'),
