...
export let generateBarcode = SlateTool.create(
  ...
  .input(z.object({
    format: z.string().describe('Barcode format, e.g. "QR_CODE", "CODE_39", "CODE_128", "EAN_13"'),
    ...
    showLabel: z.boolean().optional().describe('Whether to display the encoded value as a label below the barcode'),
  }))
  .output(z.object({
