...
export class RenderClient {
  ...
  async scaleService(serviceId: string, numInstances: number) {
    let response = await this.axios.post(`/services/${serviceId}/scale`, { numInstances }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async updateServiceEnvVars(serviceId: string, envVars: Array<{ key: string; value: string }>) {
  ...
  async setServiceEnvVar(serviceId: string, name: string, value: string) {
    let response = await this.axios.put(`/services/${serviceId}/env-vars/${name}`, { value }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async triggerDeploy(serviceId: string, body?: { clearCache?: string; commitId?: string; imageUrl?: string }) {
  ...
  async cancelDeploy(serviceId: string, deployId: string) {
    let response = await this.axios.post(`/services/${serviceId}/deploys/${deployId}/cancel`, null, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async rollbackDeploy(serviceId: string, deployId: string) {
    let response = await this.axios.post(`/services/${serviceId}/deploys/${deployId}/rollback`, null, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async addCustomDomain(serviceId: string, name: string) {
    let response = await this.axios.post('/custom-domains', { serviceId, name }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async createPostgresUser(postgresId: string, username: string) {
    let response = await this.axios.post(`/postgres/${postgresId}/users`, { username }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async restoreDiskSnapshot(diskId: string, snapshotId: string) {
    let response = await this.axios.post(`/disks/${diskId}/snapshots/${snapshotId}/restore`, null, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async linkServiceToEnvGroup(envGroupId: string, serviceId: string) {
    let response = await this.axios.post(`/env-groups/${envGroupId}/services`, { serviceId }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async setEnvGroupVar(envGroupId: string, name: string, value: string) {
    let response = await this.axios.put(`/env-groups/${envGroupId}/env-vars/${name}`, { value }, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async getEnvironment(projectId: string, environmentId: string) {
    let response = await this.axios.get(`/projects/${projectId}/environments/${environmentId}`, {
      headers: this.headers,
    });
    return response.data;
  }

  async updateEnvironment(projectId: string, environmentId: string, body: Record<string, any>) {
    let response = await this.axios.patch(`/projects/${projectId}/environments/${environmentId}`, body, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async deleteEnvironment(projectId: string, environmentId: string) {
    let response = await this.axios.delete(`/projects/${projectId}/environments/${environmentId}`, {
      headers: this.headers,
    });
    return response.data;
  }
  ...
  async updateServiceSecretFiles(serviceId: string, secretFiles: Array<{ name: string; content: string }>) {
