...
export let listActivities = SlateTool.create(
  ...
  .output(z.object({
    activities: z.array(z.object({
      ...
      trackableType: z.string().optional().describe('Type of the resource affected (e.g. "Story", "Component")'),
      action: z.string().optional().describe('Action key (e.g. "story.publish", "component.create")'),
