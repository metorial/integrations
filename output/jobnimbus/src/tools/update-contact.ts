...
export let updateContact = SlateTool.create(
  ...
  .input(z.object({
    contactId: z.string().describe('The unique JobNimbus ID (jnid) of the contact to update'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.recordTypeName !== undefined) data.record_type_name = ctx.input.recordTypeName;
