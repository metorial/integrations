...
export let getTimeEntries = SlateTool.create(
  ...
  .input(z.object({
    userId: z.string().optional().describe('User ID to get entries for. Defaults to the authenticated user.'),
    start: z.string().optional().describe('Filter entries starting after this ISO 8601 date'),
