...
export let listContacts = SlateTool.create(
  ...
  .input(z.object({
    ...
    limit: z.number().min(1).max(100).optional().describe('Number of contacts to return (1-100). Defaults to 10.'),
  ...
  .output(z.object({
    ...
    contacts: z.array(z.object({
      ...
      unsubscribeIds: z.array(z.string()).describe('Message type IDs the contact unsubscribed from'),
