...
export let upsertContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    })).optional().describe('Custom field values for the contact'),
    ...
    unsubscribeIds: z.array(z.string()).optional().describe('Message type IDs to unsubscribe from'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let c = await client.upsertContact(ctx.input.brandId, {
