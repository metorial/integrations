...
export let listLists = SlateTool.create(
  ...
  .input(z.object({
    ...
    limit: z.number().min(1).max(100).optional().describe('Number of lists to return (1-100). Defaults to 10.'),
  ...
  .output(z.object({
    ...
    lists: z.array(z.object({
      ...
      isAllContacts: z.boolean().describe('Whether this is the system list containing all contacts'),
