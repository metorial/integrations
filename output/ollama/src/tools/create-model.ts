...
export let createModel = SlateTool.create(
  ...
  .input(z.object({
    ...
    quantize: z.string().optional().describe('Quantization level (e.g., "q4_0", "q4_1", "q5_0", "q5_1", "q8_0").'),
    ...
    parameters: z.record(z.string(), z.unknown()).optional().describe('Custom model parameters.'),
  }))
  .output(z.object({
