...
export let managePermission = SlateTool.create(
  ...
  .input(z.object({
    ...
    path: z.string().optional().describe('Folder path to set permission on (required for create, optional filter for list)'),
    permission: z.enum(['admin', 'full', 'readonly', 'writeonly', 'list', 'history']).optional().describe('Permission level (required for create)'),
    ...
    includeGroups: z.boolean().optional().describe('Include inherited group permissions (for list)'),
  ...
  .output(z.object({
    ...
    })).optional().describe('List of permissions'),
    created: z.object({
      permissionId: z.number().describe('Permission ID'),
      path: z.string().describe('Folder path'),
      permission: z.string().describe('Permission level'),
    }).optional().describe('Created permission'),
