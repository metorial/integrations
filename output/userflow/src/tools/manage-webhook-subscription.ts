...
export let manageWebhookSubscription = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    subscriptionId: z.string().optional().describe('ID of the subscription (required for get/delete)'),
    url: z.string().optional().describe('URL to receive webhook notifications (required for create)'),
    topics: z.array(z.string()).optional().describe('List of topics to subscribe to (required for create)'),
  }))
  .output(z.object({
    ...
    }).optional().describe('Webhook subscription (for create/get)'),
    subscriptions: z.array(z.object({
      subscriptionId: z.string().describe('ID of the webhook subscription'),
      url: z.string().describe('Webhook URL'),
      topics: z.array(z.string()).describe('Subscribed topics'),
      createdAt: z.string().describe('Timestamp when the subscription was created'),
    })).optional().describe('List of webhook subscriptions (for list)'),
