...
export let trackEvent = SlateTool.create(
  ...
  .input(z.object({
    name: z.string().describe('Name of the event (e.g. "subscription_activated", "feature_used")'),
    ...
    attributes: z.record(z.string(), z.unknown()).optional().describe('Custom event attributes (e.g. plan_name, price)'),
  }))
  .output(z.object({
