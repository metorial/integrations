...
let conversationEventTypes = ['conversation_opened', 'conversation_snoozed', 'conversation_done'] as const;
...
export let conversationEvents = SlateTrigger.create(
  ...
  .input(z.object({
    ...
    })).optional().describe('Assigned users'),
    labels: z.array(z.object({
      labelId: z.string().optional(),
      name: z.string().optional(),
    })).optional().describe('Conversation labels'),
