...
export let listModels = SlateTool.create(
  ...
  .input(z.object({
    search: z.string().optional().describe('Optional search text to filter models by name or technical name'),
    limit: z.number().optional().default(100).describe('Maximum number of models to return (default: 100)'),
