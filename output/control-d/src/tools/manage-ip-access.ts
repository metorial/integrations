...
export let manageIpAccess = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    ips: z.array(z.string()).optional().describe('IP addresses to authorize or deauthorize (required for authorize/deauthorize)'),
  }))
  .output(z.object({
