...
export let popularVideos = SlateTool.create(
  spec,
  {
    name: 'Popular Videos',
    key: 'popular_videos',
  ...
  .input(z.object({
    ...
    minDuration: z.number().optional().describe('Minimum duration in seconds of returned videos'),
    maxDuration: z.number().optional().describe('Maximum duration in seconds of returned videos'),
