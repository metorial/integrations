...
export let createOrder = SlateTool.create(
  ...
  .input(z.object({
    orderStatusId: z.number().describe('Order status ID (retrieve available statuses with the Get Order Statuses tool)'),
    ...
    paymentMethod: z.string().describe('Payment method name, e.g. "PayPal", "Bank Transfer"'),
    ...
    deliveryCountryCode: z.string().optional().describe('Delivery country code (two-letter, e.g. "US")'),
    ...
    products: z.array(z.object({
      storage: z.string().optional().describe('Product source type: "db" (BaseLinker), "shop", or "warehouse"'),
