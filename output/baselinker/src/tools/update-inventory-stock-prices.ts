...
export let updateInventoryStockPrices = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    stockUpdates: z.record(z.string(), z.record(z.string(), z.number())).optional()
      .describe('Stock updates: { "productId": { "warehouseId": quantity } }'),
    priceUpdates: z.record(z.string(), z.record(z.string(), z.number())).optional()
