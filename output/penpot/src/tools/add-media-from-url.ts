...
export let addMediaFromUrlTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    isLocal: z.boolean().optional().default(true).describe('Whether the media is local to this file or available as a library asset'),
  }))
  .output(z.object({
