...
export let listExpenses = SlateTool.create(
  ...
  .input(z.object({
    ...
    dateFrom: z.string().optional().describe('Filter expenses on or after this date (YYYY-MM-DD)'),
    dateTo: z.string().optional().describe('Filter expenses on or before this date (YYYY-MM-DD)'),
  }))
  .output(z.object({
