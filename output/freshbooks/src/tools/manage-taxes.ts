...
export let manageTaxes = SlateTool.create(
  spec,
  {
    name: 'Manage Taxes',
    key: 'manage_taxes',
  ...
  .input(z.object({
    ...
    name: z.string().optional().describe('Tax name (e.g. "GST", "HST", "VAT") - required for create'),
    amount: z.string().optional().describe('Tax percentage as string (e.g. "13")'),
    compound: z.boolean().optional().describe('Whether this tax is compound (calculated on top of primary taxes)'),
