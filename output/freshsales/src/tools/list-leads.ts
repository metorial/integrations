...
export let listLeads = SlateTool.create(
  ...
  .input(z.object({
    viewId: z.number().describe('View ID to list leads from. Use the listFilters tool to get available views.'),
    page: z.number().optional().describe('Page number for pagination (starts at 1)'),
    sort: z.string().optional().describe('Field to sort by (e.g. "created_at", "updated_at", "lead_score")'),
