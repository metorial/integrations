...
export let manageAppointment = SlateTool.create(
  ...
  .input(z.object({
    appointmentId: z.number().optional().describe('ID of the appointment to update. Omit to create.'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.targetableType !== undefined) apptData.targetable_type = ctx.input.targetableType;
