...
export let listAclUsers = SlateTool.create(
  spec,
  {
    name: 'List ACL Users',
    key: 'list_acl_users',
...
export let createAclUser = SlateTool.create(
  spec,
  {
...
export let updateAclUser = SlateTool.create(
  spec,
  {
...
export let deleteAclUser = SlateTool.create(
  spec,
  {
