...
export let listCloudAccounts = SlateTool.create(
  spec,
  {
...
export let createCloudAccount = SlateTool.create(
  spec,
  {
...
export let updateCloudAccount = SlateTool.create(
  spec,
  {
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.accessSecretKey !== undefined) body.accessSecretKey = ctx.input.accessSecretKey;
    if (ctx.input.consoleUsername !== undefined) body.consoleUsername = ctx.input.consoleUsername;
    if (ctx.input.consolePassword !== undefined) body.consolePassword = ctx.input.consolePassword;
...
export let deleteCloudAccount = SlateTool.create(
  spec,
  {
