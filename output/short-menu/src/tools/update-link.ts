...
export let updateLink = SlateTool.create(
  ...
  .input(z.object({
    ...
    destinationUrl: z.string().optional().describe('New destination URL for the short link. If omitted, the current destination is kept.'),
    tags: z.array(tagSchema).optional().describe('Updated set of tags for the short link. Replaces all existing tags. If omitted, existing tags are kept.'),
  }))
  .output(z.object({
