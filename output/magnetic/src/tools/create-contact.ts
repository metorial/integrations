...
export let createContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    companyId: z.string().optional().describe('ID of an existing company to associate with this contact'),
    companyName: z.string().optional().describe('Name of the company. Used if companyId is not provided to create or match a company.'),
    ...
    externalRef: z.string().optional().describe('External reference identifier for the contact')
  }))
  .output(z.object({
