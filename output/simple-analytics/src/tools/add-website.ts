...
export let addWebsiteTool = SlateTool.create(
  spec,
  {
    name: 'Add Website',
    key: 'add_website',
  ...
  .input(z.object({
    hostname: z.string().describe('The domain name of the website to add (e.g. "example.com").'),
    timezone: z.string().optional().describe('IANA timezone identifier for the website (e.g. "Europe/Amsterdam"). Defaults to UTC.'),
    isPublic: z.boolean().optional().describe('Whether analytics data should be publicly accessible.'),
