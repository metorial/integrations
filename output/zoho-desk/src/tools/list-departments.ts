...
export let listDepartments = SlateTool.create(
  ...
  .input(z.object({
    departmentId: z.string().optional().describe('Specific department ID to retrieve. If omitted, lists all departments.'),
  ...
  .output(z.object({
    department: z.object({
      ...
      isVisibleInCustomerPortal: z.boolean().optional().describe('Visible in customer portal'),
    }).optional().describe('Single department (when departmentId is provided)'),
    departments: z.array(z.object({
      departmentId: z.string().describe('Department ID'),
      name: z.string().optional().describe('Department name'),
      description: z.string().optional().describe('Department description'),
    })).optional().describe('List of departments (when departmentId is omitted)'),
  }))
