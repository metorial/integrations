...
export let listAgents = SlateTool.create(
  ...
  .input(z.object({
    agentId: z.string().optional().describe('Specific agent ID to retrieve. If omitted, lists agents.'),
  ...
  .output(z.object({
    ...
    }).optional().describe('Single agent (when agentId is provided)'),
    agents: z.array(z.object({
      agentId: z.string().describe('Agent ID'),
      name: z.string().optional().describe('Agent name'),
      email: z.string().optional().describe('Agent email'),
      status: z.string().optional().describe('Agent status'),
    })).optional().describe('List of agents (when agentId is omitted)'),
  }))
