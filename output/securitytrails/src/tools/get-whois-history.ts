...
export let getWhoisHistory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    hostname: z.string().describe('Domain to look up WHOIS history for (e.g., "example.com")'),
  ...
  .output(z.object({
    ...
    records: z.array(z.object({
      ...
      nameServers: z.array(z.string()).optional().describe('Name servers at this point'),
      contacts: z.any().optional().describe('Contact information at this point')
    }).passthrough()).describe('Historical WHOIS records'),
