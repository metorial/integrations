...
export let getActivityLogs = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    activities: z.array(z.object({
      activityType: z.string().optional().describe('Type of activity (e.g., login, registration)'),
      timestamp: z.string().optional().describe('When the activity occurred'),
      ipAddress: z.string().optional().describe('IP address associated with the activity'),
