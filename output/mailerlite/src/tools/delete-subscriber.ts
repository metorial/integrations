...
export let deleteSubscriber = SlateTool.create(
  ...
  .input(z.object({
    ...
    mode: z.enum(['delete', 'forget']).default('delete').describe('Delete mode: "delete" removes the subscriber, "forget" performs GDPR-compliant permanent removal'),
  }))
  .output(z.object({
