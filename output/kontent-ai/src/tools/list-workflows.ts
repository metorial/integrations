  ...
  .output(z.object({
    workflows: z.array(z.object({
      ...
      steps: z.array(z.object({
        ...
        transitionsTo: z.array(z.string()).describe('IDs or codenames of steps this can transition to'),
      })).describe('Workflow steps'),
      scopes: z.array(z.object({
        contentTypeIds: z.array(z.string()).optional().describe('Content type IDs this workflow applies to'),
      })).optional().describe('Scopes defining which content types use this workflow'),
    })),
  }))
