...
export let getContentItem = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeVariants: z.boolean().default(false).describe('Whether to also fetch language variants for this item'),
  }))
  .output(z.object({
    ...
    variants: z.array(z.object({
      ...
      lastModified: z.string().describe('ISO 8601 timestamp of last modification'),
    })).optional().describe('Language variants if includeVariants is true'),
  }))
