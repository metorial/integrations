...
export let getBuild = SlateTool.create(
  ...
  .output(z.object({
    ...
    status: z.string().describe('Build status (e.g. queued, building, finished, failed, canceled)'),
    branch: z.string().optional().describe('Git branch'),
    tag: z.string().optional().describe('Git tag'),
    workflowId: z.string().optional().nullable().describe('Workflow ID (Workflow Editor apps)'),
    ...
    buildActions: z.array(buildActionSchema).optional().describe('Individual build action steps'),
