...
export let listIncidentTemplates = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    templates: z.array(z.object({
      ...
      body: z.string().optional().nullable().describe('Pre-filled incident message body'),
      ...
      shouldNotifySubscribers: z.boolean().optional().describe('Whether to notify subscribers'),
      componentIds: z.array(z.string()).optional().describe('Pre-filled affected component IDs'),
