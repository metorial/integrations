...
export let createCertificate = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    productId: z.number().optional().describe('Package product ID to create a certificate for'),
    couponId: z.number().optional().describe('Coupon ID to create a certificate for'),
    certificate: z.string().optional().describe('Custom certificate code (auto-generated if omitted)'),
...
export let checkCertificate = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    appointmentTypeId: z.number().optional().describe('Appointment type ID to check eligibility against'),
  }))
  .output(z.object({
    certificateId: z.number().describe('Certificate ID'),
    certificate: z.string().describe('Certificate code'),
...
export let deleteCertificate = SlateTool.create(
  spec,
  {
