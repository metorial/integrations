...
export let deviceInfoSchema = z.object({
  macAddress: z.string().describe('MAC address of the weather station device'),
  lastData: z.record(z.string(), z.any()).optional().describe('Most recent data reading from the device'),
  info: z.object({
    ...
    }).optional().describe('Geographical coordinates'),
