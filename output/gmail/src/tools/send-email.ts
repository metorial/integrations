...
export let sendEmail = SlateTool.create(
  ...
  .input(z.object({
    ...
    threadId: z.string().optional().describe('Thread ID to send this message as part of an existing conversation.'),
    inReplyTo: z.string().optional().describe('Message-ID header value of the message being replied to.'),
    ...
    attachments: z.array(z.object({
      ...
      mimeType: z.string().describe('MIME type of the attachment (e.g., "application/pdf").'),
