...
export let auth = SlateAuth.create()
  ...
  .addOauth({
    ...
    scopes: [
      ...
      {
        title: 'Metadata',
        description: 'Read metadata including labels, history records, and email headers, but not the body or attachments.',
      ...
      },
      {
        ...
        description: 'Manage sensitive mail settings including forwarding rules and aliases. Restricted to service accounts with domain-wide delegation.',
        scope: 'https://www.googleapis.com/auth/gmail.settings.sharing',
      },
      {
        title: 'Full Access',
        description: 'Full access to the Gmail account including permanent deletion of threads and messages.',
