...
export let manageCampaign = SlateTool.create(
  ...
  .input(z.object({
    ...
    widgetId: z.string().optional().describe('Widget ID to run the campaign through (required for run)'),
    name: z.string().optional().describe('Campaign name'),
    contactIds: z.array(z.string()).optional().describe('List of contact IDs to include in the campaign'),
    promptVariables: z.record(z.string(), z.string()).optional().describe('Dynamic prompt variables for personalization'),
  }))
  .output(z.object({
