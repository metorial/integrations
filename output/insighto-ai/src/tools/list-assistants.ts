...
export let listAssistants = SlateTool.create(
  ...
  .input(z.object({
    assistantId: z.string().optional().describe('Specific assistant ID to retrieve details for'),
    includeWidgets: z.boolean().optional().describe('Include linked widgets for the specified assistant'),
    includeDataSources: z.boolean().optional().describe('Include connected data sources for the specified assistant'),
