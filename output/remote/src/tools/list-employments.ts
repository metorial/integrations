...
export let listEmployments = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    status: z.string().optional().describe('Filter by employment status (e.g., active, onboarding, offboarding)'),
    page: z.number().optional().describe('Page number for pagination'),
    pageSize: z.number().optional().describe('Number of results per page'),
  }))
  .output(z.object({
    employments: z.array(z.record(z.string(), z.any())).describe('List of employment records'),
