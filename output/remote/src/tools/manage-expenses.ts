...
export let manageExpenses = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    action: z.enum(['create', 'update', 'get', 'list', 'list_categories']).describe('Action to perform'),
    expenseId: z.string().optional().describe('Expense ID (required for get, update)'),
    employmentId: z.string().optional().describe('Employment ID (used for create, list, list_categories)'),
    ...
    currency: z.string().optional().describe('Currency code (e.g., USD, EUR) for create/update'),
    category: z.string().optional().describe('Expense category for create/update'),
    expenseDate: z.string().optional().describe('Date of the expense (YYYY-MM-DD) for create'),
  ...
  .output(z.object({
    ...
    expenses: z.array(z.record(z.string(), z.any())).optional().describe('List of expense records'),
    categories: z.array(z.record(z.string(), z.any())).optional().describe('Available expense categories'),
