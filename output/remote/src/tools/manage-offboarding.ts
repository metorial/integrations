...
export let manageOffboarding = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    terminationDate: z.string().optional().describe('Planned termination date (YYYY-MM-DD) for create'),
    terminationReason: z.string().optional().describe('Reason for termination'),
    additionalComments: z.string().optional().describe('Additional comments about the offboarding'),
    confidential: z.boolean().optional().describe('Whether the offboarding is confidential'),
    type: z.string().optional().describe('Offboarding type (e.g., termination, resignation)'),
    proposedLastWorkingDate: z.string().optional().describe('Proposed last working date (YYYY-MM-DD)'),
    status: z.string().optional().describe('Filter by status when listing'),
    page: z.number().optional().describe('Page number'),
    pageSize: z.number().optional().describe('Page size'),
  }))
  .output(z.object({
    offboarding: z.record(z.string(), z.any()).optional().describe('Single offboarding record'),
    offboardings: z.array(z.record(z.string(), z.any())).optional().describe('List of offboarding records'),
