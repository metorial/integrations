...
export let domainEventsTrigger = SlateTrigger.create(
  spec,
  {
    name: 'Domain Events',
    key: 'domain_events',
    description: 'Fires when account-level domain events occur: creation, DNS changes, certificate lifecycle, renewal, and transfer events.',
  }
)
  .input(z.object({
