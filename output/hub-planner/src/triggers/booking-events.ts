...
export let bookingEvents = SlateTrigger.create(
  ...
  .input(z.object({
    eventType: z.string().describe('The webhook event type (e.g. booking.create, booking.update, booking.delete)'),
  ...
  .webhook({
    autoRegisterWebhook: async (ctx) => {
      ...
      let events = ['booking.create', 'booking.update', 'booking.delete', 'booking.delete.multiple'];
