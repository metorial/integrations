...
export let createCompany = SlateTool.create(
  ...
  .input(z.object({
    ...
    emailDomain: z.string().optional().describe('Company email domain (e.g., "example.com")'),
...
export let searchCompanies = SlateTool.create(
  ...
  .input(z.object({
    ...
    sortBy: z.string().optional().describe('Field to sort by: name, city, state, date_modified, date_created'),
