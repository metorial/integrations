...
export let getRelatedItems = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    entityType: z.enum(['people', 'companies', 'leads', 'opportunities', 'projects', 'tasks']).describe('Type of the source entity'),
...
export let createRelatedItem = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    entityType: z.enum(['people', 'companies', 'leads', 'opportunities', 'projects', 'tasks']).describe('Type of the source entity (plural form)'),
    entityId: z.number().describe('ID of the source entity'),
    relatedResourceType: z.string().describe('Type of the entity to relate: "person", "company", "opportunity", "project", "task", or "lead"'),
...
export let deleteRelatedItem = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    entityType: z.enum(['people', 'companies', 'leads', 'opportunities', 'projects', 'tasks']).describe('Type of the source entity (plural form)'),
    entityId: z.number().describe('ID of the source entity'),
    relatedResourceType: z.string().describe('Type of the related entity: "person", "company", "opportunity", "project", "task", or "lead"'),
