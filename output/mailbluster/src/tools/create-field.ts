...
export let createField = SlateTool.create(
  ...
  .input(z.object({
    fieldLabel: z.string().describe('Display label for the custom field (e.g., "Company Name")'),
    fieldMergeTag: z.string().describe('Merge tag key for the custom field (e.g., "company_name")'),
  }))
  .output(z.object({
