...
If no lead exists for the provided customer email, a new lead is automatically created.`,
  ...
  .input(z.object({
    ...
    customerEmail: z.string().describe('Email address of the customer. A new lead is created if none exists.'),
    ...
    campaignId: z.string().optional().describe('Campaign ID to attribute this order to for revenue tracking'),
