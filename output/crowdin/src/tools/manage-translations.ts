...
export let manageTranslationsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    action: z.enum(['add_string_translation', 'upload_file_translation', 'pre_translate', 'list_string_translations']).describe('Action to perform'),
    stringId: z.number().optional().describe('String ID (for add_string_translation/list_string_translations)'),
    ...
    fileContent: z.string().optional().describe('Translation file content (for upload_file_translation)'),
    fileName: z.string().optional().describe('Translation file name (for upload_file_translation)'),
    autoApproveImported: z.boolean().optional().describe('Auto-approve imported translations'),
    languageIds: z.array(z.string()).optional().describe('Target language IDs (for pre_translate)'),
    ...
    engineId: z.number().optional().describe('MT engine ID (for pre_translate with mt method)'),
