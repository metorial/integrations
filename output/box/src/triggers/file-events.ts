...
let fileEventTypes = [
  'FILE.UPLOADED', 'FILE.DOWNLOADED', 'FILE.PREVIEWED', 'FILE.COPIED',
  'FILE.MOVED', 'FILE.RENAMED', 'FILE.LOCKED', 'FILE.UNLOCKED',
...
export let fileEvents = SlateTrigger.create(
  spec,
  {
    name: 'File Events',
    key: 'file_events',
    description: 'Triggers when file lifecycle events occur: uploaded, downloaded, previewed, copied, moved, renamed, locked, unlocked, trashed, deleted, or restored. Attach to a specific folder to monitor all files within.'
  }
)
  .input(z.object({
