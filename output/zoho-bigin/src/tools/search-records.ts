...
export let searchRecords = SlateTool.create(
  ...
  .input(z.object({
    ...
    email: z.string().optional()
      .describe('Search by email address across all email fields'),
    phone: z.string().optional()
      .describe('Search by phone number across all phone fields'),
    word: z.string().optional()
      .describe('Keyword search across all searchable fields'),
