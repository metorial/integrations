...
let campaignSchema = z.object({
  ...
  prospectsContacted: z.number().optional().nullable().describe('Number of prospects contacted'),
  prospectsReached: z.number().optional().nullable().describe('Number of prospects reached'),
  prospectsReplied: z.number().optional().nullable().describe('Number of prospects who replied'),
  prospectsOpened: z.number().optional().nullable().describe('Number of prospects who opened emails'),
  prospectsBounced: z.number().optional().nullable().describe('Number of bounced prospects'),
  prospectsOptedOut: z.number().optional().nullable().describe('Number of prospects who opted out'),
