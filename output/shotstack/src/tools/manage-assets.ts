...
export let getAssetTool = SlateTool.create(
  spec,
  {
...
export let getAssetsByRenderIdTool = SlateTool.create(
  spec,
  {
...
export let deleteAssetTool = SlateTool.create(
  spec,
  {
...
export let transferAssetTool = SlateTool.create(
  spec,
  {
    name: 'Transfer Asset',
    key: 'transfer_asset',
  ...
  .input(z.object({
    ...
    destinations: z.array(z.object({
      ...
      options: z.record(z.string(), z.any()).optional().describe('Provider-specific options (e.g. bucket, region for S3)'),
    })).optional().describe('Output destinations. Defaults to Shotstack CDN.'),
  }))
  .output(z.object({
