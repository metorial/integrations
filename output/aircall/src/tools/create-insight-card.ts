...
export let createInsightCard = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    contents: z.array(z.object({
      type: z.enum(['title', 'shortText']).describe('Card line type: title for headings, shortText for label-value pairs'),
      text: z.string().describe('The text content to display'),
      label: z.string().optional().describe('Label shown before the text (only for shortText type)'),
