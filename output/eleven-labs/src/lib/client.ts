...
export class ElevenLabsClient {
  ...
  async editVoiceSettings(voiceId: string, settings: {
    ...
    if (settings.useSpeakerBoost !== undefined) body['use_speaker_boost'] = settings.useSpeakerBoost;
  ...
  async textToSpeech(voiceId: string, params: {
    ...
    if (params.pronunciationDictionaryLocators) {
      body['pronunciation_dictionary_locators'] = params.pronunciationDictionaryLocators.map(l => ({
    ...
    if (params.voiceSettings) {
      ...
      if (params.voiceSettings.stability !== undefined) vs['stability'] = params.voiceSettings.stability;
      if (params.voiceSettings.similarityBoost !== undefined) vs['similarity_boost'] = params.voiceSettings.similarityBoost;
      if (params.voiceSettings.style !== undefined) vs['style'] = params.voiceSettings.style;
      if (params.voiceSettings.useSpeakerBoost !== undefined) vs['use_speaker_boost'] = params.voiceSettings.useSpeakerBoost;
  ...
  async listHistory(params?: {
    ...
    let query: Record<string, string | number> = {};
    if (params?.pageSize) query['page_size'] = params.pageSize;
    if (params?.startAfterHistoryItemId) query['start_after_history_item_id'] = params.startAfterHistoryItemId;
