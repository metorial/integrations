...
export let getSummaryReport = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    timezoneOffset: z.string().optional().describe('Timezone offset (defaults to user timezone)'),
    projectIds: z.string().optional().describe('Semicolon-separated project IDs to filter by'),
