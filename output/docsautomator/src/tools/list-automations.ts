...
let automationSchema = z.object({
  ...
  dataSourceName: z.string().optional().describe('Data source type (e.g., "API", "Airtable", "Google Sheets").'),
  isActive: z.boolean().optional().describe('Whether the automation is currently active.'),
  saveGoogleDoc: z.boolean().optional().describe('Whether a Google Doc copy is saved on generation.'),
