...
export let listPlaceholders = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    placeholders: z.record(z.string(), z.array(z.string())).describe('Placeholder names grouped by section. "main" contains top-level placeholders, "line_items_1", "line_items_2", etc. contain line item placeholders.'),
  }))
