...
export let getUnifiedSnapshot = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    tickers: z.string().describe('Comma-separated list of tickers (e.g., "AAPL,C:EURUSD,X:BTCUSD,I:SPX")'),
  }))
  .output(z.object({
    snapshots: z.array(z.object({
      ...
      }).optional().describe('Current session data'),
