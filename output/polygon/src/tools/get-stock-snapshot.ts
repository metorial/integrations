...
let snapshotBarSchema = z.object({
...
let snapshotOutputSchema = z.object({
  ...
  todaysChangePercent: z.number().optional().describe('Percentage change from previous trading day'),
...
export let getStockSnapshot = SlateTool.create(
  ...
  .input(z.object({
    tickers: z.string().describe('Comma-separated list of stock ticker symbols (e.g., "AAPL" or "AAPL,TSLA,GOOG")'),
