...
export let incidentMembershipEvents = SlateTrigger.create(
  spec,
  {
  ...
  .webhook({
    handleRequest: async (ctx) => {
      ...
      let isMembershipEvent = eventType.includes('membership_granted') ||
        eventType.includes('membership_revoked');
