...
export let createIncident = SlateTool.create(
  ...
  .input(z.object({
    visibility: z.enum(['public', 'private']).describe('Whether the incident is visible to all or restricted'),
    ...
    mode: z.enum(['standard', 'retrospective', 'test', 'tutorial']).optional().describe('Incident mode'),
    idempotencyKey: z.string().optional().describe('Unique key for request deduplication; auto-generated if omitted'),
    customFieldEntries: z.array(z.object({
