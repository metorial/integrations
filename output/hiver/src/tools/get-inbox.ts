...
export let getInbox = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeUsers: z.boolean().optional().default(true).describe('Whether to include users in the inbox'),
    includeTags: z.boolean().optional().default(true).describe('Whether to include tags in the inbox'),
  }))
  .output(z.object({
    ...
    })).optional().describe('Users with access to this inbox'),
    ...
    })).optional().describe('Tags available in this inbox'),
  }))
