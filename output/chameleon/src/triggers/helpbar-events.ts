...
export let helpbarEvents = SlateTrigger.create(
  spec,
  {
    name: 'HelpBar Events',
    key: 'helpbar_events',
    description: 'Triggers when a user interacts with the Chameleon HelpBar: search queries, AI answers, item actions, and item errors.',
  }
)
  .input(z.object({
