...
export let getZapTemplates = SlateTool.create(
  spec,
  {
...
Use this to suggest popular automations to users or to discover common integration patterns.`,
  ...
  .input(z.object({
    apps: z.string().optional().describe('Comma-separated list of Zapier app names to match templates against'),
    limit: z.number().optional().describe('Maximum templates to return (default: 5, max: 100)'),
