...
export let listCalls = SlateTool.create(
  ...
  .input(z.object({
    ...
    callStatus: z.string().optional().describe('Filter by call status (e.g., "completed", "busy", "failed", "no-answer")'),
    ...
    leadPhoneNumber: z.string().optional().describe('Filter by lead phone number (E.164 format)'),
  }))
  .output(z.object({
