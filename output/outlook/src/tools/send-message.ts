...
let attachmentSchema = z.object({
  ...
  contentType: z.string().optional().describe('MIME type of the attachment (e.g., "application/pdf")'),
...
export let sendMessage = SlateTool.create(
  ...
  .input(z.object({
    ...
    saveToSentItems: z.boolean().optional().describe('Whether to save the message to Sent Items. Defaults to true.'),
  }))
  .output(z.object({
