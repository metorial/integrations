...
export let createContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    displayName: z.string().optional().describe('Display name (auto-generated from given/surname if omitted)'),
    ...
    folderId: z.string().optional().describe('Contact folder ID. Omit to use the default folder.'),
  }))
  .output(z.object({
    contactId: z.string(),
