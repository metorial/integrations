...
Returns a URL to the generated audio file.`,
  ...
  .input(z.object({
    ...
    referenceAudioUrl: z.string().optional().describe('Reference audio URL for voice cloning'),
    referenceText: z.string().optional().describe('Transcript of the reference audio for voice cloning'),
