...
export let getNodeTool = SlateTool.create(
  spec,
  {
    name: 'Get Node',
    key: 'get_node',
  ...
  .input(z.object({
    ...
    childrenStart: z.number().optional().describe('Starting index for children pagination (1-based)'),
...
export let createNodeTool = SlateTool.create(
  spec,
  {
    name: 'Create Node',
    key: 'create_node',
    ...
    constraints: [
      'The folder hierarchy can be at most 5 levels deep from the root.',
    ],
    tags: {
      destructive: false,
    },
...
export let updateNodeTool = SlateTool.create(
  spec,
  {
    name: 'Update Node',
    key: 'update_node',
...
export let deleteNodeTool = SlateTool.create(
  spec,
  {
    name: 'Delete Node',
    key: 'delete_node',
