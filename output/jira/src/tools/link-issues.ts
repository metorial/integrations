...
export let linkIssuesTool = SlateTool.create(
  spec,
  {
    name: 'Link Issues',
    key: 'link_issues',
  ...
  .input(z.object({
    linkTypeName: z.string().describe('The link type name (e.g., "Blocks", "Duplicate", "Relates").'),
...
export let listIssueLinkTypesTool = SlateTool.create(
  spec,
  {
