...
export let searchIssuesTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    startAt: z.number().optional().default(0).describe('The index of the first result to return (for pagination).'),
    maxResults: z.number().optional().default(50).describe('Maximum number of results to return (max 100).'),
