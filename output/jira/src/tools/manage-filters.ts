...
export let createFilterTool = SlateTool.create(
  spec,
  {
    name: 'Create Filter',
    key: 'create_filter',
  ...
  .input(z.object({
    ...
    favourite: z.boolean().optional().default(false).describe('Whether to mark the filter as a favourite.'),
  }))
  .output(z.object({
...
export let listFavouriteFiltersTool = SlateTool.create(
  spec,
  {
