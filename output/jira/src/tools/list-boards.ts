...
export let listBoardsTool = SlateTool.create(
  ...
  .output(z.object({
    ...
    boards: z.array(z.object({
      ...
      projectKey: z.string().optional().describe('The project key associated with the board.'),
      projectName: z.string().optional().describe('The project name associated with the board.'),
    })),
  }))
