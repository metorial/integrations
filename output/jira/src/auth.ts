...
export let auth = SlateAuth.create()
  ...
  .addTokenAuth({
    ...
    inputSchema: z.object({
      ...
      cloudId: z.string().describe('Your Jira Cloud ID. Found at https://your-domain.atlassian.net/_edge/tenant_info'),
    }),
    ...
    getProfile: async (ctx: { output: AuthOutput; input: { email: string; token: string; cloudId: string } }) => {
      let http = createAxios({
