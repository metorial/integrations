...
- **delete**: Remove a collection.`,
  ...
  .input(z.object({
    ...
    collectionId: z.string().optional().describe('Collection ID (required for update/delete)'),
    ...
    attributes: z.record(z.string(), z.any()).optional().describe('Additional collection attributes'),
  }))
  .output(z.object({
    collections: z.array(z.record(z.string(), z.any())).optional().describe('List of collections (for list)'),
    collection: z.record(z.string(), z.any()).optional().describe('Collection details (for create/update)'),
