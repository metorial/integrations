...
export let listGlossaries = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    glossaries: z.array(z.object({
      ...
      targetLanguages: z.array(z.string()).optional().nullable().describe('Target language codes.'),
      organizationDefault: z.boolean().optional().describe('Whether this is the default glossary for the organization.'),
