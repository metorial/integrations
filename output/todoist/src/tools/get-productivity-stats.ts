...
export let getProductivityStats = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    daysItems: z.array(z.object({
      date: z.string(),
      totalCompleted: z.number(),
    })).optional().describe('Daily completion counts'),
    weekItems: z.array(z.object({
      date: z.string(),
      totalCompleted: z.number(),
    })).optional().describe('Weekly completion counts'),
    currentDailyStreak: z.object({
      count: z.number(),
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }).optional().describe('Current daily goal streak'),
    currentWeeklyStreak: z.object({
      count: z.number(),
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }).optional().describe('Current weekly goal streak'),
  }))
