...
export let getTunnel = SlateTool.create(
  spec,
  {
    name: 'Get Tunnel',
    key: 'get_tunnel',
...
export let listTunnelSessions = SlateTool.create(
  spec,
  {
...
export let restartTunnelSession = SlateTool.create(
  spec,
  {
    ...
    constraints: ['Not supported on Windows agents', 'The agent process will be replaced via exec()'],
...
export let stopTunnelSession = SlateTool.create(
  spec,
  {
