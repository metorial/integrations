...
export let validatePhone = SlateTool.create(
  ...
  .input(z.object({
    phone: z.string().describe('The phone number to validate (include country code, e.g. +14152007986)'),
  }))
  .output(z.object({
    ...
    }).optional().describe('Country information for the phone number'),
    type: z.string().optional().describe('Line type (e.g. mobile, landline, voip, toll_free)'),
