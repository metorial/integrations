...
export let approveCampaign = SlateTool.create(
  spec,
  {
...
export let bookCampaign = SlateTool.create(
  spec,
  {
    name: 'Book Campaign',
    key: 'book_campaign',
  ...
  .input(z.object({
    ...
    nextAvailableDate: z.boolean().optional().describe('Use next available date if requested date is unavailable'),
...
export let getCampaignCost = SlateTool.create(
  spec,
  {
