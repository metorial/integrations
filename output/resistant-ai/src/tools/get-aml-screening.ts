...
export let getAmlScreening = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    matches: z.array(z.object({
      matchType: z.string().optional().describe('Type of match (pep, sanctions, adverse_media)'),
    ...
    })).optional().describe('Details of individual matches found'),
