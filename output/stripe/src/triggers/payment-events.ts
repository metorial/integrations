...
export let paymentEvents = SlateTrigger.create(
  spec,
  {
    name: 'Payment Events',
    key: 'payment_events',
    description: 'Triggered when payment-related events occur, including PaymentIntent, Charge, and Refund lifecycle changes such as creation, success, failure, and refunds.',
  }
)
  .input(z.object({
    ...
    handleEvent: async (ctx) => {
      ...
      return {
        ...
        output: {
          ...
          failureMessage: resource.failure_message || resource.last_payment_error?.message || null,
