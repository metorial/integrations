...
export let listResourcesTool = SlateTool.create(
  ...
  .input(z.object({
    resourceType: z.enum([
      'bots', 'conversations', 'datasets', 'skillsets', 'contacts',
      'memories', 'integrations', 'files', 'spaces', 'secrets', 'tasks', 'blueprints'
  ...
  .handleInvocation(async (ctx) => {
    ...
    switch (resourceType) {
      case 'bots': result = await client.listBots(params); break;
      case 'conversations': result = await client.listConversations(params); break;
      case 'datasets': result = await client.listDatasets(params); break;
      case 'skillsets': result = await client.listSkillsets(params); break;
      case 'contacts': result = await client.listContacts(params); break;
      case 'memories': result = await client.listMemories(params); break;
      case 'integrations': result = await client.listIntegrations(params); break;
      case 'files': result = await client.listFiles(params); break;
      case 'spaces': result = await client.listSpaces(params); break;
      case 'secrets': result = await client.listSecrets(params); break;
      case 'tasks': result = await client.listTasks(params); break;
      case 'blueprints': result = await client.listBlueprints(params); break;
