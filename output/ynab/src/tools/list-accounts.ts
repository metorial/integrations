...
let accountSchema = z.object({
  ...
  directImportLinked: z.boolean().optional().describe('Whether a linked bank import is set up'),
  directImportInError: z.boolean().optional().describe('Whether the linked import is in an error state'),
