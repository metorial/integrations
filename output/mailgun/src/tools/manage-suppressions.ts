...
Suppressed addresses are blocked from receiving further emails to protect sending reputation.`,
  ...
  .input(z.object({
    ...
    type: z.enum(['bounces', 'complaints', 'unsubscribes']).describe('Type of suppression to list'),
...
export let addSuppression = SlateTool.create(
  ...
  .input(z.object({
    ...
    type: z.enum(['bounce', 'complaint', 'unsubscribe']).describe('Type of suppression to add'),
...
export let removeSuppression = SlateTool.create(
  ...
  .input(z.object({
    domain: z.string().describe('Domain name'),
    type: z.enum(['bounce', 'complaint', 'unsubscribe']).describe('Type of suppression to remove'),
