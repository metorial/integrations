...
export let lookupCodes = SlateTool.create(
  spec,
  {
    name: 'Lookup Codes',
    key: 'lookup_codes',
  ...
  .input(z.object({
    ...
    code: z.string().optional().describe('Specific code to look up (e.g. "541330" for NAICS, "8440" for PSC, "93.778" for grant program)'),
    agencyKey: z.number().optional().describe('Filter grant programs by agency key (grant_program only)'),
