...
export let getPicklistValues = SlateTool.create(
  spec,
  {
...
Use this to discover valid options before creating or updating records with picklist fields.`,
  ...
  .input(z.object({
    objectId: z.union([z.number(), z.string()]).describe('The object type number (e.g., 1 for accounts)'),
    fieldName: z.string().describe('The system field name of the picklist field (e.g., "accounttypecode", "statuscode")'),
  }))
  .output(z.object({
