...
export let createTestimonial = SlateTool.create(
  spec,
  {
    ...
    instructions: [
      'The propertyId can be found in the URL in your Endorsal Property Settings.',
    ],
  }
)
  .input(z.object({
    ...
    propertyId: z.string().describe('The Endorsal property ID to associate this testimonial with'),
    ...
    approved: z.boolean().optional().describe('Whether the testimonial should be approved immediately'),
