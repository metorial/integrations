...
export let getContact = SlateTool.create(
  ...
  .input(z.object({
    ...
    includeTestimonials: z.boolean().optional().describe('Whether to also fetch testimonials submitted by this contact'),
  }))
  .output(z.object({
    ...
    customAttributes: z.record(z.string(), z.unknown()).optional().describe('Custom contact attributes'),
    ...
    })).optional().describe('Testimonials submitted by this contact'),
  }))
