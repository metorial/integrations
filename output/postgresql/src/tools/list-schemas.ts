...
Useful for exploring the database structure and understanding the organization of tables across schemas.`,
  ...
  .input(z.object({
    includeSystemSchemas: z.boolean().optional().default(false).describe('Include system schemas (pg_catalog, information_schema, pg_toast)'),
  }))
  .output(z.object({
    schemas: z.array(z.object({
      ...
      sizeFormatted: z.string().nullable().describe('Total size of all tables in the schema'),
