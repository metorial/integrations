...
export let exportInventory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    includeViolationMetrics: z.boolean().optional().describe('Include violation metrics in the export'),
    includeFrameworkExceptionCounts: z.boolean().optional().describe('Include framework exception counts'),
  ...
  .output(z.object({
    ...
    totalCount: z.number().optional().describe('Total number of resources matching the filter')
  }).passthrough())
