...
export let exportUsers = SlateTool.create(
  spec,
  {
    name: 'Export Users',
    key: 'export_users',
  ...
  .input(z.object({
    ...
    })).optional().describe('User aliases to look up'),
    fieldsToExport: z.array(z.string()).optional().describe('Specific fields to include in the export (e.g. external_id, first_name, email, custom_attributes)')
  }))
  .output(z.object({
