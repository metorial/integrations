...
export let deleteUsers = SlateTool.create(
  spec,
  {
    name: 'Delete Users',
    key: 'delete_users',
...
export let mergeUsers = SlateTool.create(
  spec,
  {
    name: 'Merge Users',
    key: 'merge_users',
  ...
  .input(z.object({
    mergeUpdates: z.array(z.object({
      identifierToKeep: z.record(z.string(), z.any()).describe('Identifier of the user profile to keep (e.g. { external_id: "keep_id" })'),
      identifierToMerge: z.record(z.string(), z.any()).describe('Identifier of the user profile to merge and remove (e.g. { external_id: "merge_id" })')
