...
export let getCall = SlateTool.create(
  ...
  .output(z.object({
    ...
    callStatus: z.string().describe('Status: registered, not_connected, ongoing, ended, or error'),
    ...
    callAnalysis: z.any().optional().describe('Post-call analysis including sentiment, summary, and custom data'),
