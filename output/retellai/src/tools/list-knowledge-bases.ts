...
let knowledgeBaseSchema = z.object({
  ...
  status: z.string().describe('Status: in_progress, complete, error, or refreshing_in_progress'),
  enableAutoRefresh: z.boolean().optional().describe('Whether auto-refresh is enabled for URLs'),
