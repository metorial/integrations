...
Requires **Connect OAuth** authentication with the \`connect:fulfillment\` scope.`,
  ...
  .input(z.object({
    ...
    orderId: z.string().optional().describe('Specific order ID to retrieve. If omitted, returns all orders for the user.'),
  }))
  .output(z.object({
    orders: z.array(z.object({
      ...
      isInstacartplus: z.boolean().optional().describe('Whether Instacart+ benefits were applied'),
