...
export let getPerson = SlateTool.create(
  ...
  .input(z.object({
    ...
    withInteractionDates: z.boolean().optional().describe('Include first and last interaction dates'),
  }))
  .output(z.object({
    ...
    })).optional().describe('List entries this person belongs to'),
    interactionDates: z.object({
    ...
    }).optional().describe('Interaction date timestamps'),
  }))
