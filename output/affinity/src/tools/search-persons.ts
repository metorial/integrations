...
export let searchPersons = SlateTool.create(
  spec,
  {
    name: 'Search Persons',
    key: 'search_persons',
  ...
  .input(z.object({
    term: z.string().optional().describe('Search term to match against name or email address'),
    withInteractionDates: z.boolean().optional().describe('Include first and last interaction dates in results'),
