...
export let listCampaigns = SlateTool.create(
  ...
  .input(z.object({
    ...
    dateAdded: z.string().optional().describe('Filter campaigns created on or after this date (ISO 8601).'),
    lastModified: z.string().optional().describe('Filter campaigns modified on or after this date (ISO 8601).'),
...
export let listFunds = SlateTool.create(
  ...
  .input(z.object({
    ...
    dateAdded: z.string().optional().describe('Filter funds created on or after this date (ISO 8601).'),
    lastModified: z.string().optional().describe('Filter funds modified on or after this date (ISO 8601).'),
    limit: z.number().optional().describe('Number of records to return (default 500, max 5000).'),
    offset: z.number().optional().describe('Number of records to skip for pagination.'),
  }))
  .output(z.object({
...
export let getFund = SlateTool.create(
  spec,
  {
    name: 'Get Fund',
    key: 'get_fund',
...
export let listAppeals = SlateTool.create(
  spec,
  {
    name: 'List Appeals',
    key: 'list_appeals',
  ...
  .input(z.object({
    ...
    dateAdded: z.string().optional().describe('Filter appeals created on or after this date (ISO 8601).'),
    lastModified: z.string().optional().describe('Filter appeals modified on or after this date (ISO 8601).'),
    limit: z.number().optional().describe('Number of records to return (default 500, max 5000).'),
    offset: z.number().optional().describe('Number of records to skip for pagination.'),
  }))
  .output(z.object({
...
export let getAppeal = SlateTool.create(
  spec,
  {
    name: 'Get Appeal',
    key: 'get_appeal',
