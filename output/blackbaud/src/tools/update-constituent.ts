...
export let updateConstituent = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    }).optional().describe('New address to add to the constituent.'),
    newEmail: z.object({
      type: z.string().describe('Email type.'),
      address: z.string().describe('Email address.'),
      primary: z.boolean().optional(),
    }).optional().describe('New email address to add.'),
    newPhone: z.object({
      type: z.string().describe('Phone type.'),
      number: z.string().describe('Phone number.'),
      primary: z.boolean().optional(),
    }).optional().describe('New phone number to add.'),
    newNote: z.object({
    ...
    }).optional().describe('New note to add.'),
  }))
  .output(z.object({
