...
export let getGivingSummary = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    lifetimeGiving: z.any().optional().describe('Lifetime giving summary including total giving, pledge balance, consecutive years, etc.'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let summary = totalGiving !== undefined
