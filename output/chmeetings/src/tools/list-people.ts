...
export let listPeople = SlateTool.create(
  ...
  .input(z.object({
    ...
    name: z.string().optional().describe('Filter by name (when searching within an organization)'),
    mobile: z.string().optional().describe('Filter by mobile number (when searching within an organization)'),
    email: z.string().optional().describe('Filter by email (when searching within an organization)'),
    includeFamilyMembers: z.boolean().optional().describe('Include family members in the results (organization search only)'),
    includeAdditionalFields: z.boolean().optional().describe('Include additional profile fields (organization search only)'),
