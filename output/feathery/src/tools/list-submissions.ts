...
export let listSubmissions = SlateTool.create(
  ...
  .input(z.object({
    ...
    startTime: z.string().optional().describe('Filter submissions after this datetime (ISO 8601)'),
    endTime: z.string().optional().describe('Filter submissions before this datetime (ISO 8601)'),
    createdAfter: z.string().optional().describe('Filter by creation date after (ISO 8601)'),
    createdBefore: z.string().optional().describe('Filter by creation date before (ISO 8601)'),
    completed: z.boolean().optional().describe('Filter by completion status'),
    fieldSearch: z.record(z.string(), z.string()).optional().describe('Key-value pairs to search specific field values'),
    fields: z.array(z.string()).optional().describe('Specific field IDs to include in the response'),
  ...
  .output(z.object({
    submissions: z.array(z.object({
      ...
      fieldValues: z.record(z.string(), z.any()).optional().describe('Submitted field values'),
