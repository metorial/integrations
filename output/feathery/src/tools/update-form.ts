...
export let updateForm = SlateTool.create(
  ...
  .input(z.object({
    ...
    translations: z.any().optional().describe('Translation configuration for internationalization'),
    integrations: z.array(z.any()).optional().describe('Integration configurations (webhooks, etc.)'),
  }))
  .output(z.object({
