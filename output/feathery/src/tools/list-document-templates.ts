...
export let listDocumentTemplates = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    tags: z.string().optional().describe('Filter by tags. Use ";;" for OR logic within a tag, multiple tags for AND logic.'),
  }))
  .output(z.object({
