...
export let fillDocument = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    fieldValues: z.record(z.string(), z.any()).describe('Key-value mapping of template fields to fill values'),
    signerEmail: z.string().optional().describe('Email address to route the document to for signature'),
