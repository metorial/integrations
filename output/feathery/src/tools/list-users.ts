...
export let listUsers = SlateTool.create(
  ...
  .input(z.object({
    createdAfter: z.string().optional().describe('Filter users created after this datetime (ISO 8601)'),
    createdBefore: z.string().optional().describe('Filter users created before this datetime (ISO 8601)'),
