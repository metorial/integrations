...
export let moveInEventsTrigger = SlateTrigger.create(
  spec,
  {
    name: 'Move-In Events',
    key: 'move_in_events',
    description: 'Triggers on self-storage move-in lifecycle events: order initiation, submission, confirmation, completion, and cancellation.',
  }
)
  .input(z.object({
