...
export let listProjectTasks = SlateTool.create(
  spec,
  {
...
export let createProjectTask = SlateTool.create(
  spec,
  {
...
export let updateProjectTask = SlateTool.create(
  spec,
  {
...
export let deleteProjectTask = SlateTool.create(
  spec,
  {
