...
let commentOutputSchema = z.object({
  ...
  commentableType: z.string().optional().describe('Type of entity this comment is on (e.g., Project, Contact)'),
...
export let listComments = SlateTool.create(
  ...
  .input(z.object({
    commentableType: z.enum(['Company', 'Contact', 'Deal', 'Invoice', 'Offer', 'Project', 'Purchase']).optional().describe('Filter by entity type'),
...
export let createComment = SlateTool.create(
  ...
  .input(z.object({
    commentableType: z.enum(['Company', 'Contact', 'Deal', 'Invoice', 'Offer', 'Project', 'Purchase']).describe('Entity type to comment on'),
