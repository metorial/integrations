...
export let campaignEvents = SlateTrigger.create(
  spec,
  {
    ...
    key: 'campaign_events',
    description: 'Triggered when a campaign is created or updated. Configure the webhook in Givebutter Settings > Developers > Webhooks.',
  }
)
  .input(z.object({
  ...
  .webhook({
    handleRequest: async (ctx) => {
      ...
      let type = eventType === 'campaign.created' ? 'created' as const : 'updated' as const;
