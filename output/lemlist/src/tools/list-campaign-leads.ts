...
export let listCampaignLeads = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    state: z.string().optional().describe('Filter leads by state (e.g., scanned, contacted, interested, notInterested, skipped)')
  }))
  .output(z.object({
