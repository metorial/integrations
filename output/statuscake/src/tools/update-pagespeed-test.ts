...
export let updatePagespeedTest = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    alertSlower: z.number().optional().describe('Alert if load time exceeds this value in ms'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let { testId, checkRate, locationIso, contactGroups, alertBigger, alertSlower, alertSmaller, ...rest } = ctx.input;
