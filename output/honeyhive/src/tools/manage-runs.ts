...
export let listRuns = SlateTool.create(
  ...
  .input(z.object({
    project: z.string().optional().describe('Project name or ID. Falls back to the configured default project.'),
...
export let createRun = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    project: z.string().optional().describe('Project ID. Falls back to the configured default project.'),
    ...
    configuration: z.record(z.string(), z.any()).optional().describe('Configuration used for this run'),
...
export let getRun = SlateTool.create(
  ...
  .output(z.object({
    ...
    results: z.record(z.string(), z.any()).optional().describe('Evaluation results and metric outcomes'),
...
export let getRunResult = SlateTool.create(
  spec,
  {
...
export let compareRuns = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    commonDatapoints: z.array(z.string()).optional().describe('Datapoint IDs shared between runs'),
