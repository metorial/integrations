...
export let listSmsTool = SlateTool.create(
  spec,
  {
...
Use date filters to narrow results.`,
  ...
  .input(z.object({
    dateFrom: z.string().optional().describe('Start date filter (ISO 8601 format, e.g. "2024-01-01")'),
    dateTo: z.string().optional().describe('End date filter (ISO 8601 format, e.g. "2024-01-31")'),
