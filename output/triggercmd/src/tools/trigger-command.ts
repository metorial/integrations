...
export let triggerCommand = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    params: z.string().optional().describe('Optional parameters to pass to the command. The command must have "Allow Parameters" enabled.'),
  }))
  .output(z.object({
