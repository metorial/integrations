...
export let getDownloadHistory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    afterCreatedAt: z.string().optional().describe('Filter images downloaded after this date (ISO 8601)'),
    beforeCreatedAt: z.string().optional().describe('Filter images downloaded before this date (ISO 8601)'),
  }))
  .output(z.object({
    filteredResults: z.number().describe('Total number of downloaded images matching filters'),
