...
export let listCoursework = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    courseWorkStates: z.array(z.enum(['PUBLISHED', 'DRAFT', 'DELETED'])).optional()
      .describe('Filter by coursework states'),
    orderBy: z.string().optional().describe('Order by field (e.g., "dueDate asc", "updateTime desc")'),
