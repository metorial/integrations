...
export let createCourse = SlateTool.create(
  ...
  .input(z.object({
    ...
    ownerId: z.string().optional().describe('User ID or email of the course owner. Defaults to the authenticated user.'),
    courseState: z.enum(['ACTIVE', 'PROVISIONED']).optional()
