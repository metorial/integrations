...
export let searchPackages = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    query: z.string().describe('Search text. Supports keyword parameters like author:username, scope:scopename, keywords:keyword1,keyword2'),
    size: z.number().optional().describe('Number of results to return (default 20, max 250)'),
  ...
  .output(z.object({
    ...
    packages: z.array(z.object({
      ...
      scope: z.string().optional().describe('Package scope (e.g. "angular" for @angular/core)'),
      ...
      }).optional().describe('Relevant links'),
      score: z.object({
        final: z.number().optional(),
        quality: z.number().optional(),
        popularity: z.number().optional(),
        maintenance: z.number().optional(),
      }).optional().describe('Package scores'),
