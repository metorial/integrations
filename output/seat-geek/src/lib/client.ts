...
export class Client {
  ...
  async getEventRecommendations(params: Record<string, string>): Promise<SeatGeekEventRecommendationsResponse> {
  ...
  async getPerformerRecommendations(params: Record<string, string>): Promise<SeatGeekPerformerRecommendationsResponse> {
    let response = await api.get<SeatGeekPerformerRecommendationsResponse>('/recommendations/performers', {
      params: { ...this.baseParams(), ...params },
    });
    return response.data;
  }
