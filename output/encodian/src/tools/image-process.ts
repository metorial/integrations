...
export let imageProcess = SlateTool.create(
  spec,
  {
    name: 'Process Image',
    key: 'process_image',
...
Supports JPG, PNG, BMP, TIFF, GIF, and HEIC formats.`,
  ...
  .input(z.object({
    ...
    // Format conversion
    currentFormat: z.enum(['BMP', 'GIF', 'JPG', 'PNG', 'TIF', 'HEIC']).optional().describe('Current image format'),
    targetFormat: z.enum(['BMP', 'GIF', 'JPG', 'PNG', 'TIF']).optional().describe('Target image format'),
    // Compression
    ...
    resizePercentage: z.number().optional().describe('Resize percentage (for percentage resize)'),
    width: z.number().optional().describe('Target width in pixels'),
    height: z.number().optional().describe('Target height in pixels'),
    maintainAspectRatio: z.boolean().optional().describe('Maintain aspect ratio when resizing'),
    // Crop
    ...
    // Flip
    flipOrientation: z.enum(['Horizontal', 'Vertical', 'HorizontalAndVertical']).optional().describe('Flip orientation'),
    // Watermark
    watermarkText: z.string().optional().describe('Watermark text'),
    watermarkPosition: z.string().optional().describe('Watermark position (e.g., Diagonal, TopLeft, BottomRight, CentreHorizontal)'),
