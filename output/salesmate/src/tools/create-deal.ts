...
export let createDeal = SlateTool.create(
  ...
  .input(z.object({
    ...
    stage: z.string().describe('Pipeline stage name (must match a stage in the selected pipeline)'),
    ...
    estimatedCloseDate: z.string().optional().describe('Expected close date (YYYY-MM-DD format)'),
    ...
    followers: z.array(z.number()).optional().describe('Array of user IDs who should follow this deal'),
