...
export let getMacroIndicators = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    indicator: z.string().optional().describe('Specific indicator (default: gdp_current_usd). E.g., inflation_consumer_prices_annual, unemployment_total_percent')
  }))
  .output(z.object({
