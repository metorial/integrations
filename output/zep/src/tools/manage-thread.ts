...
export let manageThread = SlateTool.create(
  ...
  .input(z.object({
    ...
    userId: z.string().optional().describe('User ID that owns the thread (required for create)'),
    ...
    orderBy: z.enum(['created_at', 'updated_at', 'user_id', 'thread_id']).optional().describe('Field to order results by'),
  ...
  .output(z.object({
    ...
    }).optional().describe('Single thread result'),
    threads: z.array(z.object({
      threadId: z.string().describe('Thread ID'),
      userId: z.string().optional().nullable().describe('Owner user ID'),
      uuid: z.string().optional().nullable().describe('Zep internal UUID'),
      createdAt: z.string().optional().nullable().describe('Creation timestamp'),
    })).optional().describe('List of threads'),
