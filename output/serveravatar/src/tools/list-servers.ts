...
Optionally retrieve a single server's full details by providing a serverId.`,
  ...
  .input(z.object({
    ...
    serverId: z.string().optional().describe('Specific server ID to retrieve detailed info for'),
    page: z.number().optional().describe('Page number for pagination'),
  }))
  .output(z.object({
    servers: z.array(z.record(z.string(), z.unknown())).optional().describe('List of servers'),
