...
export let createNote = SlateTool.create(
  ...
  .input(z.object({
    ...
    html: z.string().optional().describe('HTML content for the note body (alternative to markdown)'),
    parentNoteId: z.string().optional().describe('ID of the parent note to nest this note under. If omitted, the note goes to the personal channel.'),
