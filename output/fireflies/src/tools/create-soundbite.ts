...
export let createSoundbite = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    privacies: z.array(z.enum(['public', 'team', 'participants'])).optional().describe('Visibility settings for the soundbite'),
    summary: z.string().optional().describe('Summary text for the soundbite (max 500 characters)'),
  }))
  .output(z.object({
