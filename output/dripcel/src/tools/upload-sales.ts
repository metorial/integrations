...
export let uploadSales = SlateTool.create(
  spec,
  {
    name: 'Upload Sales',
    key: 'upload_sales',
  ...
  .input(z.object({
    sales: z.array(z.object({
      ...
      soldAt: z.string().optional().describe('Sale date in ISO format (YYYY-MM-DD). Defaults to current date.'),
      saleValue: z.number().optional().describe('Sale amount. Defaults to campaign\'s defaultSaleValue.')
