...
export let searchContacts = SlateTool.create(
  ...
  .input(z.object({
    ...
    tagIdsIn: z.array(z.string()).optional().describe('Filter contacts that have any of these tag IDs'),
    tagIdsAll: z.array(z.string()).optional().describe('Filter contacts that have all of these tag IDs'),
    updatedAfter: z.string().optional().describe('Filter contacts updated on or after this date (ISO 8601)'),
    updatedBefore: z.string().optional().describe('Filter contacts updated on or before this date (ISO 8601)'),
