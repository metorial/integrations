...
export let listContacts = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.enum(['SUBSCRIBED', 'UNSUBSCRIBED', 'PENDING']).optional().describe('Filter by subscription status'),
    tag: z.string().optional().describe('Filter by tag name'),
    createdBefore: z.string().optional().describe('Filter contacts created before this ISO 8601 date'),
    createdAfter: z.string().optional().describe('Filter contacts created after this ISO 8601 date'),
    updatedBefore: z.string().optional().describe('Filter contacts updated before this ISO 8601 date'),
    updatedAfter: z.string().optional().describe('Filter contacts updated after this ISO 8601 date'),
