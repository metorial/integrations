...
export let filterPodioItems = SlateTool.create(
  spec,
  {
...
This is more powerful than search for building precise queries with multiple conditions. Follows the [Podio filter API](https://developers.podio.com/doc/items/filter-items-4496747) specification.`,
  ...
  .input(z.object({
    ...
    filter: z.record(z.string(), z.any()).describe('Filter criteria in Podio API format with filters, sort_by, sort_desc, limit, offset'),
  }))
  .output(z.object({
