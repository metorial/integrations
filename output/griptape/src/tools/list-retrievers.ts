...
export let listRetrievers = SlateTool.create(
  spec,
  {
  ...
  .handleInvocation(async (ctx) => {
    ...
    let result = await client.listRetrievers({ page: ctx.input.page, pageSize: ctx.input.pageSize });
