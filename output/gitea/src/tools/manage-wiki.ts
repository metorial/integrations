...
let wikiPageOutputSchema = z.object({
  ...
  contentBase64: z.string().optional().describe('Base64-encoded page content (only when fetching a single page)'),
...
export let listWikiPages = SlateTool.create(
  spec,
  {
...
export let getWikiPage = SlateTool.create(
  spec,
  {
    name: 'Get Wiki Page',
    key: 'get_wiki_page',
...
export let createWikiPage = SlateTool.create(
  spec,
  {
...
export let updateWikiPage = SlateTool.create(
  spec,
  {
...
export let deleteWikiPage = SlateTool.create(
  spec,
  {
