...
export let listMilestones = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    state: z.enum(['open', 'closed', 'all']).optional().describe('Filter by milestone state'),
...
export let createMilestone = SlateTool.create(
  spec,
  {
