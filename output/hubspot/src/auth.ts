...
let requiredScopeDefinitions: HubSpotScopeDefinition[] = [
  ...
  { title: 'Contacts Write', description: 'Write contacts', scope: 'crm.objects.contacts.write' },
  { title: 'Companies Read', description: 'Read companies', scope: 'crm.objects.companies.read' },
  { title: 'Companies Write', description: 'Write companies', scope: 'crm.objects.companies.write' },
  ...
  { title: 'CRM Contact Schemas Read', description: 'Read contact schemas', scope: 'crm.schemas.contacts.read' },
  { title: 'CRM Company Schemas Read', description: 'Read company schemas', scope: 'crm.schemas.companies.read' },
  { title: 'CRM Deal Schemas Read', description: 'Read deal schemas', scope: 'crm.schemas.deals.read' },
  ...
  { title: 'Timeline', description: 'Access CRM timeline events and engagements', scope: 'timeline' },
  { title: 'Sales Email Read', description: 'Read sales email data', scope: 'sales-email-read' },
  ...
  { title: 'Forms External Integrations', description: 'External integrations forms access', scope: 'external_integrations.forms.access' },
  { title: 'Forms Uploaded Files', description: 'Read uploaded files on forms', scope: 'forms-uploaded-files' },
];
...
let optionalScopeDefinitions: HubSpotScopeDefinition[] = [
  ...
  { title: 'Custom Objects Read', description: 'Read custom objects (Enterprise)', scope: 'crm.objects.custom.read' },
  { title: 'Custom Objects Write', description: 'Write custom objects (Enterprise)', scope: 'crm.objects.custom.write' },
...
export let auth = SlateAuth.create()
  ...
  .addOauth({
    ...
    handleCallback: async (ctx) => {
      ...
      let response = await httpClient.post('/oauth/v1/token', new URLSearchParams({
  ...
  .addTokenAuth({
    ...
    inputSchema: z.object({
      token: z.string().describe('Private App access token from HubSpot Settings > Integrations > Private Apps'),
    }),
