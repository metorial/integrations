...
export let listApps = SlateTool.create(
  ...
  .input(z.object({
    ...
    authMethod: z.number().optional().describe('Filter by auth method (0=Password, 1=OpenId, 2=SAML, 3=API, 4=Google, 6=Forms, 7=WSFED, 8=OpenIdConnect)'),
  }))
  .output(z.object({
    apps: z.array(z.object({
      ...
      visible: z.boolean().nullable().optional().describe('Whether the app is visible in the portal'),
