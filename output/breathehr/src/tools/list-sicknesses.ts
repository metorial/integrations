...
export let listSicknesses = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    startDate: z.string().optional().describe('Filter sicknesses starting from this date (format: YYYY-MM-DD)'),
    endDate: z.string().optional().describe('Filter sicknesses ending before this date (format: YYYY-MM-DD)'),
