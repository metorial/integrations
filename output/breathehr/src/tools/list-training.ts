...
export let listTraining = SlateTool.create(
  spec,
  {
    name: 'List Training',
    key: 'list_training',
  ...
  .input(z.object({
    resourceType: z.enum(['company_training_types', 'employee_training_courses']).describe('Whether to list company training types or employee training course records'),
