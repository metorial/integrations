...
export let listAccountsAndProperties = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    accountId: z.string().optional().describe('If provided, lists properties for this specific account (e.g., "123456"). Otherwise, lists all accessible accounts.'),
    pageSize: z.number().optional().describe('Number of results per page (default: 50, max: 200).'),
    pageToken: z.string().optional().describe('Page token for pagination.'),
  }))
  .output(z.object({
    accounts: z.array(z.object({
      name: z.string().optional().describe('Resource name of the account (e.g., "accounts/123456").'),
      displayName: z.string().optional(),
      regionCode: z.string().optional(),
      createTime: z.string().optional(),
      updateTime: z.string().optional(),
    })).optional().describe('List of GA accounts (when no accountId is provided).'),
    properties: z.array(z.object({
      name: z.string().optional().describe('Resource name of the property (e.g., "properties/987654").'),
      displayName: z.string().optional(),
      ...
      createTime: z.string().optional(),
      updateTime: z.string().optional(),
    })).optional().describe('List of GA4 properties (when accountId is provided).'),
