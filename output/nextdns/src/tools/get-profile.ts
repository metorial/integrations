...
export let getProfile = SlateTool.create(
  ...
  .output(z.object({
    ...
    privacy: z.record(z.string(), z.unknown()).describe('Privacy and ad-blocking configuration'),
    parentalControl: z.record(z.string(), z.unknown()).describe('Parental control configuration'),
    ...
    setup: z.record(z.string(), z.unknown()).optional().describe('Setup and connection information'),
  }))
