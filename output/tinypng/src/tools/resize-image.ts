...
export let resizeImage = SlateTool.create(
  ...
  .input(z.object({
    sourceUrl: z.string().describe('Publicly accessible URL of the image to compress and resize'),
    ...
    convertTo: z.string().optional().describe('Target image format MIME type, e.g. "image/webp", "image/png", "image/jpeg", "image/avif". Use "*/*" for smallest format.'),
