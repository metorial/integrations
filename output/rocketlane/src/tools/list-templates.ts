...
export let listTemplates = SlateTool.create(
  ...
  .input(z.object({
    templateId: z.number().optional().describe('If provided, retrieves full details of this specific template'),
  ...
  .output(z.object({
    ...
    })).optional().describe('List of templates (when listing all)'),
