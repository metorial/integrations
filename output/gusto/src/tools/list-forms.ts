...
export let listForms = SlateTool.create(
  ...
  .input(z.object({
    scope: z.enum(['company', 'employee', 'single']).describe('Whether to list company forms, employee forms, or get a single form'),
  ...
  .output(z.object({
    forms: z.array(z.object({
      ...
      requiresSigning: z.boolean().optional().describe('Whether the form requires signing'),
