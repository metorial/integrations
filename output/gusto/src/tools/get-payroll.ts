...
export let getPayroll = SlateTool.create(
  spec,
  {
    name: 'Get Payroll',
    key: 'get_payroll',
  ...
  .output(z.object({
    ...
    totals: z.any().optional().describe('Payroll totals including gross pay, net pay, taxes, etc.'),
    employeeCompensations: z.array(z.any()).optional().describe('Per-employee compensation details'),
  }))
