...
export let forkRepositoryTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    targetWorkspace: z.string().optional().describe('Target workspace slug for the fork (defaults to the configured workspace)'),
