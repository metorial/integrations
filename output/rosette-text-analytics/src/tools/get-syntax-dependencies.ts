...
export let getSyntaxDependenciesTool = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    sentences: z.array(z.object({
      tokens: z.array(z.object({
        ...
        dependencyType: z.string().describe('Dependency relation type (e.g., nsubj, dobj, root)'),
        governorIndex: z.number().describe('Index of the governor/head token (-1 for root)'),
