...
export let extractRelationshipsTool = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    relationships: z.array(z.object({
      ...
      arg2: z.string().optional().describe('The second entity/argument in the relationship'),
      arg3: z.string().optional().describe('Optional third argument'),
      adjuncts: z.array(z.string()).optional().describe('Additional modifiers or context'),
