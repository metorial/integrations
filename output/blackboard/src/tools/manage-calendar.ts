...
export let listCalendarItems = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    type: z.string().optional().describe('Filter by calendar type (e.g., "Course", "Personal", "Institution")'),
...
export let createCalendarItem = SlateTool.create(
  spec,
  {
