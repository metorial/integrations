...
export let getPlaylist = SlateTool.create(
  spec,
  {
    name: 'Get Playlist',
    key: 'get_playlist',
...
export let createPlaylist = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    sharing: z.enum(['public', 'private']).optional().describe('Sharing setting (default: public)'),
    trackIds: z.array(z.string()).optional().describe('Track IDs or URNs to include in the playlist'),
...
export let updatePlaylist = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    trackIds: z.array(z.string()).optional().describe('Complete list of track IDs/URNs (replaces existing tracks)'),
    isAlbum: z.boolean().optional().describe('Whether to mark as an album')
  }))
  .output(z.object({
...
export let deletePlaylist = SlateTool.create(
  spec,
  {
