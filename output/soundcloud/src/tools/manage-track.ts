...
export let updateTrack = SlateTool.create(
  spec,
  {
    name: 'Update Track',
    key: 'update_track',
  ...
  .input(z.object({
    ...
    license: z.string().optional().describe('License type (e.g., "cc-by", "cc-by-nc", "all-rights-reserved")')
  }))
  .output(z.object({
...
export let deleteTrack = SlateTool.create(
  spec,
  {
    name: 'Delete Track',
    key: 'delete_track',
...
export let uploadTrack = SlateTool.create(
  spec,
  {
    name: 'Upload Track',
    key: 'upload_track',
  ...
  .input(z.object({
    ...
    assetFilename: z.string().describe('Filename including extension (e.g., "my-track.mp3")'),
