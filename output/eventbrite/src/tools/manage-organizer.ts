...
export let manageOrganizer = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    organizationId: z.string().optional().describe('The organization ID (required for create). Falls back to configured value.'),
