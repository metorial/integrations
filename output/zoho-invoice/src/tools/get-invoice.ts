...
export let getInvoice = SlateTool.create(
  ...
  .output(z.object({
    ...
    status: z.string().optional().describe('Current status of the invoice (e.g. draft, sent, paid, overdue)'),
    ...
    currencyCode: z.string().optional().describe('Currency code of the invoice (e.g. USD, EUR)'),
