...
Supports pagination via **page** and **perPage** parameters.`,
  ...
  .input(z.object({
    status: z.enum(['unbilled', 'invoiced', 'reimbursed']).optional().describe('Filter expenses by status'),
    ...
    sortColumn: z.string().optional().describe('Column to sort results by (e.g. date, amount, total, customer_name)'),
