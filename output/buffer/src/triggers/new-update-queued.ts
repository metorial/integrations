...
export let newUpdateQueuedTrigger = SlateTrigger.create(
  spec,
  {
    name: 'New Update Queued',
    key: 'new_update_queued',
    description: 'Triggers when a new update is added to the posting queue on any connected social media profile. Polls for newly queued updates across all profiles.'
  }
)
  .input(z.object({
