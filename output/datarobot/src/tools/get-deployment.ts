...
export let getDeployment = SlateTool.create(
  spec,
  {
    name: 'Get Deployment',
    key: 'get_deployment',
  ...
  .output(z.object({
    ...
    serviceHealth: z.record(z.string(), z.any()).optional().nullable().describe('Service health details'),
    modelHealth: z.record(z.string(), z.any()).optional().nullable().describe('Model health details'),
    accuracyHealth: z.record(z.string(), z.any()).optional().nullable().describe('Accuracy health details'),
    defaultPredictionServerId: z.string().optional().describe('Default prediction server ID'),
