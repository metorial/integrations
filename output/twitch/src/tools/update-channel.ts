...
export let updateChannel = SlateTool.create(
  ...
  .input(z.object({
    ...
    language: z.string().optional().describe('Stream language as an ISO 639-1 code (e.g. "en")'),
    ...
    isBrandedContent: z.boolean().optional().describe('Whether the channel has branded content'),
  }))
  .output(z.object({
