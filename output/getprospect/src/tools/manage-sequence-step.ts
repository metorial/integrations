...
export let createSequenceStep = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    delayDays: z.number().optional().describe('Number of days to wait before sending this step'),
  }))
  .output(z.object({
...
export let updateSequenceStep = SlateTool.create(
  spec,
  {
...
export let deleteSequenceStep = SlateTool.create(
  spec,
  {
