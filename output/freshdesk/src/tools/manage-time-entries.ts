...
export let createTimeEntry = SlateTool.create(
  ...
  .input(z.object({
    ...
    timeSpent: z.string().describe('Time spent in HH:MM format (e.g., "01:30" for 1 hour 30 minutes)'),
    agentId: z.number().optional().describe('ID of the agent who performed the work. Defaults to the authenticated agent.'),
    billable: z.boolean().optional().describe('Whether the time is billable. Defaults to true.'),
