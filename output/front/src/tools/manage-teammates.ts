...
export let listTeammates = SlateTool.create(
  spec,
  {
    name: 'List Teammates',
    key: 'list_teammates',
...
export let getTeammate = SlateTool.create(
  spec,
  {
    name: 'Get Teammate',
    key: 'get_teammate',
  ...
  .input(z.object({
    teammateId: z.string().describe('Teammate ID or email alias (alt:email:user@example.com)'),
  }))
...
export let updateTeammate = SlateTool.create(
  spec,
  {
