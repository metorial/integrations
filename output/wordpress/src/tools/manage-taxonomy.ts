...
export let createCategoryTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    parentId: z.string().optional().describe('Parent category ID for creating a subcategory'),
...
export let deleteCategoryTool = SlateTool.create(
  spec,
  {
