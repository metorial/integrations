...
export let manageTeam = SlateTool.create(
  ...
  .input(z.object({
    ...
    identifierType: z.enum(['id', 'name']).optional().describe('Type of team identifier for delete. Defaults to "id"'),
    ...
    members: z.array(memberSchema).optional().describe('Team members. For update, this replaces the entire members list.'),
  }))
  .output(z.object({
