...
let logLineSchema = z.object({
  ...
  timestamp: z.number().optional().describe('Unix timestamp in milliseconds. Defaults to current time if omitted'),
  ...
  meta: z.record(z.string(), z.any()).optional().describe('Custom metadata key-value pairs associated with this log line'),
