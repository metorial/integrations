...
import { Client, flattenResource, flattenResources, type JsonApiResource } from '../lib/client';
import { spec } from '../spec';
import { z } from 'zod';

export let listActionItems = SlateTool.create(
  spec,
  {
...
export let createActionItem = SlateTool.create(
  spec,
  {
...
export let updateActionItem = SlateTool.create(
  spec,
  {
