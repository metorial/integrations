...
export let createStarterQuestion = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    starterQuestionId: z.string().describe('Unique identifier of the created starter question'),
...
export let updateStarterQuestion = SlateTool.create(
  spec,
  {
...
export let listStarterQuestions = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    searchQuery: z.string().optional().describe('Search for starter questions matching this query'),
  ...
  .output(z.object({
    starterQuestions: z.array(z.object({
...
export let deleteStarterQuestion = SlateTool.create(
  spec,
  {
