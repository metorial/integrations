...
export let createEvaluationTask = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    taskType: z.string().describe('Type of evaluation task (e.g., imageannotation, textcollection)'),
    project: z.string().describe('Project name'),
    expectedResponse: z.any().describe('The known-correct response for evaluating annotator quality'),
    initialResponse: z.any().optional().describe('Initial response for review-phase evaluations'),
    taskParams: z.record(z.string(), z.any()).optional().describe('Type-specific task parameters (e.g., attachment, geometries, fields)'),
  }))
  .output(z.object({
