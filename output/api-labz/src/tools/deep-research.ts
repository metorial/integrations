...
Useful for market research, competitive analysis, topic exploration, and generating in-depth knowledge reports.`,
  ...
  .input(z.object({
    query: z.string().describe('The research topic or question to investigate, e.g. "Current trends in renewable energy adoption in Southeast Asia"'),
  }))
  .output(z.object({
    researchResults: z.any().describe('Comprehensive research results including insights, analysis, and citations'),
  }))
