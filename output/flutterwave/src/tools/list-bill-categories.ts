...
export let listBillCategories = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    country: z.string().optional().describe('Filter billers by country code (e.g. NG, GH, KE)'),
  }))
  .output(z.object({
    categories: z.array(z.any()).optional().describe('Bill categories with biller codes and item codes'),
