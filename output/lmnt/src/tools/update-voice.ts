...
export let updateVoice = SlateTool.create(
  spec,
  {
    name: 'Update Voice',
    key: 'update_voice',
  ...
  .input(z.object({
    ...
    gender: z.string().optional().describe('Gender tag (e.g. male, female, nonbinary). Descriptive only.'),
    starred: z.boolean().optional().describe('If true, adds this voice to your starred list.'),
    unfreeze: z.boolean().optional().describe('If true, unfreezes a frozen professional voice and upgrades it to the latest model.'),
  }))
  .output(z.object({
