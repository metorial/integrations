...
export let listMeetings = SlateTool.create(
  ...
  .input(z.object({
    start: z.string().describe('Start of the time range (ISO 8601 date string, e.g. "2024-01-01T00:00:00Z")'),
    end: z.string().describe('End of the time range (ISO 8601 date string, e.g. "2024-01-31T23:59:59Z")')
  }))
  .output(z.object({
