...
let COMPANY_EVENTS = ['company.created', 'company.updated', 'company.deleted', 'company.status_changed'] as const;
...
export let companyEvents = SlateTrigger.create(
  spec,
  {
    name: 'Company Events',
    key: 'company_events',
    description: 'Triggers when a company is created, updated, deleted, or has its status changed.',
  }
)
  .input(z.object({
