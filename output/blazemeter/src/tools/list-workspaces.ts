...
export let listWorkspaces = SlateTool.create(
  ...
  .input(z.object({
    accountId: z.number().optional().describe('Specific account ID to list workspaces for. If omitted, lists all accounts first.'),
  }))
  .output(z.object({
    accounts: z.array(z.object({
      ...
      })).optional().describe('Workspaces within this account'),
