...
let customerSchema = z.object({
  ...
  socialNetwork: z.string().describe('Social network used for registration (e.g. Facebook, Instagram)'),
...
export let listCustomers = SlateTool.create(
  ...
  .input(z.object({
    locationId: z.string().optional().describe('Filter customers by a specific location ID. Omit to retrieve across all locations.'),
