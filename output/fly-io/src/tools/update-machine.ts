...
export let updateMachine = SlateTool.create(
  spec,
  {
    name: 'Update Machine',
    key: 'update_machine',
    ...
    constraints: [
      'Region and name cannot be changed after creation.',
    ],
  }
)
  .input(z.object({
    ...
    leaseNonce: z.string().optional().describe('Lease nonce if the machine has an active lease'),
    ...
    }).optional().describe('Resource configuration'),
