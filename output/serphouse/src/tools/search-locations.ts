...
export let searchLocations = SlateTool.create(
  ...
  .input(z.object({
    ...
    searchEngine: z.enum(['google', 'bing']).default('google').describe('Search engine to get locations for'),
  }))
  .output(z.object({
    ...
    locations: z.array(z.object({
      ...
      locationType: z.string().optional().describe('Location type (City, State, Country, etc.)'),
