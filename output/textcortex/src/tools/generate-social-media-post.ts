...
export let generateSocialMediaPost = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    platform: z.enum(['twitter', 'linkedin', 'instagram', 'facebook']).optional().describe('Target social media platform (default: "twitter")'),
    ...
    generationCount: z.number().min(1).max(10).optional().describe('Number of post variations to generate (default: 1)'),
