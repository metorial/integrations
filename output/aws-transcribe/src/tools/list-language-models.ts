...
export let listLanguageModels = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    statusEquals: z.enum(['IN_PROGRESS', 'FAILED', 'COMPLETED']).optional().describe('Filter by model training status'),
    nameContains: z.string().optional().describe('Filter models whose name contains this string'),
