...
export let createEndpoint = SlateTool.create(
  ...
  .input(z.object({
    ...
    filterTypes: z.array(z.string()).optional().describe('Event types to subscribe to (empty = all events)'),
    channels: z.array(z.string()).optional().describe('Channels the endpoint subscribes to'),
    secret: z.string().optional().describe('Signing secret for the endpoint (auto-generated if not set)'),
...
export let updateEndpoint = SlateTool.create(
  ...
  .input(z.object({
    ...
    filterTypes: z.array(z.string()).optional().describe('Updated event types to subscribe to'),
