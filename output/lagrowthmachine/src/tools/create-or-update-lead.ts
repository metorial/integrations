...
export let createOrUpdateLead = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    audience: z.string().describe('Name of the LGM audience to add the lead to. Must already exist in La Growth Machine.'),
