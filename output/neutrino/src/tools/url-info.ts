...
export let urlInfoTool = SlateTool.create(
  spec,
  {
    name: 'URL Info',
    key: 'url_info',
  ...
  .input(z.object({
    ...
    fetchContent: z.boolean().optional().describe('Fetch and return the actual page content'),
    ignoreCertificateErrors: z.boolean().optional().describe('Bypass TLS/SSL certificate validation'),
