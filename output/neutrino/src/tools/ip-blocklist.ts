...
export let ipBlocklistTool = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    blocklists: z.array(z.string()).describe('Blocklist categories: tor, proxy, vpn, bot, spam-bot, exploit-bot, hijacked, malware, spyware, spider, dshield'),
