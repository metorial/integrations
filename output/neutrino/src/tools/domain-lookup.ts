...
export let domainLookupTool = SlateTool.create(
  spec,
  {
    name: 'Domain Lookup',
    key: 'domain_lookup',
  ...
  .input(z.object({
    ...
    live: z.boolean().optional().describe('Enable real-time reconnaissance for previously unseen domains (may increase latency)')
  }))
  .output(z.object({
