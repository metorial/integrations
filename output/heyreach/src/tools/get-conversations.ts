...
export let getConversations = SlateTool.create(
  ...
  .input(z.object({
    limit: z.number().optional().default(50).describe('Number of conversations to return (default: 50)'),
    offset: z.number().optional().default(0).describe('Pagination offset (default: 0)'),
    filters: z.record(z.string(), z.unknown()).optional().describe('Advanced filter options for querying conversations'),
  }))
  .output(z.object({
