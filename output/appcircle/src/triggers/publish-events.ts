...
export let publishEvents = SlateTrigger.create(
  spec,
  {
    name: 'Publish Events',
    key: 'publish_events',
    description: 'Triggers on store publishing lifecycle events including status changes, flow started, succeeded, failed, canceled, and version deployed or rejected.',
  }
)
  .input(z.object({
