...
export let getVoiceTool = SlateTool.create(
  spec,
  {
    name: 'Get Voice',
    key: 'get_voice',
  ...
  .output(z.object({
    ...
    }).optional().describe('Fine-tuning status and state'),
    createdAtUnix: z.number().optional().describe('Unix timestamp of when the voice was created'),
  }))
