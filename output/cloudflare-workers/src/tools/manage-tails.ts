...
export let createTail = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    expiresAt: z.string().optional().describe('ISO 8601 expiration timestamp for the tail session'),
  }))
...
export let listTails = SlateTool.create(
  spec,
  {
...
export let deleteTail = SlateTool.create(
  spec,
  {
