...
export let getSchedules = SlateTool.create(
  spec,
  {
...
export let updateSchedules = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    schedules: z.array(z.object({
      cron: z.string().describe('Cron expression in UTC (e.g. "*/30 * * * *" for every 30 minutes)'),
