...
export let createUserTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    externalId: z.string().optional().describe('External identifier for the user in your system'),
    companyId: z.string().optional().describe('ID of the company to associate this user with'),
  }))
  .output(z.object({
