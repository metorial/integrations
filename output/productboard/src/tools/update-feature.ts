...
export let updateFeatureTool = SlateTool.create(
  spec,
  {
    name: 'Update Feature',
    key: 'update_feature',
  ...
  .input(z.object({
    ...
    parentFeatureId: z.string().optional().describe('ID of the parent feature to move under'),
    parentComponentId: z.string().optional().describe('ID of the parent component to move under'),
    parentProductId: z.string().optional().describe('ID of the parent product to move under'),
