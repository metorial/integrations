...
export let addExhibitor = SlateTool.create(
  spec,
  {
    name: 'Add Exhibitor',
    key: 'add_exhibitor',
  ...
  .input(z.object({
    ...
    featured: z.boolean().optional().describe('Whether exhibitor is featured (shown at top of listings)'),
    ...
    externalId: z.string().optional().describe('External ID for integration with other systems'),
    categories: z.array(z.number()).optional().describe('Category IDs to assign'),
    tags: z.array(z.string()).optional().describe('Tags to assign'),
    metadata: z.record(z.string(), z.string()).optional().describe('Custom key-value metadata (max 50 char keys, 256 char values)'),
