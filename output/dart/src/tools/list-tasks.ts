...
export let listTasks = SlateTool.create(
  ...
  .input(z.object({
    ...
    createdAtAfter: z.string().optional().describe('Tasks created after this date (ISO 8601)'),
    createdAtBefore: z.string().optional().describe('Tasks created before this date (ISO 8601)'),
    updatedAtAfter: z.string().optional().describe('Tasks updated after this date (ISO 8601)'),
    updatedAtBefore: z.string().optional().describe('Tasks updated before this date (ISO 8601)'),
    ...
    ordering: z.array(z.string()).optional().describe('Ordering fields (e.g., ["-created_at", "title"])'),
