...
export let getPlaceDetails = SlateTool.create(
  ...
  .input(z.object({
    ...
    fields: z.string().optional().describe('Comma-separated list of fields to include (e.g. "name,location,hours,rating,photos")'),
  }))
  .output(z.object({
    ...
    hoursPopular: z.array(z.object({
      close: z.string().optional(),
      day: z.number().optional(),
      open: z.string().optional(),
    })).optional().describe('Popular hours'),
    ...
    features: z.record(z.string(), z.any()).optional().describe('Place features (e.g. outdoor seating)'),
  }))
