...
Can automatically generate release notes from commits since the last release.`,
  ...
  .input(z.object({
    ...
    targetCommitish: z.string().optional().describe('Branch or commit SHA for the tag (defaults to default branch)'),
    ...
    generateReleaseNotes: z.boolean().optional().describe('Auto-generate release notes from commits'),
  }))
  .output(z.object({
