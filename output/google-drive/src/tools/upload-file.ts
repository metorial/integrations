...
export let uploadFileTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    contentEncoding: z.enum(['text', 'base64']).default('text').describe('How the content is encoded'),
    mimeType: z.string().optional().describe('MIME type of the file (e.g. "text/plain", "application/pdf")'),
    parentFolderIds: z.array(z.string()).optional().describe('Parent folder IDs to upload into'),
