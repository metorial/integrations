...
export let getMarketPairs = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    cryptocurrencyId: z.string().optional().describe('CoinMarketCap ID of the cryptocurrency'),
    ...
    matchedSymbol: z.string().optional().describe('Filter to pairs with this quote currency (e.g., "USDT", "USD")'),
    category: z.enum(['all', 'spot', 'derivatives', 'otc', 'perpetual']).optional().describe('Market category filter. Default: all'),
