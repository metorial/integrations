...
export let updateStringVariable = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    value: z.string().nullable().optional().describe('New text value to set. Pass null or omit to clear the variable.'),
  }))
  .output(z.object({
