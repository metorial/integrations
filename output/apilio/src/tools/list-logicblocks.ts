...
export let listLogicblocks = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    logicblocks: z.array(z.object({
      ...
      result: z.boolean().nullable().describe('Last evaluation result, or null if never evaluated'),
