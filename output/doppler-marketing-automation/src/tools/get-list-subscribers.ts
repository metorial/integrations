...
export let getListSubscribers = SlateTool.create(
  spec,
  {
...
Returns subscriber emails, custom fields, status, and engagement scores.`,
  ...
  .input(z.object({
    ...
    from: z.string().optional().describe('Filter subscribers added from this date (ISO 8601 with timezone, e.g. 2024-01-01T00:00:00+00:00)'),
    to: z.string().optional().describe('Filter subscribers added up to this date (ISO 8601 with timezone)'),
  }))
  .output(z.object({
