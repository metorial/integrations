...
export let getSubscriber = SlateTool.create(
  ...
  .output(z.object({
    ...
    unsubscriptionDate: z.string().optional().describe('Date the subscriber unsubscribed, if applicable'),
    unsubscriptionType: z.string().optional().describe('Reason for unsubscription, if applicable'),
  }))
