...
let intentSchema = z.object({
  ...
  })).optional().describe('Entities associated with the intent'),
});

export let listIntents = SlateTool.create(
  spec,
  {
    name: 'List Intents',
    key: 'list_intents',
...
export let getIntent = SlateTool.create(
  spec,
  {
    name: 'Get Intent',
    key: 'get_intent',
...
export let createIntent = SlateTool.create(
  spec,
  {
    name: 'Create Intent',
    key: 'create_intent',
...
export let deleteIntent = SlateTool.create(
  spec,
  {
    name: 'Delete Intent',
    key: 'delete_intent',
