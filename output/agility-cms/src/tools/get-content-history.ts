...
export let getContentHistory = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    includeComments: z.boolean().default(false).describe('Also fetch comments associated with the content item'),
  ...
  .output(z.object({
    ...
    comments: z.array(z.any()).optional().describe('Array of comments if includeComments was true'),
  }))
