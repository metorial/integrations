...
export let inviteMember = SlateTool.create(
  spec,
  {
    name: 'Invite Member',
    key: 'invite_member',
  ...
  .input(z.object({
    ...
    type: z.number().default(2).describe('Role to assign: 0=Owner, 1=Admin, 2=User, 3=Manager'),
    accessAll: z.boolean().default(false).describe('Whether to grant access to all collections'),
    ...
    })).optional().describe('Specific collections to assign access to'),
  }))
  .output(z.object({
