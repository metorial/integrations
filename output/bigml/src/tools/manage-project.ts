...
export let manageProject = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Deleting a project also deletes all resources within it.'
    ],
    tags: {
      destructive: false,
      readOnly: false
  ...
  .input(z.object({
    projectId: z.string().optional().describe('Existing project ID to update. If omitted, creates a new project.'),
