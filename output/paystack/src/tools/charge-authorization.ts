...
export let chargeAuthorization = SlateTool.create(
  spec,
  {
...
Amounts are in the **smallest currency unit**.`,
  ...
  .input(z.object({
    ...
    authorizationCode: z.string().describe('Authorization code from a previous transaction (e.g., AUTH_xxx)'),
    currency: z.string().optional().describe('Currency code'),
    reference: z.string().optional().describe('Unique reference. Auto-generated if not provided'),
