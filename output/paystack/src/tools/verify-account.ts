...
export let listBanks = SlateTool.create(
  spec,
  {
    name: 'List Banks',
    key: 'list_banks',
  ...
  .input(z.object({
    country: z.string().optional().describe('Country code (e.g., nigeria, ghana, south-africa, kenya)'),
    currency: z.string().optional().describe('Filter by currency (e.g., NGN, GHS, ZAR, KES)'),
    type: z.string().optional().describe('Filter by bank type (e.g., nuban, mobile_money, ghipss)'),
...
export let resolveCardBin = SlateTool.create(
  spec,
  {
