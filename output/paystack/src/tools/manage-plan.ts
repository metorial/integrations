...
Amounts are in the **smallest currency unit** (e.g., kobo for NGN).`,
  ...
  .input(z.object({
    ...
    interval: z.enum(['hourly', 'daily', 'weekly', 'monthly', 'quarterly', 'biannually', 'annually']).describe('Billing interval'),
    description: z.string().optional().describe('Plan description'),
    currency: z.string().optional().describe('Currency code (default NGN)'),
    invoiceLimit: z.number().optional().describe('Number of times to charge. Leave empty for infinite'),
...
export let updatePlan = SlateTool.create(
  spec,
  {
    name: 'Update Plan',
    key: 'update_plan',
  ...
  .input(z.object({
    ...
    interval: z.enum(['hourly', 'daily', 'weekly', 'monthly', 'quarterly', 'biannually', 'annually']).optional().describe('Updated billing interval'),
