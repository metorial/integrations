...
export let staticImageTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    styleId: z.string().describe('Map style ID (e.g., "streets-v12", "dark-v11", or a custom style ID)'),
    ...
    styleOwner: z.string().optional().describe('Style owner username (default: your username, use "mapbox" for built-in styles)'),
    ...
    padding: z.string().optional().describe('Padding around the viewport as "top,right,bottom,left"'),
  }))
  .output(z.object({
