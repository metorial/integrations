...
export let manageCustomerGroups = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    addGroupIds: z.array(z.string()).optional().describe('Customer group IDs to add the customer to'),
    removeGroupIds: z.array(z.string()).optional().describe('Customer group IDs to remove the customer from'),
  }))
  .output(z.object({
