...
export let webSearch = SlateTool.create(
  ...
  .input(z.object({
    ...
    aiOverview: z.boolean().optional().describe('Include an AI-generated overview of the results (default: true)'),
    safeSearch: z.enum(['moderate', 'strict', 'off']).optional().describe('Safe search level (default: "moderate")'),
    spellCheck: z.boolean().optional().describe('Auto-correct spelling in query (default: true)'),
    countryCode: z.string().optional().describe('Country code to localize results'),
    autoScrape: z.boolean().optional().describe('Automatically scrape result pages for content (default: true)'),
  ...
  .output(z.object({
    ...
    spellFixed: z.boolean().optional().describe('Whether the query spelling was auto-corrected'),
