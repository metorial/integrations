...
export let createImagesFromPdf = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    imageFormat: z.enum(['png', 'jpg', 'tiff', 'bmp']).default('png').describe('Output image format'),
    pageNumbers: z.string().describe('Comma-separated page numbers to convert (e.g. "1,2,3")'),
