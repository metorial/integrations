...
export let compressPdf = SlateTool.create(
  spec,
  {
    name: 'Compress PDF',
    key: 'compress_pdf',
  ...
  .input(z.object({
    ...
    profile: z.enum(['Default', 'Web', 'WebMax', 'Print', 'PrintMax', 'PrintGray', 'Max', 'Compress', 'CompressMax'])
      .default('Default')
      .describe('Compression profile: "Web"/"WebMax" for web display, "Print"/"PrintMax"/"PrintGray" for printing, "Max"/"CompressMax" for maximum compression'),
  }))
  .output(z.object({
