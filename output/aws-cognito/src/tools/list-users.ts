...
export let listUsers = SlateTool.create(
  ...
  .input(z.object({
    ...
    filter: z.string().optional().describe('Filter expression (e.g., "email ^= \\"test\\"")'),
    limit: z.number().min(1).max(60).optional().describe('Maximum number of users to return (1-60)'),
