...
export let listOrgUsers = SlateTool.create(
  spec,
  {
...
export let addOrgUser = SlateTool.create(
  spec,
  {
...
export let updateOrgUserRole = SlateTool.create(
  spec,
  {
...
export let removeOrgUser = SlateTool.create(
  spec,
  {
