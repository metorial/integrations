...
export let searchDashboards = SlateTool.create(
  ...
  .input(z.object({
    query: z.string().optional().describe('Search query string to filter dashboards by title'),
  ...
  .output(z.object({
    dashboards: z.array(z.object({
      ...
      folderUid: z.string().optional().describe('UID of the folder containing the dashboard'),
      folderTitle: z.string().optional().describe('Title of the folder containing the dashboard'),
    })),
