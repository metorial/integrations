...
export let listAllBookmarks = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    results: z.number().optional().describe('Number of results to return (default: 1000, max: 100000)'),
    fromDate: z.string().optional().describe('Return only bookmarks created after this ISO 8601 datetime'),
    toDate: z.string().optional().describe('Return only bookmarks created before this ISO 8601 datetime'),
  }))
  .output(z.object({
