...
Use without a **creditNoteId** to create, or with one to update. Use **applyToInvoices** to apply credits.`,
  ...
  .input(z.object({
    creditNoteId: z.string().optional().describe('Credit note ID to update or apply. Omit to create.'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.creditnoteNumber !== undefined) body.creditnote_number = ctx.input.creditnoteNumber;
