...
export let createJob = SlateTool.create(
  ...
  .input(z.object({
    status: z.enum(['Quote', 'Work Order', 'Completed', 'Unsuccessful']).optional().describe('Job status'),
    ...
    companyUuid: z.string().optional().describe('UUID of the client/company to associate with this job'),
