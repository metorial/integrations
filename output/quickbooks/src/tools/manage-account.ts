...
let accountOutputSchema = z.object({
  ...
  classification: z.string().optional().describe('Account classification (Asset, Liability, Equity, Revenue, Expense)'),
...
export let createAccount = SlateTool.create(
  ...
  .input(z.object({
    ...
    accountSubType: z.string().optional().describe('Account sub-type (e.g., Checking, Savings, etc.)'),
    accountNumber: z.string().optional().describe('Account number'),
    description: z.string().optional().describe('Account description'),
    parentAccountId: z.string().optional().describe('Parent account ID for sub-account hierarchy'),
  }))
