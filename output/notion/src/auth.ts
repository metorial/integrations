...
export let auth = SlateAuth.create()
  ...
  .addOauth({
    ...
    handleCallback: async (ctx) => {
      ...
      let response = await axios.post('https://api.notion.com/v1/oauth/token', {
  ...
  .addTokenAuth({
    ...
    inputSchema: z.object({
      token: z.string().describe('Internal Integration Token from your Notion integration settings'),
    }),
