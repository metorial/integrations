...
export let deactivateMember = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    reactivate: z.boolean().optional().describe('If true, reactivates a previously deactivated user instead of deactivating'),
  }))
  .output(z.object({
