...
export let createMember = SlateTool.create(
  ...
  .input(z.object({
    ...
    profilePicture: z.string().optional().describe('Profile picture as a data URI (JPG, GIF, or PNG)'),
    ...
    createIntroductionThread: z.boolean().optional().describe('If true and bio is provided, creates an introduction thread for the user'),
  }))
  .output(z.object({
