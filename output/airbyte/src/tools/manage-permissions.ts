...
export let listPermissionsTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    organizationId: z.string().optional().describe('Organization UUID. Required to view another user\'s permissions (must be org admin or higher).'),
  }))
  .output(z.object({
...
export let createPermissionTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    workspaceId: z.string().optional().describe('UUID of the workspace (for workspace-scoped permissions).'),
    organizationId: z.string().optional().describe('UUID of the organization (for organization-scoped permissions).'),
  }))
  .output(z.object({
    permissionId: z.string(),
    permissionType: z.string(),
...
export let deletePermissionTool = SlateTool.create(
  spec,
  {
