...
export let createPerson = SlateTool.create(
  ...
  .input(z.object({
    ...
    fields: z.record(z.string(), z.any()).optional().describe('Custom profile field values as a map of field ID to value. Use List Profile Fields to discover available field IDs.'),
  }))
  .output(z.object({
