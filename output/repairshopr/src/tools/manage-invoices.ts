...
export let searchInvoices = SlateTool.create(
  ...
  .input(z.object({
    ...
    createdBefore: z.string().optional().describe('Filter invoices created before this date (YYYY-MM-DD)'),
    createdAfter: z.string().optional().describe('Filter invoices created after this date (YYYY-MM-DD)'),
