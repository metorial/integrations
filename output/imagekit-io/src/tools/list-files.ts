...
export let listFiles = SlateTool.create(
  ...
  .input(z.object({
    searchQuery: z.string().optional().describe('Advanced search query using Lucene-like syntax, e.g. \'name : "product"\' or \'createdAt > "7d"\''),
    ...
    sort: z.string().optional().describe('Sort field and direction, e.g. "ASC_CREATED" or "DESC_SIZE"'),
