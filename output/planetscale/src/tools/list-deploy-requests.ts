...
export let listDeployRequests = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    state: z.string().optional().describe('Filter by deploy request state (e.g. open, closed, deployed)'),
    page: z.number().optional().describe('Page number for pagination'),
    perPage: z.number().optional().describe('Number of results per page'),
  }))
  .output(z.object({
    deployRequests: z.array(z.object({
