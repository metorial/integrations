...
export let sendPayout = SlateTool.create(
  spec,
  {
    ...
    constraints: [
      'Maximum 15,000 items per batch in production.',
    ],
    tags: {
      destructive: false,
      readOnly: false,
  ...
  .input(z.object({
    ...
    recipients: z.array(z.object({
      ...
      recipientType: z.enum(['EMAIL', 'PHONE', 'PAYPAL_ID']).optional().describe('Type of receiver identifier. Defaults to EMAIL.'),
    ...
    })).min(1).describe('List of payout recipients'),
  }))
  .output(z.object({
