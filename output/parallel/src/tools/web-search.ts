  ...
  .input(
    z.object({
      objective: z
        .string()
        .optional()
        .describe('Natural language description of what to find. May include guidance about preferred sources or freshness.'),
      searchQueries: z
        .array(z.string())
        .optional()
      ...
      mode: z
        ...
        .optional()
        .describe('Search mode: one-shot (comprehensive), agentic (concise for AI loops), fast (lower latency)'),
      maxResults: z
        .number()
        .optional()
      ...
      excerpts: z
        .object({
          maxCharsPerResult: z.number().optional().describe('Maximum characters per result excerpt (min 1000)'),
          maxCharsTotal: z.number().optional().describe('Maximum total characters across all excerpts (min 1000)'),
        })
        .optional()
      ...
      sourcePolicy: z
        .object({
          ...
          afterDate: z.string().optional().describe('Only include results published after this date (YYYY-MM-DD)'),
        })
        .optional()
