...
export let searchPlaces = SlateTool.create(
  ...
  .input(z.object({
    categories: z.string().describe('Comma-separated place categories (e.g. "catering.restaurant,catering.cafe")'),
    filter: z.string().optional().describe('Hard geographic boundary (e.g. "circle:-87.770,41.878,5000" or "rect:west,south,east,north")'),
    bias: z.string().optional().describe('Soft proximity preference (e.g. "proximity:-87.770,41.878")'),
    conditions: z.string().optional().describe('Attribute filters (e.g. "wheelchair", "internet_access", "vegetarian")'),
