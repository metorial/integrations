...
export let listUsers = SlateTool.create(
  ...
  .input(z.object({
    role: z.enum(['teacher', 'student', 'admin']).optional().describe('Filter users by role.'),
    spaceUuid: z.string().optional().describe('Filter users who attended sessions in this space.'),
