...
export let createDeal = SlateTool.create(
  ...
  .input(z.object({
    ...
    clientEmail: z.string().optional().describe('Email of the client associated with this deal'),
    pipelineStage: z.string().optional().describe('Pipeline stage for the deal (e.g., "lead", "proposal", "negotiation", "won", "lost")'),
