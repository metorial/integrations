    ...
    handleRequest: async (ctx) => {
      ...
      return {
        inputs: [{
          ...
          invoiceNumber: invoice.invoice_number ?? invoice.invoiceNumber ?? invoice.number ?? undefined,
          clientName: invoice.client_name ?? invoice.clientName ?? data.client_name ?? undefined,
          clientEmail: invoice.client_email ?? invoice.clientEmail ?? data.client_email ?? undefined,
