...
export let eventScheduled = SlateTrigger.create(
  spec,
  {
    ...
    handleRequest: async (ctx) => {
      ...
      return {
        inputs: [{
          ...
          attendeeName: event.attendee_name ?? event.attendeeName ?? event.invitee_name ?? undefined,
          attendeeEmail: event.attendee_email ?? event.attendeeEmail ?? event.invitee_email ?? undefined,
