...
export let getDomainReport = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    lastUpdateDate: z.string().optional().describe('Domain last update date (Unix timestamp)'),
    lastDnsRecords: z.array(z.object({
      type: z.string().optional(),
      value: z.string().optional(),
      ttl: z.number().optional()
    })).optional().describe('Latest DNS records'),
    totalVotes: z.object({
    ...
    categories: z.record(z.string(), z.string()).optional().describe('Domain categories from different engines'),
    whois: z.string().optional().describe('Raw WHOIS data'),
    tags: z.array(z.string()).optional().describe('Tags assigned to the domain'),
    popularityRanks: z.record(z.string(), z.object({
      rank: z.number().optional(),
      timestamp: z.number().optional()
    })).optional().describe('Popularity rankings from different providers')
  }))
