...
export let createTimeEntry = SlateTool.create(
  ...
  .input(z.object({
    ...
    duration: z.string().describe('Duration in HH:MM format (e.g. "02:30" for 2 hours 30 minutes).'),
    ...
    billable: z.boolean().optional().describe('Whether this time entry is billable. Defaults to project setting.'),
  }))
  .output(z.object({
