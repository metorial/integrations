...
export let listPaymentsReceived = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    search: z.string().optional().describe('Free-text search across title, contact name, and date.'),
    contactId: z.string().optional().describe('Filter by contact ID.'),
    transactionType: z.string().optional().describe('Filter by type: "dp" (client payment), "icm" (income).'),
    ordering: z.string().optional().describe('Sort field: date, amount, modified, created. Prefix with "-" for descending.'),
    ...
    modifiedAfter: z.string().optional().describe('Only return records modified after this date.'),
