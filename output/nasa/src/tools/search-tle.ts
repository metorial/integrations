...
export let searchTle = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    search: z.string().optional().describe('Search term for satellite name (e.g., "ISS", "STARLINK")'),
    satelliteNumber: z.number().optional().describe('NORAD catalog number for direct lookup (e.g., 25544 for ISS)'),
