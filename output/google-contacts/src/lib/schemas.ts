...
export let birthdaySchema = z.object({
...
export let biographySchema = z.object({
...
export let nicknameSchema = z.object({
...
export let occupationSchema = z.object({
  value: z.string().describe('Occupation'),
}).describe('Occupation');

export let membershipSchema = z.object({
...
export let contactGroupSchema = z.object({
  ...
  groupType: z.string().optional().describe('GROUP_TYPE_UNSPECIFIED, USER_CONTACT_GROUP, or SYSTEM_CONTACT_GROUP'),
  memberCount: z.number().optional().describe('Number of members in the group'),
  memberResourceNames: z.array(z.string()).optional().describe('Resource names of group members'),
