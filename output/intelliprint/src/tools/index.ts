...
export { createMailingList, getMailingList, listMailingLists, updateMailingList, deleteMailingList } from './manage-mailing-lists';
export { addRecipient, getRecipient, listRecipients, updateRecipient, deleteRecipient } from './manage-recipients';
