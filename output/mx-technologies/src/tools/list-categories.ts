...
let categorySchema = z.object({
  ...
  parentGuid: z.string().optional().nullable().describe('Parent category GUID for subcategories'),
  isDefault: z.boolean().optional().nullable().describe('Whether this is an MX default category'),
  isIncome: z.boolean().optional().nullable().describe('Whether the category represents income'),
...
export let listCategories = SlateTool.create(
  ...
  .input(z.object({
    userGuid: z.string().optional().describe('MX GUID of the user. If omitted, returns default MX categories.'),
