...
export let listCustomers = SlateTool.create(
  ...
  .input(z.object({
    ...
    perPage: z.number().optional().describe('Number of customers per page (default: 20, max: 100)'),
    search: z.string().optional().describe('Filter by name or email'),
    sort: z.string().optional().describe('Sort field and direction (e.g., "name_asc", "created_at_desc")'),
  }))
  .output(z.object({
