...
export let executeTransaction = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    operations: z.array(z.object({
      ...
      recordId: z.string().optional().describe('Record ID (required for update, delete, get)'),
      record: z.record(z.string(), z.any()).optional().describe('Record data (for insert operations)'),
      fields: z.record(z.string(), z.any()).optional().describe('Fields to update (for update operations)'),
      columns: z.array(z.string()).optional().describe('Columns to return (for get operations)'),
