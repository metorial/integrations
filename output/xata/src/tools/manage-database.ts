...
export let createDatabase = SlateTool.create(
  ...
  .input(z.object({
    ...
    region: z.string().optional().describe('Region for the database (defaults to workspace region)'),
    branchName: z.string().optional().describe('Name for the initial branch (default: "main")'),
  }))
  .output(z.object({
