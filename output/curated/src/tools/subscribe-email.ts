...
export let subscribeEmail = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    sync: z.boolean().optional().describe('Set to true to bypass double opt-in (useful when syncing from another service)'),
  }))
  .output(z.object({
