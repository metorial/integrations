...
export let listVariableSetsTool = SlateTool.create(
  spec,
  {
...
export let createVariableSetTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    global: z.boolean().optional().describe('Whether to apply to all workspaces in the organization (default: false)'),
    workspaceIds: z.array(z.string()).optional().describe('Workspace IDs to apply this variable set to'),
    projectIds: z.array(z.string()).optional().describe('Project IDs to apply this variable set to')
  }))
...
export let deleteVariableSetTool = SlateTool.create(
  spec,
  {
