...
export let listUsers = SlateTool.create(
  ...
  .input(z.object({
    ...
    sort: z.enum(['CreatedOn', '-CreatedOn', 'LastUpdated', '-LastUpdated', 'Status', '-Status', 'Email', '-Email']).optional().describe('Sort order (prefix with - for descending)'),
  }))
  .output(z.object({
    users: z.array(z.object({
      ...
      accessGroups: z.array(z.any()).optional().describe('Access groups the user belongs to'),
