...
export let getTemplate = SlateTool.create(
  ...
  .output(z.object({
    ...
    bodyStructure: z.record(z.string(), z.unknown()).describe('Structure defining the fields, recipient roles, and configuration required to create a document from this template'),
  }))
