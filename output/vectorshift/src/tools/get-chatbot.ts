...
export let getChatbotTool = SlateTool.create(
  spec,
  {
    name: 'Get Chatbot',
    key: 'get_chatbot',
  ...
  .input(z.object({
    chatbotId: z.string().optional().describe('Chatbot ID. Required if name is not provided.'),
    name: z.string().optional().describe('Chatbot name. Required if chatbotId is not provided.'),
