...
export let getTransformationTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    transformationId: z.string().optional().describe('Transformation ID. Required if name is not provided.'),
    name: z.string().optional().describe('Transformation name. Required if transformationId is not provided.'),
