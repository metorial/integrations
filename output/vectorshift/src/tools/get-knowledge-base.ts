...
export let getKnowledgeBaseTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    knowledgeBaseId: z.string().optional().describe('Knowledge base ID. Required if name is not provided.'),
    name: z.string().optional().describe('Knowledge base name. Required if knowledgeBaseId is not provided.'),
