...
export let getPipelineTool = SlateTool.create(
  spec,
  {
    name: 'Get Pipeline',
    key: 'get_pipeline',
  ...
  .input(z.object({
    pipelineId: z.string().optional().describe('Pipeline ID. Required if name is not provided.'),
    name: z.string().optional().describe('Pipeline name. Required if pipelineId is not provided.'),
