...
export let updateStory = SlateTool.create(
  spec,
  {
    name: 'Update Story',
    key: 'update_story',
  ...
  .input(z.object({
    ...
    estimate: z.number().optional().nullable().describe('Story point estimate (null to unset)'),
    deadline: z.string().optional().nullable().describe('Deadline in ISO 8601 format (null to unset)'),
    labels: z.array(z.object({
      name: z.string().describe('Label name'),
    })).optional().describe('Labels to set on the story (replaces existing)'),
