...
export let listOrders = SlateTool.create(
  ...
  .input(z.object({
    ...
    createdAfter: z.string().optional().describe('Filter orders created at or after this ISO 8601 timestamp'),
    createdBefore: z.string().optional().describe('Filter orders created at or before this ISO 8601 timestamp'),
  }))
  .output(z.object({
