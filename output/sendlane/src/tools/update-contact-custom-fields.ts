...
export let updateContactCustomFields = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    customFields: z.record(z.string(), z.string()).describe('Custom field values as key-value pairs (field name → value)'),
  }))
  .output(z.object({
    success: z.boolean(),
