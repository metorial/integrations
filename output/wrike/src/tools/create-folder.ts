...
export let createFolder = SlateTool.create(
  ...
  .input(z.object({
    parentFolderId: z.string().describe('Parent folder ID to create the folder/project under'),
    ...
    }).optional().describe('Project configuration; if provided, creates a project instead of a folder')
  }))
  .output(z.object({
    folderId: z.string(),
    title: z.string(),
