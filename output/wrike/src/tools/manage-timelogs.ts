...
export let listTimelogs = SlateTool.create(
  spec,
  {
    name: 'List Timelogs',
    key: 'list_timelogs',
  ...
  .input(z.object({
    ...
    trackedDateStart: z.string().optional().describe('Filter by tracked date start (ISO 8601)'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    let trackedDate = (ctx.input.trackedDateStart || ctx.input.trackedDateEnd)
...
export let createTimelog = SlateTool.create(
  spec,
  {
    name: 'Create Timelog',
    key: 'create_timelog',
...
export let updateTimelog = SlateTool.create(
  spec,
  {
    name: 'Update Timelog',
    key: 'update_timelog',
...
export let deleteTimelog = SlateTool.create(
  spec,
  {
    name: 'Delete Timelog',
    key: 'delete_timelog',
