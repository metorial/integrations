...
export let getMetadata = SlateTool.create(
  spec,
  {
    name: 'Get Metadata',
    key: 'get_metadata',
  ...
  .input(z.object({}))
  .output(z.object({
    metadata: z.record(z.string(), z.unknown()).describe('The complete metadata schema including custom fields, meta attributes, and marketing audiences'),
  }))
