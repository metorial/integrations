...
export let subscribeMarketingAudience = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    contactIdentifiers: z.array(z.string()).describe('List of contact UIDs or emails to subscribe'),
    audienceIdentifier: z.string().describe('Identifier of the marketing audience to subscribe contacts to'),
  }))
  .output(z.object({
