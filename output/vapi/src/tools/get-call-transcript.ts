...
export let getCallTranscript = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    messages: z.array(z.object({
      role: z.string().optional().describe('Message role (user, assistant, system, tool_call, tool_result)'),
    ...
    })).optional().describe('Conversation messages with timestamps'),
