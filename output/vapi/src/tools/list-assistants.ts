...
export let listAssistants = SlateTool.create(
  ...
  .input(z.object({
    limit: z.number().optional().describe('Maximum number of assistants to return (default 100)'),
    createdAfter: z.string().optional().describe('Filter for assistants created after this ISO 8601 timestamp'),
    createdBefore: z.string().optional().describe('Filter for assistants created before this ISO 8601 timestamp'),
    updatedAfter: z.string().optional().describe('Filter for assistants updated after this ISO 8601 timestamp'),
    updatedBefore: z.string().optional().describe('Filter for assistants updated before this ISO 8601 timestamp')
  }))
  .output(z.object({
