...
let tiktokSearchResultSchema = z.object({
...
export let searchTikTokAds = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    countryCode: z.string().optional().describe('ISO 3166-1 alpha-2 country code to filter results, e.g. "DE", or "ALL" for all countries'),
  }))
  .output(z.object({
