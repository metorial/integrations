...
let googleShoppingAdSchema = z.object({
...
export let lookupGoogleShoppingAds = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    companyDomain: z.string().describe('Company website domain in bare format, e.g. "amazon.com"'),
  }))
  .output(z.object({
