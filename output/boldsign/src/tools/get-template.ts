...
export let getTemplate = SlateTool.create(
  ...
  .output(z.object({
    ...
    signerDetails: z.array(z.record(z.string(), z.any())).optional().describe('Role/signer configuration'),
    ccDetails: z.array(z.record(z.string(), z.any())).optional().describe('CC recipient details'),
    ...
    sharedTemplateDetail: z.array(z.record(z.string(), z.any())).optional().describe('Teams the template is shared with'),
  }))
