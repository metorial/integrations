...
export let listUsersTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    createdAfter: z.string().optional().describe('Only return users created after this ISO 8601 timestamp'),
    createdBefore: z.string().optional().describe('Only return users created before this ISO 8601 timestamp'),
    updatedAfter: z.string().optional().describe('Only return users updated after this ISO 8601 timestamp'),
    updatedBefore: z.string().optional().describe('Only return users updated before this ISO 8601 timestamp'),
  }))
  .output(z.object({
