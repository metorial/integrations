...
export let listDonations = SlateTool.create(
  spec,
  {
    name: 'List Donations',
    key: 'list_donations',
  ...
  .input(z.object({
    userId: z.number().optional().describe('User ID to view public donations for. Leave empty to list your own donations.'),
