...
export let auth = SlateAuth.create()
  ...
  .addOauth({
    ...
    scopes: [
      ...
      {
        title: 'User Profile',
        description: 'Read extended profile info such as bio description, verification status, and username.',
    ...
    getProfile: async (ctx: { output: { token: string; refreshToken?: string; expiresAt?: string; openId?: string }; input: {}; scopes: string[] }) => {
      let axios = createAxios();
