...
export let getHighlights = SlateTool.create(
  ...
  .input(z.object({
    meetingId: z.string().describe('The unique identifier of the meeting whose highlights to retrieve.'),
  }))
  .output(z.object({
    meetingId: z.string().describe('The meeting these highlights belong to.'),
    highlights: z.array(z.object({
      text: z.string().describe('Highlight text content.'),
      startTime: z.number().describe('Start time in seconds when this highlight occurs.'),
