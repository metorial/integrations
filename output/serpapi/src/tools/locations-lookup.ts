...
let locationSchema = z.object({
  ...
  canonicalName: z.string().optional().describe('Full hierarchical name (e.g., "Austin,Texas,United States")'),
  countryCode: z.string().optional().describe('ISO country code'),
  targetType: z.string().optional().describe('Location type (e.g., "DMA Region", "City", "Country")'),
...
export let locationsLookupTool = SlateTool.create(
  spec,
  {
