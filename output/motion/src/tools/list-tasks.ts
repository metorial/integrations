...
export let listTasks = SlateTool.create(
  ...
  .input(z.object({
    ...
    status: z.array(z.string()).optional().describe('Filter by task statuses. Mutually exclusive with includeAllStatuses.'),
    includeAllStatuses: z.boolean().optional().describe('Include tasks with any status. Mutually exclusive with status filter.'),
    label: z.string().optional().describe('Filter by label name'),
    name: z.string().optional().describe('Search for tasks containing this string (case-insensitive)'),
