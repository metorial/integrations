...
export let createJobMessageTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    replyToMessageId: z.string().optional().describe('Message ID to reply to. If provided, creates a reply instead of a new message.'),
  }))
  .output(z.object({
