...
export let manageImage = SlateTool.create(
  spec,
  {
    name: 'Manage Image',
    key: 'manage_image',
  ...
  .input(z.object({
    ...
    mediaType: z.string().optional().describe('Image MIME type (e.g. "image/png", "image/jpeg")'),
  ...
  .output(z.object({
    ...
    images: z.array(z.object({
      ...
      fileName: z.string().optional().describe('Image file name'),
      mediaType: z.string().optional().describe('Image media type'),
    })).optional().describe('List of all images (when listing)'),
  }))
