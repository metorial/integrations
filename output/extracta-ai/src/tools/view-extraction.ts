...
export let viewExtractionTool = SlateTool.create(
  spec,
  {
  ...
  .output(z.object({
    ...
    language: z.string().optional().describe('Document language configured for this extraction'),
    status: z.string().optional().describe('Current status of the extraction'),
    options: z.record(z.string(), z.unknown()).optional().describe('Processing options configured'),
    fields: z.array(z.object({
      key: z.string(),
      description: z.string().optional(),
      example: z.string().optional(),
    })).optional().describe('Fields configured for extraction'),
    batches: z.record(z.string(), z.object({
      filesNo: z.number().optional(),
      origin: z.string().optional(),
      startTime: z.string().optional(),
      status: z.string().optional(),
    })).optional().describe('Batch processing information'),
  }))
