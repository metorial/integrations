...
export let browseFolders = SlateTool.create(
  spec,
  {
    name: 'Browse Folders',
    key: 'browse_folders',
  ...
  .input(z.object({
    folderId: z.string().optional().describe('Folder ID to browse contents of. If provided, returns the folder\'s contents.'),
    parentFolderId: z.string().nullable().optional().describe('Filter folders by parent folder ID. Pass null for root-level folders.'),
    titleContains: z.string().optional().describe('Filter folders whose title contains this substring'),
