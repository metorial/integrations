...
export let executeView = SlateTool.create(
  spec,
  {
    name: 'Execute View',
    key: 'execute_view',
    description: 'Run a shared item view and return its filtered, sorted records. This is the preferred way to pull structured item data on a schedule.',
    tags: {
      readOnly: true,
    },
  }
  ...
  .output(z.object({
    ...
    objectRecords: z.array(z.record(z.string(), z.any())).describe('Records returned by the view'),
