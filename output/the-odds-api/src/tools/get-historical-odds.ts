...
export let getHistoricalOddsTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    date: z.string().describe('ISO 8601 timestamp for the snapshot (e.g. "2023-10-15T12:00:00Z")'),
  ...
  .output(z.object({
    ...
    previousTimestamp: z.string().nullable().describe('Timestamp of the previous snapshot (null if none)'),
    nextTimestamp: z.string().nullable().describe('Timestamp of the next snapshot (null if none)'),
