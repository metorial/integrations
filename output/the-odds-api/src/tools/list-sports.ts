...
export let listSportsTool = SlateTool.create(
  spec,
  {
    name: 'List Sports',
    key: 'list_sports',
...
Use the returned sport key as the **sport** parameter in other tools.`,
  ...
  .input(z.object({
    includeInactive: z.boolean().optional().describe('Set to true to include out-of-season sports'),
  }))
  .output(z.object({
    sports: z.array(z.object({
      ...
      hasOutrights: z.boolean().describe('Whether the sport supports outright/futures markets'),
    })),
  }))
