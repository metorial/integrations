...
export let listIndexesTool = SlateTool.create(
  spec,
  {
    name: 'List Indexes',
    key: 'list_indexes',
  ...
  .output(z.object({
    indexes: z.array(z.object({
      ...
      metric: z.string().describe('Distance metric used (cosine, euclidean, dotproduct)'),
      ...
      deletionProtection: z.string().optional().describe('Whether deletion protection is enabled'),
      ...
      tags: z.record(z.string(), z.string()).optional().describe('Custom tags on the index'),
