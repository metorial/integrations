...
export let updateVectorTool = SlateTool.create(
  spec,
  {
    name: 'Update Vector',
    key: 'update_vector',
  ...
  .input(z.object({
    ...
    }).optional().describe('New sparse vector values'),
    metadata: z.record(z.string(), z.any()).optional().describe('Metadata fields to set or update'),
  }))
  .output(z.object({
