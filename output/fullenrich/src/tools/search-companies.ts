...
Costs 0.25 credits per company returned.`,
  ...
  .input(z.object({
    ...
    linkedinUrls: z.array(filterSchema).optional().describe('Filter by company LinkedIn URL'),
    ...
    types: z.array(filterSchema).optional().describe('Filter by company type (e.g. Public Company, Privately Held)'),
    headquartersLocations: z.array(filterSchema).optional().describe('Filter by headquarters location'),
    foundedYears: z.array(rangeFilterSchema).optional().describe('Filter by founding year range'),
    headcounts: z.array(rangeFilterSchema).optional().describe('Filter by employee count range'),
