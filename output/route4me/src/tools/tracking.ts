...
export let getTrackingHistory = SlateTool.create(
  spec,
  {
...
export let setGpsPosition = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    deviceType: z.string().optional().describe('Device type: iphone, android, ipad, android_tablet'),
