...
export let associateRecords = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    navigationProperty: z.string().describe('Navigation property name representing the relationship'),
...
export let disassociateRecords = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    recordId: z.string().describe('GUID of the source record'),
    navigationProperty: z.string().describe('Navigation property name representing the relationship'),
    targetRecordId: z.string().optional().describe('GUID of the target record to disassociate (required for collection-valued navigation properties)'),
  }))
  .output(z.object({
...
export let getRelatedRecords = SlateTool.create(
  ...
  .input(z.object({
    ...
    navigationProperty: z.string().describe('Navigation property to traverse (e.g., "contact_customer_accounts")'),
    select: z.array(z.string()).optional().describe('Columns to return from the related records'),
