...
export let listStyleguides = SlateTool.create(
  ...
  .input(z.object({
    linkedProject: z.string().optional().describe('Filter to styleguides linked to this project ID'),
    linkedStyleguide: z.string().optional().describe('Filter to styleguides linked to this styleguide ID'),
...
export let getStyleguide = SlateTool.create(
  spec,
  {
    name: 'Get Styleguide',
    key: 'get_styleguide',
