...
let noteSchema = z.object({
  ...
  }).optional().describe('Position on the screen'),
  ...
  }).optional().describe('User who created the note')
});

export let listScreenNotes = SlateTool.create(
  spec,
  {
...
export let createScreenNote = SlateTool.create(
  spec,
  {
...
export let deleteScreenNote = SlateTool.create(
  spec,
  {
...
export let addNoteComment = SlateTool.create(
  spec,
  {
