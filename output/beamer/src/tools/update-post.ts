...
export let updatePostTool = SlateTool.create(
  ...
  .input(z.object({
    ...
    translations: z.array(translationUpdateSchema).optional().describe('Updated translations'),
  ...
  .handleInvocation(async (ctx) => {
    ...
    if (ctx.input.showInStandalone !== undefined) updateData.showInStandalone = ctx.input.showInStandalone;
    if (ctx.input.boostedAnnouncement !== undefined) updateData.boostedAnnouncement = ctx.input.boostedAnnouncement;
    if (ctx.input.linksInNewWindow !== undefined) updateData.linksInNewWindow = ctx.input.linksInNewWindow;
    ...
    if (ctx.input.enableFeedback !== undefined) updateData.enableFeedback = ctx.input.enableFeedback;
    if (ctx.input.enableReactions !== undefined) updateData.enableReactions = ctx.input.enableReactions;
    if (ctx.input.enableSocialShare !== undefined) updateData.enableSocialShare = ctx.input.enableSocialShare;
    if (ctx.input.autoOpen !== undefined) updateData.autoOpen = ctx.input.autoOpen;
    if (ctx.input.sendPushNotification !== undefined) updateData.sendPushNotification = ctx.input.sendPushNotification;
