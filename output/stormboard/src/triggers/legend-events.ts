...
export let legendEvents = SlateTrigger.create(
  spec,
  {
    name: 'Legend Changed',
    key: 'legend_changed',
    description: 'Triggered when the color legend of a Storm is modified. Configure the webhook URL in Stormboard account settings (My Account → Webhooks).',
    instructions: [
