...
export let createUpdateContact = SlateTool.create(
  spec,
  {
...
You can set basic contact info, custom fields, tags, and list memberships in a single operation.`,
  ...
  .input(z.object({
    contactId: z.string().optional().describe('Spoki contact ID. If provided, performs an update on this specific contact.'),
    ...
    customFields: z.record(z.string(), z.string()).optional().describe('Custom/dynamic field values as key-value pairs'),
