...
let moneySchema = z.object({
  amount: z.number().optional().describe('Amount in the smallest denomination of the currency (e.g., cents)'),
...
export let listPayments = SlateTool.create(
  ...
  .input(z.object({
    ...
    sortOrder: z.enum(['ASC', 'DESC']).optional().describe('Sort order by created_at. Defaults to DESC'),
