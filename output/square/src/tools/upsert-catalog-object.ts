...
export let upsertCatalogObject = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    object: z.record(z.string(), z.any()).describe('The catalog object to create or update. Must include "type" and "id" fields. See Square Catalog API docs for object structure'),
    idempotencyKey: z.string().optional().describe('Unique key to prevent duplicates. Auto-generated if omitted'),
  }))
  .output(z.object({
