...
export let listInvitations = SlateTool.create(
  spec,
  {
...
export let createInvitation = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    role: z.enum(['admin', 'developer']).optional().describe('Role to assign (admin or developer)'),
...
export let deleteInvitation = SlateTool.create(
  spec,
  {
