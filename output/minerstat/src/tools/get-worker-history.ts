...
export let getWorkerHistoryTool = SlateTool.create(
  spec,
  {
  ...
  .input(z.object({
    ...
    dataType: z.enum(['hashrate', 'statistics', 'activity']).describe('Type of historical data to retrieve'),
    timezone: z.string().optional().describe('Timezone for the data (e.g. "America/New_York")')
  }))
  .output(z.object({
