...
export let faceSwap = SlateTool.create(
  spec,
  {
    name: 'Face Swap',
    key: 'face_swap',
...
Can also generate AI avatars and business photos from a face image with creative transformation options.`,
  ...
  .input(z.object({
    ...
    avatarGenerationType: z.enum(['creative_img2img']).optional()
      .describe('Avatar generation mode for creative transformations'),
    description: z.string().optional()
      .describe('Optional prompt to reimagine the scene (e.g. "cinematic scene with dramatic lighting")'),
